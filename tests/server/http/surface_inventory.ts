...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/mine',
    handler: 'handleApi arm: /api/realms/mine',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/tiers',
    handler: 'handleApi arm: /api/realms/tiers',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/quote',
    handler: 'handleApi arm: /api/realms/quote',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/confirm',
    handler: 'handleApi arm: /api/realms/confirm',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/buy/info',
    handler: 'handleApi arm: /api/realms/buy/info',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/buy/quote',
    handler: 'handleApi arm: /api/realms/buy/quote',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/buy/confirm',
    handler: 'handleApi arm: /api/realms/buy/confirm',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/decommission',
    handler: 'realmDecommissionMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/decommission$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/release',
    handler: 'realmReleaseMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/release$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/affiliate/me',
    handler: 'handleApi arm: /api/affiliate/me',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/affiliate/realms',
    handler: 'handleApi arm: /api/affiliate/realms',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/referral/summary',
    handler: 'handleApi arm: /api/referral/summary',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/register',
    handler: 'realmTokenRegisterMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/register$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/vote/open',
    handler: 'realmVoteOpenMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/vote\/open$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/:id/token/vote',
    handler: 'realmVoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/vote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/presale/config',
    handler: 'presaleConfigMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/presale\/config$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/presale/quote',
    handler: 'presaleQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/presale\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/presale/confirm',
    handler: 'presaleConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/presale\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/presale/finalize',
    handler: 'presaleFinalizeMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/presale\/finalize$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/presale/refund',
    handler: 'presaleRefundMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/presale\/refund$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    ...
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/launch$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/mint/quote',
    handler: 'mintQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/mint\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/mint/confirm',
    handler: 'mintConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/mint\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/distribute/quote',
    handler: 'distributeQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/distribute\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/distribute/confirm',
    handler: 'distributeConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/distribute\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/lock/quote',
    handler: 'lockQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/lock\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/lock/confirm',
    handler: 'lockConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/lock\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/quote',
    handler: 'tokenCurveQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/confirm',
    handler: 'curveConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/:id/token/curve',
    handler: 'curveStateMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/reconcile',
    handler: 'curveReconcileMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/reconcile$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/leftover/quote',
    handler: 'leftoverQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/leftover\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/leftover/confirm',
    handler: 'leftoverConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/leftover\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
