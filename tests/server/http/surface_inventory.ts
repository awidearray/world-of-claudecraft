...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/mint/prepare',
    handler: 'mintPrepareMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/mint\/prepare$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/launch/verify',
    handler: 'launchVerifyMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/launch\/verify$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/realms/:id/token/curve',
    handler: 'realmCurveMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/prepare',
    handler: 'curvePrepareMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/prepare$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
  ...
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/curve/graduation',
    handler: 'curveGraduationMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/curve\/graduation$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/power/quote',
    handler: 'powerQuoteMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/power\/quote$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/realms/:id/token/power/confirm',
    handler: 'powerConfirmMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'rateLimited',
    requireOwnedExpected: null,
    match: /^\/api\/realms\/(\d+)\/token\/power\/confirm$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
