...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/realms/:id/token/mint/prepare': PROBLEM_JSON,
  '/api/realms/:id/token/mint/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/launch/verify': PROBLEM_JSON,
  ...
  '/api/realms/:id/token/power/quote': PROBLEM_JSON,
  '/api/realms/:id/token/power/confirm': PROBLEM_JSON,
