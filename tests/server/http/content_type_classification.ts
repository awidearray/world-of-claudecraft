...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/realms/mine': PROBLEM_JSON,
  '/api/realms/tiers': PROBLEM_JSON,
  '/api/realms/quote': PROBLEM_JSON,
  '/api/realms/confirm': PROBLEM_JSON,
  ...
  '/api/realms/:id/token/register': PROBLEM_JSON,
  '/api/realms/:id/token/vote/open': PROBLEM_JSON,
  '/api/realms/:id/token/vote': PROBLEM_JSON,
  '/api/realms/:id/token/presale/config': PROBLEM_JSON,
  '/api/realms/:id/token/presale/quote': PROBLEM_JSON,
  '/api/realms/:id/token/presale/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/presale/finalize': PROBLEM_JSON,
  '/api/realms/:id/token/presale/refund': PROBLEM_JSON,
  '/api/realms/:id/token/power-credit': PROBLEM_JSON,
  '/api/realms/:id/token/launch': PROBLEM_JSON,
  '/api/realms/:id/token/mint/quote': PROBLEM_JSON,
  '/api/realms/:id/token/mint/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/distribute/quote': PROBLEM_JSON,
  '/api/realms/:id/token/distribute/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/lock/quote': PROBLEM_JSON,
  '/api/realms/:id/token/lock/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/curve/quote': PROBLEM_JSON,
  '/api/realms/:id/token/curve/confirm': PROBLEM_JSON,
  '/api/realms/:id/token/curve': PROBLEM_JSON,
  '/api/realms/:id/token/curve/reconcile': PROBLEM_JSON,
  '/api/realms/:id/token/curve/leftover/quote': PROBLEM_JSON,
  '/api/realms/:id/token/curve/leftover/confirm': PROBLEM_JSON,
