...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/claudium/purchase/woc/confirm': PROBLEM_JSON,
  '/api/claudium/spend': PROBLEM_JSON,
  '/api/merch/stripe/webhook': PROBLEM_JSON,
  '/api/merch/printful/webhook': PROBLEM_JSON,
  '/api/merch/products': PROBLEM_JSON,
  '/api/merch/checkout': PROBLEM_JSON,
  '/api/merch/checkout/native/confirm': PROBLEM_JSON,
  '/api/merch/orders': PROBLEM_JSON,
  '/api/card': BINARY,
