...
export interface InputCallbacks {
  ...
  onUiKey(key: 'interact' | 'bags' | 'char' | 'spellbook' | 'talents' | 'mounts' | 'questlog' | 'map' | 'nameplates' | 'escape' | 'chat' | 'meters' | 'social' | 'arena' | 'leaderboard'): void;
...
export class Input {
  ...
  private dispatchEdge(action: string): void {
    ...
    switch (action) {
      ...
      case 'mounts': this.cb.onUiKey('mounts'); return;
