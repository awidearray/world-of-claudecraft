...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.title': '周边商店',
  'hudChrome.merch.subtitle': '官方《World of ClaudeCraft》周边商品，全球配送。',
  'hudChrome.merch.loading': '正在加载商店…',
  'hudChrome.merch.unavailable': '周边商店暂时不可用。您的订单和付款不会受到影响，请稍后再试。',
  'hudChrome.merch.disclosure': '周边商品由我们的印刷合作伙伴按需制作并发货。用于购买周边的 Claudium 不可退还为 Claudium；银行卡和 Solana 付款遵循服务条款中的退款政策。',
  'hudChrome.merch.catalogTitle': '商品目录',
  'hudChrome.merch.catalogEmpty': '目前没有可用的周边商品。',
  'hudChrome.merch.variantLabel': '款式与尺码',
  'hudChrome.merch.addToCart': '加入购物车',
  'hudChrome.merch.outOfStock': '缺货',
  'hudChrome.merch.cartTitle': '购物车',
  'hudChrome.merch.cartEmpty': '您的购物车是空的。',
  'hudChrome.merch.removeFromCart': '从购物车移除',
  'hudChrome.merch.totalLabel': '总计',
  'hudChrome.merch.totalNote': '运费和税费将在结账时添加；最终金额以服务器确认为准。',
  'hudChrome.merch.claudiumPrice': '{amount} Claudium',
  'hudChrome.merch.checkoutTitle': '结账',
  'hudChrome.merch.loginRequired': '请登录帐户后再结账。',
  'hudChrome.merch.shipping.name': '姓名',
  'hudChrome.merch.shipping.address1': '地址',
  'hudChrome.merch.shipping.address2': '地址第二行（可选）',
  'hudChrome.merch.shipping.city': '城市',
  'hudChrome.merch.shipping.state': '州/省',
  'hudChrome.merch.shipping.zip': '邮政编码',
  'hudChrome.merch.shipping.country': '国家/地区',
  'hudChrome.merch.shipping.email': '接收订单通知的邮箱',
  'hudChrome.merch.shippingIncomplete': '请填写所有必填的收货信息。',
  'hudChrome.merch.railLabel': '付款方式',
  'hudChrome.merch.railStripe': '银行卡',
  'hudChrome.merch.railSol': 'SOL',
  'hudChrome.merch.railClaudium': 'Claudium',
  'hudChrome.merch.payNow': '提交订单',
  'hudChrome.merch.checkoutPending': '订单正在处理。请完成付款，并保持此页面打开。',
  'hudChrome.merch.checkoutFailed': '无法开始结账，请重试。',
  'hudChrome.merch.checkoutUnavailable': '该订单暂时不可用。',
  'hudChrome.merch.checkoutNotSettled': '交易已发送，但订单尚未确认。请稍后查看您的订单。',
  'hudChrome.merch.orderPlaced': '订单 {orderId} 已提交。可在下方的订单中跟踪。',
  'hudChrome.merch.ordersTitle': '我的订单',
  'hudChrome.merch.trackOrder': '跟踪',
  'hudChrome.merch.status.pendingPayment': '等待付款',
  'hudChrome.merch.status.paid': '已付款',
  'hudChrome.merch.status.submitted': '已送交生产',
  'hudChrome.merch.status.inProduction': '生产中',
  'hudChrome.merch.status.shipped': '已发货',
  'hudChrome.merch.status.delivered': '已送达',
  'hudChrome.merch.status.paymentFailed': '付款失败',
  'hudChrome.merch.status.expired': '已过期',
  'hudChrome.merch.status.canceled': '已取消',
  'hudChrome.merch.status.refunded': '已退款',
  'hudChrome.merch.status.fulfillmentFailed': '配送失败',
  'hudChrome.merch.status.unknown': '处理中',
