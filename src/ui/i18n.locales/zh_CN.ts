...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.riverboat_dealer.name': '荷官玛丽贝尔',
  'entities.npcs.riverboat_dealer.title': '大沙龙的老千',
  'entities.npcs.riverboat_dealer.greeting': '请坐，{className}。牌堆是新的，发牌绝对公道。来一局吗？',
  'entities.npcs.riverboat_pit_boss.name': '赌台经理克雷克',
  'entities.npcs.riverboat_pit_boss.title': '赌斗擂台之主',
  'entities.npcs.riverboat_pit_boss.greeting': '两名斗士，一份彩金，{className}。上擂台，报出你的赌注吧。',
  'entities.npcs.riverboat_slots_attendant.name': '蒂莉·斯普罗基特',
  'entities.npcs.riverboat_slots_attendant.title': '转轮看守人',
  'entities.npcs.riverboat_slots_attendant.greeting': '机柜已上好油，跃跃欲试，{className}。每天一次免费转动，转轮从不说谎。',
  'entities.npcs.riverboat_hilo_croupier.name': '军需官诺克',
  'entities.npcs.riverboat_hilo_croupier.title': '掷骰唱数人',
  'entities.npcs.riverboat_hilo_croupier.greeting': '猜大或猜小，{className}，一掷定胜负。庄家只吃中间那一点。',
  ...
  'hudChrome.hilo.title': '军需官的猜大小',
  'hudChrome.hilo.rules': '在 1 到 100 的点数上猜大或猜小。小猜中 1 到 49，大猜中 52 到 100。等额赔付。',
  'hudChrome.hilo.balance': '钱袋：{amount}',
  'hudChrome.hilo.stakeLabel': '赌注',
  'hudChrome.hilo.prompt': '先选择赌注，再猜大或猜小。',
  'hudChrome.hilo.low': '小（1 到 49）',
  'hudChrome.hilo.high': '大（52 到 100）',
  'hudChrome.hilo.session': '本次：胜 {wins}，负 {losses}',
  'hudChrome.hilo.close': '关闭',
  'hudChrome.hilo.wonLine': '掷出 {roll}。你赢得 {amount}。',
  'hudChrome.hilo.lostLine': '掷出 {roll}。你输掉 {amount}。',
  'hudChrome.hilo.wonLog': '猜大小：掷出 {roll}，赢得 {amount}。',
  'hudChrome.hilo.lostLog': '猜大小：掷出 {roll}，输掉 {amount}。',
};
