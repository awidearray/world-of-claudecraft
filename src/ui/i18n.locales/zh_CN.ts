...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.close': '关闭克劳迪姆',
  'hudChrome.claudium.balanceLabel': '余额',
  'hudChrome.claudium.balanceUnit': '{amount} 克劳迪姆',
  'hudChrome.claudium.amountWithUsd': '{amount} 克劳迪姆（{usd}）',
  'hudChrome.claudium.splitLabel': '拆分',
  'hudChrome.claudium.splitSummary': '销毁 {burn} {rail}，{treasury} {rail} 转入金库',
  'hudChrome.claudium.reviewLabel': '确认',
  'hudChrome.claudium.reviewLine': '您支付 {pay} {rail}，获得 {claudium} 克劳迪姆（{usd}）。',
  'hudChrome.claudium.reviewLineCard': '您支付 {usd}，获得 {claudium} 克劳迪姆。',
  'hudChrome.claudium.scanLabel': '或扫码支付',
  'hudChrome.claudium.copyAddress': '复制地址',
  'hudChrome.claudium.copied': '已复制',
  'hudChrome.claudium.confirmPending': '正在等待链上确认，这可能需要一点时间。',
  'hudChrome.claudium.confirmNotFinalized':
    '您的付款尚未在链上确认。这是正常现象，请稍等片刻后再次确认。',
  'hudChrome.claudium.confirmRequote': '价格已变动。请重新获取报价后再试。',
  'hudChrome.claudium.retryButton': '重试',
  'hudChrome.claudium.requoteButton': '重新获取报价',
  'hudChrome.claudium.insufficientBalance': '克劳迪姆不足',
  'hudChrome.claudium.unavailable': '克劳迪姆商店当前不可用。您的余额和购买不受影响，请稍后再试。',
  'hudChrome.claudium.disclosure':
    '克劳迪姆是一种单向软通货：用钱购买，用于外观装饰。不可赎回、转让或兑现。',
  'hudChrome.claudium.buyTitle': '购买克劳迪姆',
  'hudChrome.claudium.railLabel': '支付方式',
  'hudChrome.claudium.railStripe': '银行卡',
  'hudChrome.claudium.railWocUnavailable': 'WOC 价格当前不可用。',
  'hudChrome.claudium.amountLabel': '金额',
  'hudChrome.claudium.skuRow': '{usd} 兑换 {claudium} 克劳迪姆',
  'hudChrome.claudium.buyButton': '购买',
  'hudChrome.claudium.buyUnavailable': '购买当前不可用。',
  'hudChrome.claudium.storeTitle': '外观商店',
  'hudChrome.claudium.storeEmpty': '当前没有可用的外观装饰。',
  ...
  'hudChrome.claudium.tabsLabel': '克劳迪姆选项卡',
  'hudChrome.claudium.tabBuy': '购买',
  'hudChrome.claudium.tabRedeem': '兑换',
  'hudChrome.claudium.railDisabled': '此支付方式当前不可用。',
  'hudChrome.claudium.oracleUnavailable': '实时价格当前不可用。请稍后再试。',
  'hudChrome.claudium.quoteButton': '获取报价',
  'hudChrome.claudium.amountRow': '{usd} 兑换 {claudium} 克劳迪姆',
  'hudChrome.claudium.sendExactly': '精确发送 {amount} {rail}',
  'hudChrome.claudium.addressLabel': '发送至',
  'hudChrome.claudium.memoLabel': '备注 (必填)',
  'hudChrome.claudium.splitBurn': '销毁 {amount} {rail}',
  'hudChrome.claudium.splitTreasury': '{amount} {rail} 进入金库',
  'hudChrome.claudium.expiresIn': '报价将在 {time} 后过期',
  'hudChrome.claudium.quoteExpired': '此报价已过期。请重新获取。',
  'hudChrome.claudium.payNote':
    '从你自己的钱包发送带备注的精确金额，然后粘贴交易签名以确认。服务会在链上验证后再入账。',
  'hudChrome.claudium.signatureLabel': '交易签名',
  'hudChrome.claudium.signaturePlaceholder': '粘贴签名',
  'hudChrome.claudium.confirmButton': '确认支付',
  'hudChrome.claudium.confirmCredited': '已入账 {amount} 克劳迪姆。',
  'hudChrome.claudium.confirmFailed': '暂时无法确认此笔支付。请稍后再试。',
  'hudChrome.claudium.redeemTitle': '兑换礼品卡',
  'hudChrome.claudium.enterCode': '输入你的礼品卡代码',
  'hudChrome.claudium.redeemButton': '兑换',
  'hudChrome.claudium.redeemed': '已兑换 {amount} 克劳迪姆。新余额：{balance}。',
  'hudChrome.claudium.redeemFailed': '无法兑换此代码。请检查代码后重试。',
