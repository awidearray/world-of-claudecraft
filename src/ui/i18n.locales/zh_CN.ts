...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'realmOp.affiliate.subtitle': '分享一个链接。通过它加入的玩家获得经验和金币加成，你从他们的收益中赚取分成，他们创立的任何服务器还会给你 15%。',
  'realmOp.affiliate.title': '推荐与联盟计划',
  'realmOp.affiliate.unavailable': '推荐统计暂时不可用。请稍后再试。',
  'realmOp.affiliate.yourLink': '你的推荐链接',
  'realmOp.buy.bondNote': '还需持有 {amount} $WOC，在服务器存续期间保留在你绑定的钱包中，否则服务器将失效。',
  'realmOp.buy.bondWhy': '这笔持续保证金独立于你支付的 {currency}：它确保你在运营服务器期间保持利益绑定。',
  ...
  'realmOp.found.badgeNote': '你质押的 $WOC 仍计入你的持有者徽章，因此创立服务器绝不会降低你的等级。',
  ...
  'realmOp.found.stakingNote': '你签署一笔交易，将 {amount} $WOC 锁入托管。停用后经过 {days} 天时间锁即可随时取回。',
  ...
  'realmOp.found.tierHint': '更大的质押解锁更高等级：更多玩家、更多自定义预算，以及运营者收益通道。',
  ...
  'realmOp.mine.bondWarning': '保证金低于要求。请持有 {amount} $WOC，并在 {date} 之前补足，否则此服务器将失效。',
  'realmOp.mine.decommission': '停用',
  'realmOp.mine.decommissionConfirm': '停用 {name}？这将使服务器下线，并启动 {days} 天的质押释放时间锁。',
  ...
  'launchpad.register.subtitle': '为这个服务器将要发射的货币命名。注册仅确定身份：铸造、锁仓和流动性将在后续阶段带着各自的保障机制推出。',
  'launchpad.register.symbolLabel': '代币代码',
  'launchpad.register.symbolPlaceholder': '例如 MOON',
  'launchpad.register.policyLabel': '变现政策',
  'launchpad.register.policyHint': '选择“仅限外观”可保持该服务器无付费变强。“付费变强”会向所有玩家明示标注，并在上线前受到审核限制。',
  'launchpad.register.submit': '注册代币',
  'launchpad.vote.title': '这个服务器应该发射它的代币吗？',
  'launchpad.vote.subtitle': '每个已验证的关联钱包一票，按投票时钱包持有的 $WOC 加权。投票仅供参考且免费：不会发送任何交易。',
  ...
  'launchpad.presale.subtitle': '用 SOL、USDC 或 $WOC 为发射出资。资金直接进入创始人托管钱包；本服务器只验证您的交易，绝不保管资金。',
  ...
  'launchpad.presale.refundTerms': '如果预售未达软顶，创始人将从托管钱包退款，每笔退款都会先经链上验证才计入。',
  ...
  'launchpad.presale.config.subtitle': '设置您掌控的托管钱包和各币种上限。留空即停用该币种。金额为整单位。',
  ...
  'launchpad.err.invalid_presale_caps': '这些上限无效。每个启用的币种需要软顶、不低于软顶的筹集上限和单钱包上限。',
  ...
  'launchpad.curve.openHint': '构建由您的钱包签名的池创建交易。曲线主机铸造代币并持有曲线供应量;任何资金都不经过本服务器。',
  ...
  'launchpad.fund.policyNote': '每笔持仓都按股权表上最严格的时间表归属(12 个月悬崖期 + 48 个月线性),处置需经治理审批。平台无法抛售这些持仓。',
