...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocSeason.close': '关闭',
  'hudChrome.wocSeason.colPlayer': '玩家',
  'hudChrome.wocSeason.colRating': '评分',
  'hudChrome.wocSeason.colReward': '奖励（$WOC）',
  'hudChrome.wocSeason.emittedLabel': '奖池已发放 {pct}%',
  'hudChrome.wocSeason.ended': '本赛季已结束。',
  'hudChrome.wocSeason.invariant': '派发绝不会超过赛季收入：买入大于卖出，由链上强制执行。',
  'hudChrome.wocSeason.menu': '$WOC 赛季',
  'hudChrome.wocSeason.none': '当前没有进行中的奖励赛季。',
  'hudChrome.wocSeason.noneHint': '当竞技场抽成和回购开始注入奖池时，赛季即会开启。',
  'hudChrome.wocSeason.openEnded': '无固定期限',
  'hudChrome.wocSeason.poolLabel': '可用奖池',
  'hudChrome.wocSeason.projectedNote': '根据当前奖池和竞技场排名预估；最终派发在赛季结束时结算。',
  'hudChrome.wocSeason.sinkLabel': '已注入',
  'hudChrome.wocSeason.standingsTitle': '预计最高收益者',
  'hudChrome.wocSeason.statusActive': '进行中',
  'hudChrome.wocSeason.statusEnded': '已结束',
  'hudChrome.wocSeason.subtitle': '由金库出资，向顶尖玩家派发',
  'hudChrome.wocSeason.title': '$WOC 奖励赛季',
  'realmOp.open': '创立服务器',
  'realmOp.panelTitle': '服务器运营者',
  'realmOp.affiliate.bonusRealm': '另外，他们创立的任何服务器都会给你 15% 的 USDC 佣金。',
  'realmOp.affiliate.bonusReferee': '通过你的链接加入的玩家在前 30 天获得 +10% 经验和金币。',
  'realmOp.affiliate.bonusReferrer': '在此期间，你可获得他们收益的 +5%，直接计入你的角色。',
  'realmOp.affiliate.bonusTitle': '你的链接如何赚钱',
  'realmOp.affiliate.commission': '{pct}% 佣金',
  'realmOp.affiliate.copied': '已复制',
  'realmOp.affiliate.copy': '复制链接',
  'realmOp.affiliate.earningsSoon': '当服务器内收入上线后，USDC 佣金即开始发放。',
  'realmOp.affiliate.empty': '还没有被推荐的服务器。分享你的链接开始赚取收益。',
  'realmOp.affiliate.loading': '正在加载你的推荐统计...',
  'realmOp.affiliate.open': '推荐计划',
  'realmOp.affiliate.referredCount': '{count} 个活跃的被推荐服务器',
  'realmOp.affiliate.referredCountPlural': '{count} 个活跃的被推荐服务器',
  'realmOp.affiliate.referredTitle': '你推荐的服务器',
  'realmOp.affiliate.rewardsEmpty': '推荐玩家即可开始赚取。奖励将在你下次登录时发放到角色。',
  'realmOp.affiliate.rewardsLifetime': '累计已获得 {xp} 经验和 {gold}',
  'realmOp.affiliate.rewardsPending': '{xp} 经验和 {gold} 待发放，将在你下次登录时到账',
  'realmOp.affiliate.rewardsReferred': '已推荐玩家：{count}',
  'realmOp.affiliate.rewardsTitle': '你的推荐奖励',
  'realmOp.affiliate.subtitle':
    '分享一个链接。通过它加入的玩家获得经验和金币加成，你从他们的收益中赚取分成，他们创立的任何服务器还会给你 15%。',
  'realmOp.affiliate.title': '推荐与联盟计划',
  'realmOp.affiliate.unavailable': '推荐统计暂时不可用。请稍后再试。',
  'realmOp.affiliate.yourLink': '你的推荐链接',
  'realmOp.buy.bondNote':
    '还需持有 {amount} $WOC，在服务器存续期间保留在你绑定的钱包中，否则服务器将失效。',
  'realmOp.buy.bondWhy':
    '这笔持续保证金独立于你支付的 {currency}：它确保你在运营服务器期间保持利益绑定。',
  'realmOp.buy.currencyLabel': '支付方式',
  'realmOp.buy.currencyUnavailable': '{currency} 暂时不可用（没有兑换路径）。',
  'realmOp.buy.finalNote': '购买为最终交易，不可退款。与质押不同，停用服务器时不会返还。',
  'realmOp.buy.note': '你签署一笔交易，支付 {amount} {currency} 来创立此服务器。服务器立即激活。',
  'realmOp.buy.splitNote': '你支付的 {treasuryPct}% 注入金库，其余用于回购并销毁 $WOC。',
  'realmOp.buy.submit': '购买并创立',
  'realmOp.buy.submitConnect': '连接钱包以购买',
  'realmOp.buy.unavailable': '目前无法购买服务器。请改为质押 $WOC 来创立。',
  'realmOp.err.bad_signature': '该支付签名无效。请重新开始。',
  'realmOp.err.bond_required': '购买此等级需要在绑定钱包中持有 {amount} $WOC。请充值后重试。',
  'realmOp.err.buy_unavailable': '目前无法购买服务器。请改为质押 $WOC 来创立。',
  'realmOp.err.buyback_short': '支付金额与你的报价不符。',
  'realmOp.err.generic': '出了点问题。请重试。',
  'realmOp.err.invalid_amount': '质押数量无效。请选择一个等级后重试。',
  'realmOp.err.invalid_currency': '请选择 SOL 或 USDC 后重试。',
  'realmOp.err.invalid_realm_name': '该服务器名称不被允许。请使用字母、数字、空格或连字符。',
  'realmOp.err.invalid_tier': '请选择一个等级后重试。',
  'realmOp.err.legs_collide': '无法验证该支付。请重新开始。',
  'realmOp.err.link_wallet': '请先将钱包绑定到你的账户。',
  'realmOp.err.memo_mismatch': '该支付与你的报价不符。请重新开始。',
  'realmOp.err.not_finalized': '你的支付尚未最终确认。请稍后再确认一次。',
  'realmOp.err.not_realm_owner': '你不是该服务器的运营者。',
  'realmOp.err.not_your_quote': '该报价属于其他账户。',
  'realmOp.err.payment_already_recorded': '该支付已被记录。',
  'realmOp.err.price_unavailable': '实时价格暂时不可用。请稍后再试。',
  'realmOp.err.quote_expired': '你的报价已过期。请重新开始。',
  'realmOp.err.quote_not_found': '未找到你的报价。请重新开始。',
  'realmOp.err.rate_limited': '请求过于频繁。请放慢速度后重试。',
  'realmOp.err.realm_cap_reached': '你已达到每个账户的服务器数量上限。',
  'realmOp.err.realm_name_not_allowed': '该服务器名称不被允许。',
  'realmOp.err.realm_name_taken': '该服务器名称已被占用。',
  'realmOp.err.realm_not_active': '该服务器未处于激活状态。',
  'realmOp.err.realm_not_decommissioning': '该服务器未处于停用流程中。',
  'realmOp.err.realm_not_found': '该服务器已不存在。',
  'realmOp.err.stake_already_recorded': '该质押已被记录。',
  'realmOp.err.stake_below_minimum': '该质押低于最低等级。请选择更高的等级。',
  'realmOp.err.stake_not_released_onchain': '请先在链上释放你的质押，然后再完成关闭。',
  'realmOp.err.stake_service_unavailable': '质押服务暂时不可用。请稍后再确认一次。',
  'realmOp.err.supply_unavailable': '$WOC 供应量数据暂时不可用。请稍后再试。',
  'realmOp.err.timelock_not_elapsed': '质押的时间锁尚未到期。',
  'realmOp.err.token_2022': '此 $WOC 铸币不支持用于质押。',
  'realmOp.err.treasury_short': '支付金额与你的报价不符。',
  'realmOp.err.tx_failed': '质押交易在链上失败。',
  'realmOp.err.tx_not_finalized': '你的质押尚未最终确认。请稍后再确认一次。',
  'realmOp.err.wallet_mismatch': '请连接你绑定到账户的钱包。',
  'realmOp.err.wrong_payer': '质押必须由你绑定的钱包签署。',
  'realmOp.err.wrong_vault_amount': '锁定的数量与你的报价不符。',
  'realmOp.flow.closed': '服务器已关闭。该名称重新可用。',
  'realmOp.flow.confirming': '正在链上验证你的质押...',
  'realmOp.flow.confirmingBuy': '正在链上验证你的支付...',
  'realmOp.flow.connecting': '正在连接你的钱包...',
  'realmOp.flow.decommissioning': '正在开始停用...',
  'realmOp.flow.founded': '{name} 已上线。欢迎，运营者。',
  'realmOp.flow.locking': '请在钱包中批准质押...',
  'realmOp.flow.paying': '请在钱包中批准支付...',
  'realmOp.flow.quoting': '正在为你预留服务器...',
  'realmOp.flow.released': '服务器已关闭。该名称重新可用。',
  'realmOp.flow.releasing': '正在完成关闭...',
  'realmOp.found.affiliateNote': '由联盟推荐。他们将获得该服务器收入 15% 的佣金。',
  'realmOp.found.badgeNote':
    '你质押的 $WOC 仍计入你的持有者徽章，因此创立服务器绝不会降低你的等级。',
  'realmOp.found.methodBuy': '用 SOL 或 USDC 购买',
  'realmOp.found.methodBuyHint': '用 SOL 或 USDC 一次性支付。购买为最终交易，没有可取回的质押。',
  'realmOp.found.methodLabel': '支付方式',
  'realmOp.found.methodStake': '质押 $WOC',
  'realmOp.found.methodStakeHint': '将 $WOC 锁入托管。停用时全额返还。',
  'realmOp.found.nameLabel': '服务器名称',
  'realmOp.found.namePlaceholder': '为你的服务器命名',
  'realmOp.found.nameTaken': '请换一个名称；该名称已被占用。',
  'realmOp.found.stakingNote':
    '你签署一笔交易，将 {amount} $WOC 锁入托管。停用后经过 {days} 天时间锁即可随时取回。',
  'realmOp.found.submit': '质押并创立',
  'realmOp.found.submitConnect': '连接钱包以创立',
  'realmOp.found.subtitle': '将 $WOC 质押到非托管的链上托管账户，以开设并运营你自己的服务器。',
  'realmOp.found.supplyNote': '每个等级的价格按 $WOC 实时供应量的一定比例计算。',
  'realmOp.found.tierHint':
    '更大的质押解锁更高等级：更多玩家、更多自定义预算，以及运营者收益通道。',
  'realmOp.found.tierLabel': '质押等级',
  'realmOp.found.tiersUnavailable': '实时等级价格暂时不可用。请稍后再试。',
  'realmOp.found.title': '创立服务器',
  'realmOp.found.typeLabel': '服务器类型',
  'realmOp.mine.bondInfo': '保证金：在绑定钱包中持有 {amount} $WOC。',
  'realmOp.mine.bondWarning':
    '保证金低于要求。请持有 {amount} $WOC，并在 {date} 之前补足，否则此服务器将失效。',
  'realmOp.mine.decommission': '停用',
  'realmOp.mine.decommissionConfirm':
    '停用 {name}？这将使服务器下线，并启动 {days} 天的质押释放时间锁。',
  'realmOp.mine.eligible': '质押可于 {date} 释放',
  'realmOp.mine.empty': '你还没有运营任何服务器。在上方创立一个即可开始。',
  'realmOp.mine.enter': '进入',
  'realmOp.mine.loading': '正在加载你的服务器...',
  'realmOp.mine.release': '完成关闭',
  'realmOp.mine.releaseHint': '先在链上释放你的质押，然后完成关闭以关停服务器并释放其名称。',
  'realmOp.mine.tier': '{tier} 等级',
  'realmOp.mine.title': '我的服务器',
  'realmOp.status.active': '激活',
  'realmOp.status.decommissioning': '停用中',
  'realmOp.status.provisioning': '开通中',
  'realmOp.tier.bronze': '青铜',
  'realmOp.tier.priceUnavailable': '暂无价格',
  'realmOp.tier.share': '供应量的 {pct}%',
  'realmOp.tier.silver': '白银',
  'launchpad.open': '代币发射台',
  'launchpad.title': '服务器代币发射台',
  'launchpad.back': '返回',
  'launchpad.loading': '正在加载代币状态...',
  'launchpad.symbolBadge': '{symbol} 代币',
  'launchpad.status.none': '未注册代币',
  'launchpad.status.prelaunch': '发射前',
  'launchpad.status.voting': '社区投票',
  'launchpad.status.presale': '预售',
  'launchpad.status.funded': '已达标',
  'launchpad.status.refunding': '退款中',
  'launchpad.status.refunded': '已退款',
  'launchpad.status.live': '已上线',
  'launchpad.status.graduated': '已毕业',
  'launchpad.status.closed': '已关闭',
  'launchpad.checklist.aria': '发射清单',
  'launchpad.checklist.register': '注册',
  'launchpad.checklist.vote': '投票',
  'launchpad.checklist.presale': '预售',
  'launchpad.checklist.launch': '发射',
  'launchpad.policy.cosmetic': '仅限外观',
  'launchpad.policy.power': '付费变强',
  'launchpad.policy.powerBanner': '付费变强服务器：该代币上线后可以在这里购买游戏优势。',
  'launchpad.register.title': '注册服务器代币',
  'launchpad.register.subtitle':
    '为这个服务器将要发射的货币命名。注册仅确定身份：铸造、锁仓和流动性将在后续阶段带着各自的保障机制推出。',
  'launchpad.register.symbolLabel': '代币代码',
  'launchpad.register.symbolPlaceholder': '例如 MOON',
  'launchpad.register.policyLabel': '变现政策',
  'launchpad.register.policyHint':
    '选择“仅限外观”可保持该服务器无付费变强。“付费变强”会向所有玩家明示标注，并在上线前受到审核限制。',
  'launchpad.register.submit': '注册代币',
  'launchpad.vote.title': '这个服务器应该发射它的代币吗？',
  'launchpad.vote.subtitle':
    '每个已验证的关联钱包一票，按投票时钱包持有的 $WOC 加权。投票仅供参考且免费：不会发送任何交易。',
  'launchpad.vote.openBtn': '开启社区投票',
  'launchpad.vote.yes': '投赞成票',
  'launchpad.vote.no': '投反对票',
  'launchpad.vote.tallyYes': '赞成：{amount} $WOC',
  'launchpad.vote.tallyNo': '反对：{amount} $WOC',
  'launchpad.vote.tallyAria': '赞成票权重占比',
  'launchpad.vote.quorum': '法定人数：{current} / {required} $WOC',
  'launchpad.vote.quorumAria': '法定人数进度',
  'launchpad.vote.threshold': '达到法定人数且赞成率达 {pct}% 时通过',
  'launchpad.vote.yourVote': '您的投票已记录，权重 {amount} $WOC。',
  'launchpad.vote.outcomePending': '尚未达到法定人数。',
  'launchpad.vote.outcomePassed': '投票已通过。预售已解锁。',
  'launchpad.vote.outcomeFailed': '赞成票低于门槛。',
  'launchpad.presale.title': '预售',
  'launchpad.presale.subtitle':
    '用 SOL、USDC 或 $WOC 为发射出资。资金直接进入创始人托管钱包；本服务器只验证您的交易，绝不保管资金。',
  'launchpad.presale.stripeDeferred': '本阶段暂不支持银行卡支付。',
  'launchpad.presale.progress': '软顶进度 {pct}%',
  'launchpad.presale.progressAria': '预售软顶进度',
  'launchpad.presale.railRaised': '已筹 {raised} / {cap} {currency}',
  'launchpad.presale.railWalletRemaining': '您的剩余额度：{amount} {currency}',
  'launchpad.presale.railFull': '该币种已达上限。',
  'launchpad.presale.amountLabel': '金额（{currency}）',
  'launchpad.presale.contribute': '出资',
  'launchpad.presale.contributeConnect': '连接钱包以出资',
  'launchpad.presale.escrowNote': '托管钱包：{address}',
  'launchpad.presale.refundTerms':
    '如果预售未达软顶，创始人将从托管钱包退款，每笔退款都会先经链上验证才计入。',
  'launchpad.presale.softCapMet': '已达到软顶。',
  'launchpad.presale.finalize': '结束预售',
  'launchpad.presale.finalizeHint': '结束预售：达到软顶则判定为已达标，否则开启退款。',
  'launchpad.presale.notConfigured': '创始人尚未开放出资。',
  'launchpad.presale.refundTitle': '退款',
  'launchpad.presale.refundNote': '本次预售未达软顶。退款由托管钱包支付并经链上验证。',
  'launchpad.presale.refundRemaining': '等待退款验证的出资：{count}',
  'launchpad.presale.refundDone': '所有出资都已完成经验证的退款。',
  'launchpad.presale.config.title': '开放出资',
  'launchpad.presale.config.subtitle':
    '设置您掌控的托管钱包和各币种上限。留空即停用该币种。金额为整单位。',
  'launchpad.presale.config.escrowLabel': '托管钱包地址',
  'launchpad.presale.config.softLabel': '软顶（{currency}）',
  'launchpad.presale.config.raiseLabel': '筹集上限（{currency}）',
  'launchpad.presale.config.walletLabel': '单钱包上限（{currency}）',
  'launchpad.presale.config.submit': '开启预售',
  'launchpad.flow.registering': '正在注册代币...',
  'launchpad.flow.openingVote': '正在开启投票...',
  'launchpad.flow.castingVote': '正在记录您的投票...',
  'launchpad.flow.configuring': '正在开放出资...',
  'launchpad.flow.quoting': '正在预留您的出资...',
  'launchpad.flow.paying': '请在钱包中批准转账...',
  'launchpad.flow.confirming': '正在链上验证您的出资...',
  'launchpad.flow.contributed': '出资已记录。',
  'launchpad.flow.finalizing': '正在结束预售...',
  'launchpad.err.not_realm_owner': '您不是该服务器的运营者。',
  'launchpad.err.realm_not_found': '该服务器已不存在。',
  'launchpad.err.realm_not_active': '该服务器未处于活跃状态。',
  'launchpad.err.invalid_token_symbol': '请选择 2 到 10 个字符的大写字母和数字代码。',
  'launchpad.err.invalid_token_icon': '该代币图标无效。',
  'launchpad.err.invalid_token_policy': '请选择变现政策。',
  'launchpad.err.token_already_registered': '该服务器已注册代币。',
  'launchpad.err.token_not_registered': '该服务器没有注册代币。',
  'launchpad.err.vote_not_open': '社区投票尚未开启。',
  'launchpad.err.vote_not_openable': '当前状态无法开启投票。',
  'launchpad.err.invalid_vote_choice': '请选择赞成或反对。',
  'launchpad.err.wallet_not_linked': '请先在您的账户上验证钱包。',
  'launchpad.err.vote_weight_unavailable': '无法读取您的 $WOC 余额。请稍后再试。',
  'launchpad.err.no_vote_weight': '您的已验证钱包没有可用于投票的整数 $WOC。',
  'launchpad.err.already_voted': '该钱包或账户已经投过票。',
  'launchpad.err.presale_not_open': '预售未开启。',
  'launchpad.err.presale_not_configured': '创始人尚未开放出资。',
  'launchpad.err.presale_already_configured': '出资已经开放。',
  'launchpad.err.presale_not_refunding': '本次预售不在退款阶段。',
  'launchpad.err.presale_unavailable': '预售暂时不可用。请稍后再试。',
  'launchpad.err.invalid_escrow_wallet': '该托管钱包地址无效。',
  'launchpad.err.invalid_presale_caps':
    '这些上限无效。每个启用的币种需要软顶、不低于软顶的筹集上限和单钱包上限。',
  'launchpad.err.invalid_currency': '请选择 SOL、USDC 或 $WOC。',
  'launchpad.err.currency_not_enabled': '本次预售不接受该币种。',
  'launchpad.err.invalid_amount': '请输入有效金额。',
  'launchpad.err.wallet_cap_exceeded': '这将超过您的单钱包上限。',
  'launchpad.err.raise_cap_exceeded': '这将超过总筹集上限。',
  'launchpad.err.quote_not_found': '找不到您的报价。请重新开始。',
  'launchpad.err.not_your_quote': '该报价属于其他账户。',
  'launchpad.err.quote_expired': '您的报价已过期。请重新开始。',
  'launchpad.err.contribution_already_recorded': '该交易已被记录。',
  'launchpad.err.contribution_not_found': '找不到该出资。',
  'launchpad.err.already_refunded': '该出资已退款。',
  'launchpad.err.refund_sig_reused': '该退款交易已用于另一笔出资。',
  'launchpad.err.wrong_refunder': '退款必须由托管钱包支付。',
  'launchpad.err.refund_short': '退款金额不足以覆盖该出资。',
  'launchpad.err.bad_signature': '该交易签名无效。请重新开始。',
  'launchpad.err.not_finalized': '您的交易尚未最终确认。请稍后再试。',
  'launchpad.err.tx_failed': '交易在链上失败。',
  'launchpad.err.token_2022': '此处不支持该代币程序。',
  'launchpad.err.memo_mismatch': '该交易与您的报价不符。请重新开始。',
  'launchpad.err.wrong_payer': '交易必须由您的关联钱包签名。',
  'launchpad.err.escrow_short': '支付金额与您的报价不符。',
  'launchpad.err.missing_quoteId_or_paySig': '确认信息不完整。请重新开始。',
  'launchpad.err.missing_payTxSig_or_refundSig': '退款提交信息不完整。',
  'launchpad.err.rate_limited': '请求过多。请放慢速度后再试。',
  'launchpad.err.wallet_mismatch': '请连接您账户所关联的钱包。',
  'launchpad.err.generic': '出了点问题。请重试。',
  'launchpad.launch.title': '代币发射',
  'launchpad.launch.subtitle':
    '创建铸币、分配固定供应量,并将所有非公开份额锁定在链上。所有锁仓通过验证之前,代币无法上线。',
  'launchpad.launch.stepsAria': '发射流程步骤',
  'launchpad.launch.step.mint': '创建铸币',
  'launchpad.launch.step.locks': '分配并锁仓',
  'launchpad.launch.step.verify': '链上验证',
  'launchpad.launch.step.list': '正式上线',
  'launchpad.launch.supply': '固定供应量:{amount} {symbol}',
  'launchpad.launch.allocLine': '公开曲线 {publicPct}%,流动性 {liquidityPct}%(毕业时永久锁定)',
  'launchpad.launch.bucketLine':
    '{bucket}:{pct}%,{amount} {symbol},{cliff} 个月悬崖期 + {linear} 个月线性解锁',
  'launchpad.launch.bucket.founder': '创始人',
  'launchpad.launch.bucket.levy': 'Levy Street 基金',
  'launchpad.launch.bucket.treasury': '服务器金库',
  'launchpad.launch.lockProof': '{bucket}锁仓:',
  'launchpad.launch.mintCreated': '铸币:',
  'launchpad.launch.verifiedNote': '所有锁仓均已在链上验证。曲线开放后代币即可上线。',
  'launchpad.launch.createTitle': '创建铸币',
  'launchpad.launch.createHint':
    '您的钱包支付租金并作为铸币权限签名。服务器从不持有能转移资金的密钥:它只构建交易、锁定铸币地址,并在链上验证结果。',
  'launchpad.launch.treasuryLabel': '服务器金库钱包',
  'launchpad.launch.treasuryHint': '接收归属解锁的服务器金库份额。请使用您的服务器掌控的钱包。',
  'launchpad.launch.nameLabel': '代币名称(可选)',
  'launchpad.launch.uriLabel': '元数据网址(可选)',
  'launchpad.launch.createBtn': '创建铸币',
  'launchpad.launch.locksTitle': '验证锁仓',
  'launchpad.launch.locksHint':
    '铸出全部供应量,按上述确切条款创建三个不可撤销的 Jupiter Lock 托管,放弃铸币权限,然后在此粘贴每个托管地址。所有内容都会对照链上核验。',
  'launchpad.launch.lockLabel': '{bucket}锁仓托管地址',
  'launchpad.launch.verifyBtn': '链上验证',
  'launchpad.launch.checksAria': '链上验证清单',
  'launchpad.launch.checkPass': '通过',
  'launchpad.launch.checkFail': '未通过',
  'launchpad.launch.check.mint_found': '铸币账户可读取',
  'launchpad.launch.check.mint_profile': '干净的代币配置(无冻结、无挂钩、无费用)',
  'launchpad.launch.check.supply_exact': '固定供应量足额铸出',
  'launchpad.launch.check.mint_authority_renounced': '铸币权限已放弃',
  'launchpad.launch.check.lock_found': '找到锁仓托管',
  'launchpad.launch.check.lock_mint': '锁仓持有本代币',
  'launchpad.launch.check.lock_recipient': '锁仓接收人相符',
  'launchpad.launch.check.lock_immutable': '锁仓不可变(不可取消、不可更换接收人)',
  'launchpad.launch.check.lock_token_program': '锁仓使用正确的代币程序',
  'launchpad.launch.check.lock_untouched': '锁仓未领取且从未取消',
  'launchpad.launch.check.lock_amount': '锁定数量精确',
  'launchpad.launch.check.lock_schedule': '解锁计划满足承诺',
  'launchpad.launch.check.lock_funded': '锁仓托管持有代币',
  'launchpad.launch.check.unknown': '附加检查',
  'launchpad.flow.preparingMint': '正在准备铸币交易...',
  'launchpad.flow.signingMint': '请在钱包中批准铸币创建...',
  'launchpad.flow.confirmingMint': '正在链上验证铸币...',
  'launchpad.flow.mintDone': '铸币已创建并通过验证。',
  'launchpad.flow.verifying': '正在链上验证锁仓...',
  'launchpad.flow.verified': '发射已验证:所有锁仓均在链上。',
  'launchpad.flow.notVerified': '验证发现问题。请查看下方清单。',
  'launchpad.err.mint_already_created': '铸币已创建。',
  'launchpad.err.presale_not_funded': '预售尚未达标完成。',
  'launchpad.err.levy_fund_unconfigured': '平台基金钱包尚未配置。请稍后再试。',
  'launchpad.err.invalid_treasury_wallet': '该金库钱包地址无效。',
  'launchpad.err.invalid_token_name': '代币名称为 1 到 32 个普通字符。',
  'launchpad.err.invalid_token_uri': '元数据网址必须是 https 地址。',
  'launchpad.err.chain_unavailable': '无法连接链上网络。请稍后再试。',
  'launchpad.err.launch_not_prepared': '请先准备铸币交易。',
  'launchpad.err.mint_not_in_tx': '该交易没有创建锁定的铸币。',
  'launchpad.err.mint_not_found': '无法在链上读取铸币账户。',
  'launchpad.err.wrong_token_program': '铸币不在预期的代币程序之下。',
  'launchpad.err.wrong_decimals': '铸币的小数位数不符合预期。',
  'launchpad.err.freeze_authority_set': '铸币设有冻结权限。必须没有冻结权限。',
  'launchpad.err.bad_metadata_pointer': '铸币元数据指针错误或仍可更改。',
  'launchpad.err.metadata_symbol_mismatch': '链上代码与已注册代币不符。',
  'launchpad.err.unexpected_extension': '铸币带有不被允许的扩展。',
  'launchpad.err.launch_sig_replayed': '该发射交易已被使用。',
  'launchpad.err.mint_not_created': '请先创建并确认铸币。',
  'launchpad.err.invalid_lock_address': '请输入三个互不相同的有效锁仓托管地址。',
  'launchpad.err.launch_not_verifiable': '发射尚未准备好进行验证。',
  'launchpad.err.locks_not_verified': '锁仓尚未在链上验证。',
  'launchpad.err.not_listable': '当前状态下代币无法上线。',
  'launchpad.err.missing_sig': '确认信息不完整。请重新开始。',
  'launchpad.curve.title': '联合曲线',
  'launchpad.curve.subtitle':
    '代币在公开曲线上交易,人人同价。达到迁移阈值后,它将毕业进入流动性池,LP 永久锁定。',
  'launchpad.curve.lpLockLine': '发射配置将毕业 LP 的 {pct}% 永久锁定。',
  'launchpad.curve.poolLabel': '曲线池:',
  'launchpad.curve.progressAria': '迁移阈值进度',
  'launchpad.curve.progress': '已筹集 {raised},迁移目标 {threshold}',
  'launchpad.curve.migratedNote': '曲线已达到阈值并完成迁移。请在下方验证毕业。',
  'launchpad.curve.graduatedNote': '已毕业:LP 永久锁定的流动性池:',
  'launchpad.curve.openBtn': '开启曲线',
  'launchpad.curve.openHint':
    '构建由您的钱包签名的池创建交易。曲线主机铸造代币并持有曲线供应量;任何资金都不经过本服务器。',
  'launchpad.curve.verifyBtn': '验证曲线上线',
  'launchpad.curve.verifyHint': '池创建交易最终确认后,验证它以使代币上线。',
  'launchpad.curve.graduateBtn': '验证毕业',
  'launchpad.flow.preparingCurve': '正在准备曲线池...',
  'launchpad.flow.signingCurve': '请在钱包中批准池创建...',
  'launchpad.flow.curveSubmitted': '池创建已发送。最终确认后请验证上线。',
  'launchpad.flow.verifyingCurve': '正在链上验证曲线...',
  'launchpad.flow.curveListed': '代币已在曲线上线。',
  'launchpad.flow.verifyingGraduation': '正在链上验证毕业...',
  'launchpad.flow.graduated': '已毕业:LP 已永久锁定。',
  'launchpad.err.launchpad_disabled': '本服务器尚未启用曲线发射台。',
  'launchpad.err.launchpad_config_unreadable': '无法读取发射配置。请稍后再试。',
  'launchpad.err.curve_already_created': '曲线已存在。',
  'launchpad.err.host_requires_dbc_mint': '该曲线主机自行创建代币;预先铸造的代币无法进入。',
  'launchpad.err.invalid_base_mint': '该基础铸币地址无效。',
  'launchpad.err.curve_not_found': '尚未在链上找到曲线池。请稍后再试。',
  'launchpad.err.wrong_curve_creator': '曲线池必须由您的关联钱包创建。',
  'launchpad.err.not_live': '代币未在曲线上线。',
  'launchpad.err.not_migrated': '曲线尚未达到迁移阈值。',
  'launchpad.err.graduation_not_found': '尚未在链上找到毕业后的流动性池。',
  'launchpad.err.lp_not_permanently_locked': '流动性未被永久锁定。',
  'launchpad.err.not_damm_v2': '发射配置不会毕业到锁定池。',
  'launchpad.err.no_locked_vesting': '发射配置不含锁定归属。',
  'launchpad.err.no_migration_threshold': '发射配置没有迁移阈值。',
  'launchpad.fund.open': 'Levy Street 基金',
  'launchpad.fund.title': 'Levy Street 基金',
  'launchpad.fund.subtitle':
    '平台持有在此发射的每个服务器代币的锁定份额,实时展示。这是一个透明的金库,不是可以买入的基金:本页面的任何内容都不可买卖或赎回。',
  'launchpad.fund.loading': '正在加载投资组合...',
  'launchpad.fund.notPublished': '投资组合尚未发布。',
  'launchpad.fund.empty': '基金尚未持有任何服务器代币。',
  'launchpad.fund.aum': '总价值:{amount} USD',
  'launchpad.fund.updated': '更新于 {time}',
  'launchpad.fund.clampedNote': '单次刷新出现的大幅变动正在等待确认刷新。',
  'launchpad.fund.policyNote':
    '每笔持仓都按股权表上最严格的时间表归属(12 个月悬崖期 + 48 个月线性),处置需经治理审批。平台无法抛售这些持仓。',
  'launchpad.fund.tableAria': '基金持仓',
  'launchpad.fund.colToken': '代币',
  'launchpad.fund.colAmount': '数量',
  'launchpad.fund.colPrice': '价格(USD)',
  'launchpad.fund.colValue': '价值(USD)',
  'launchpad.fund.colWeight': '权重',
  'launchpad.fund.colStatus': '状态',
  'launchpad.fund.badgeLocked': '已锁定',
  'launchpad.fund.badgeGraduated': '已毕业',
  'launchpad.fund.statusIlliquid': '流动性不足(不计入总额)',
  'launchpad.fund.confidence.high': '已定价(交叉核验)',
  'launchpad.fund.confidence.medium': '已定价',
  'launchpad.fund.confidence.low': '已定价(置信度低)',
  'launchpad.fund.illiquidNote': '没有可信价格的持仓:{count}。仅展示,从不计入。',
  'launchpad.flow.quotingPower': '正在为您的兑换报价...',
  'launchpad.flow.powerQuoted': '您将获得 {copper} 铜币。请在钱包中批准转账...',
  'launchpad.flow.confirmingPower': '正在链上验证您的转账...',
  'launchpad.flow.powerCredited': '已向您的角色发放 {copper} 铜币。',
  'launchpad.flow.powerBanked': '已记入 {copper} 铜币。该角色下次登录时到账。',
  'launchpad.power.title': '兑换铜币',
  'launchpad.power.subtitle':
    '此付费变强服务器可将 {symbol} 兑换为游戏内铜币。代币将发送至服务器金库,转账在链上最终确认后发放铜币。',
  'launchpad.power.charLabel': '发放到角色',
  'launchpad.power.amountLabel': '数量({symbol})',
  'launchpad.power.convertBtn': '兑换铜币',
  'launchpad.power.convertConnect': '连接钱包并兑换',
  'launchpad.power.noCharacters': '请先在此服务器创建角色以接收铜币。',
  'launchpad.err.power_disabled': '本服务器未启用代币兑换铜币。',
  'launchpad.err.realm_not_power': '此服务器不允许代币兑换铜币。',
  'launchpad.err.token_not_live': '代币必须先在曲线上线。',
  'launchpad.err.power_rate_unset': '兑换汇率尚未配置。',
  'launchpad.err.power_sink_unavailable': '服务器金库尚不可用。',
  'launchpad.err.amount_below_minimum': '数量太小,无法兑换。',
