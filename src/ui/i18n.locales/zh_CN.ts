...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'launchpad.launches.open': '社区发射',
  'launchpad.launches.title': '社区发射',
  'launchpad.launches.subtitle': '正在进行代币发射投票或预售的服务器。任何人都可以投票或出资。',
  'launchpad.launches.loading': '正在加载社区发射……',
  'launchpad.launches.empty': '目前没有服务器在投票或预售中，请稍后再来查看。',
  'launchpad.launches.statusVoting': '社区投票',
  'launchpad.launches.statusPresale': '预售',
  'launchpad.launches.powerTag': '付费变强',
  'launchpad.launches.progressVoting': '法定人数进度 {pct}%',
  'launchpad.launches.progressPresale': '软顶进度 {pct}%',
  'launchpad.launches.ctaVote': '投票',
  'launchpad.launches.ctaContribute': '出资',
  'launchpad.levy.open': "莱维街基金",
  'launchpad.levy.title': "莱维街基金",
  'launchpad.levy.subtitle': "一个透明、仅供展示的投资组合，持有本平台发射的每个领域代币的一部分。",
  'launchpad.levy.displayOnlyNote': "仅供展示：基金与你一同持有这些代币，无法出售。没有基金份额，也没有赎回。",
  'launchpad.levy.loading': "正在加载投资组合……",
  'launchpad.levy.empty': "暂无持仓。已发射的领域代币在上线后会显示在此处。",
  'launchpad.levy.aum': "总价值（AUM）",
  'launchpad.levy.holdings': "{count} 项持仓",
  'launchpad.levy.excluded': "{count} 项因流动性不足被排除",
  'launchpad.levy.clamped': "本次刷新的价值变动已被限制，等待确认。",
  'launchpad.levy.updated': "更新于 {time}",
  'launchpad.levy.colToken': "代币",
  'launchpad.levy.colAmount': "数量",
  'launchpad.levy.colPrice': "价格",
  'launchpad.levy.colValue': "价值",
  'launchpad.levy.colWeight': "权重",
  'launchpad.levy.illiquidTag': "流动性不足",
  'launchpad.levy.sourceCurve': "曲线",
  'launchpad.levy.locked': "已在链上锁定",
  'launchpad.err.missing_payTxSig_or_refundSig': '退款提交信息不完整。',
  'launchpad.err.mint_not_ready': "只有在预售达标后才能铸造代币。",
  'launchpad.err.token_already_minted': "该代币已铸造。",
  'launchpad.err.token_not_minted': "请先铸造代币。",
  'launchpad.err.levy_wallet_unconfigured': "该服务器主机尚未启用代币发射。",
  'launchpad.err.launch_unavailable': "发射服务暂时不可用。请稍后再试。",
  'launchpad.err.launch_sig_reused': "该交易已被其他发射使用。",
  'launchpad.err.mint_mismatch': "链上铸币与本次发射不匹配。请重新开始。",
  'launchpad.err.already_distributed': "供应量已分配。",
  'launchpad.err.not_distributed': "请先分配供应量。",
  'launchpad.err.distribution_mismatch': "分配结果与分配方案不符。",
  'launchpad.err.invalid_lock_bucket': "请选择创始人、平台或金库锁仓。",
  'launchpad.err.already_locked': "该份额已锁仓。",
  'launchpad.err.lock_mismatch': "链上锁仓与本次发射不匹配。请重新开始。",
  'launchpad.err.lock_not_immutable': "该锁仓不是不可变的。必须任何人都无法取消。",
  'launchpad.err.lock_underfunded': "锁仓未持有全部份额。",
  'launchpad.err.locks_incomplete': "在创始人、平台和流动性锁仓全部通过链上验证之前，代币无法上线。",
  'launchpad.err.missing_quoteId_or_signature': "发射确认信息不完整。请重新开始。",
  'launchpad.err.curve_disabled': "该服务器主机尚未启用联合曲线发射。",
  'launchpad.err.fee_claimer_unconfigured': "平台费用金库尚未配置。",
  'launchpad.err.curve_already_launched': "该代币已有联合曲线。",
  'launchpad.err.curve_not_launched': "请先启动联合曲线。",
  'launchpad.err.curve_mismatch': "链上曲线与本次发射不匹配。请重新开始。",
  'launchpad.err.not_migrated': "曲线尚未毕业。",
  'launchpad.err.power_credit_disabled': "此处未启用使用该代币兑换游戏内力量。",
  'launchpad.err.power_sink_unconfigured': "该领域尚未设置代币消费。",
  'launchpad.err.not_power_realm': "该领域仅为装饰性：其代币无法购买游戏力量。",
  'launchpad.err.token_2022_mismatch': "该转账与此领域代币不匹配。请重新开始。",
  'launchpad.err.sink_not_credited': "转账未到达领域钱包。",
  'launchpad.err.amount_too_small': "该金额太小，无法兑换任何货币。",
  'launchpad.err.credit_already_recorded': "该转账已入账。",
  'launchpad.err.no_character_to_credit': "请登录该领域的角色以接收入账。",
  'launchpad.err.missing_payTxSig': "入账提交信息不完整。",
