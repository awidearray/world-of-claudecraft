...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.title': 'Магазин мерча',
  'hudChrome.merch.subtitle': 'Официальный мерч World of ClaudeCraft с доставкой по всему миру.',
  'hudChrome.merch.loading': 'Загрузка магазина…',
  'hudChrome.merch.unavailable': 'Магазин мерча сейчас недоступен. Ваши заказы и платежи не затронуты; загляните позже.',
  'hudChrome.merch.disclosure': 'Мерч производится и отправляется нашим печатным партнёром под заказ. Claudium, потраченный на мерч, не возвращается в виде Claudium; платежи картой и через Solana подчиняются политике возвратов в Условиях обслуживания.',
  'hudChrome.merch.catalogTitle': 'Каталог',
  'hudChrome.merch.catalogEmpty': 'Сейчас мерч недоступен.',
  'hudChrome.merch.variantLabel': 'Стиль и размер',
  'hudChrome.merch.addToCart': 'Добавить в корзину',
  'hudChrome.merch.outOfStock': 'Нет в наличии',
  'hudChrome.merch.cartTitle': 'Ваша корзина',
  'hudChrome.merch.cartEmpty': 'Ваша корзина пуста.',
  'hudChrome.merch.removeFromCart': 'Удалить из корзины',
  'hudChrome.merch.totalLabel': 'Итого',
  'hudChrome.merch.totalNote': 'Доставка и налоги добавляются при оформлении; итоговая сумма подтверждается на сервере.',
  'hudChrome.merch.claudiumPrice': '{amount} Claudium',
  'hudChrome.merch.checkoutTitle': 'Оформление заказа',
  'hudChrome.merch.loginRequired': 'Войдите в аккаунт, чтобы оформить заказ.',
  'hudChrome.merch.shipping.name': 'Полное имя',
  'hudChrome.merch.shipping.address1': 'Адрес',
  'hudChrome.merch.shipping.address2': 'Адрес, строка 2 (необязательно)',
  'hudChrome.merch.shipping.city': 'Город',
  'hudChrome.merch.shipping.state': 'Штат / регион',
  'hudChrome.merch.shipping.zip': 'Почтовый индекс',
  'hudChrome.merch.shipping.country': 'Страна',
  'hudChrome.merch.shipping.email': 'Эл. почта для уведомлений о заказе',
  'hudChrome.merch.shippingIncomplete': 'Заполните все обязательные поля доставки.',
  'hudChrome.merch.railLabel': 'Способ оплаты',
  'hudChrome.merch.railStripe': 'Карта',
  'hudChrome.merch.railSol': 'SOL',
  'hudChrome.merch.railClaudium': 'Claudium',
  'hudChrome.merch.payNow': 'Оформить заказ',
  'hudChrome.merch.checkoutPending': 'Заказ выполняется. Завершите оплату и не закрывайте эту страницу.',
  'hudChrome.merch.checkoutFailed': 'Не удалось начать оформление. Попробуйте ещё раз.',
  'hudChrome.merch.checkoutUnavailable': 'Этот заказ сейчас недоступен.',
  'hudChrome.merch.checkoutNotSettled': 'Транзакция отправлена, но заказ ещё не подтверждён. Проверьте свои заказы чуть позже.',
  'hudChrome.merch.orderPlaced': 'Заказ {orderId} оформлен. Отслеживайте его в списке заказов ниже.',
  'hudChrome.merch.ordersTitle': 'Ваши заказы',
  'hudChrome.merch.trackOrder': 'Отследить',
  'hudChrome.merch.status.pendingPayment': 'Ожидает оплаты',
  'hudChrome.merch.status.paid': 'Оплачен',
  'hudChrome.merch.status.submitted': 'Передан в производство',
  'hudChrome.merch.status.inProduction': 'В производстве',
  'hudChrome.merch.status.shipped': 'Отправлен',
  'hudChrome.merch.status.delivered': 'Доставлен',
  'hudChrome.merch.status.paymentFailed': 'Оплата не прошла',
  'hudChrome.merch.status.expired': 'Истёк',
  'hudChrome.merch.status.canceled': 'Отменён',
  'hudChrome.merch.status.refunded': 'Возвращён',
  'hudChrome.merch.status.fulfillmentFailed': 'Сбой отправки',
  'hudChrome.merch.status.unknown': 'В обработке',
