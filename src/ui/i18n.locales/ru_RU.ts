...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.tabsLabel': 'Вкладки Клаудиума',
  'hudChrome.claudium.tabBuy': 'Купить',
  'hudChrome.claudium.tabRedeem': 'Активировать',
  'hudChrome.claudium.railDisabled': 'Этот способ оплаты сейчас недоступен.',
  'hudChrome.claudium.oracleUnavailable':
    'Актуальные цены сейчас недоступны. Пожалуйста, повторите попытку чуть позже.',
  'hudChrome.claudium.quoteButton': 'Получить котировку',
  'hudChrome.claudium.amountRow': '{usd} за {claudium} Клаудиума',
  'hudChrome.claudium.sendExactly': 'Отправьте ровно {amount} {rail}',
  'hudChrome.claudium.addressLabel': 'Отправить на',
  'hudChrome.claudium.memoLabel': 'Заметка (обязательно)',
  'hudChrome.claudium.splitBurn': '{amount} {rail} сожжено',
  'hudChrome.claudium.splitTreasury': '{amount} {rail} в казну',
  'hudChrome.claudium.expiresIn': 'Котировка истекает через {time}',
  'hudChrome.claudium.quoteExpired': 'Эта котировка истекла. Получите новую.',
  'hudChrome.claudium.payNote':
    'Отправьте точную сумму с заметкой из своего кошелька, затем вставьте подпись транзакции для подтверждения. Сервис проверяет её в блокчейне перед начислением.',
  'hudChrome.claudium.signatureLabel': 'Подпись транзакции',
  'hudChrome.claudium.signaturePlaceholder': 'Вставьте подпись',
  'hudChrome.claudium.confirmButton': 'Подтвердить оплату',
  'hudChrome.claudium.confirmCredited': 'Начислено {amount} Клаудиума.',
  'hudChrome.claudium.confirmFailed': 'Этот платёж пока не удалось подтвердить. Пожалуйста, повторите чуть позже.',
  'hudChrome.claudium.redeemTitle': 'Активировать подарочную карту',
  'hudChrome.claudium.enterCode': 'Введите код подарочной карты',
  'hudChrome.claudium.redeemButton': 'Активировать',
  'hudChrome.claudium.redeemed': 'Активировано {amount} Клаудиума. Новый баланс: {balance}.',
  'hudChrome.claudium.redeemFailed': 'Этот код не удалось активировать. Проверьте код и повторите попытку.',
  'hudChrome.claudium.back': 'Назад',
};
