...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'launchpad.launch.title': 'Запуск токена',
  'launchpad.launch.subtitle':
    'Создайте минт, распределите фиксированное предложение и заблокируйте все непубличные доли в блокчейне. Пока все блокировки не подтверждены, токен не может выйти в продажу.',
  'launchpad.launch.stepsAria': 'Шаги запуска',
  'launchpad.launch.step.mint': 'Создать минт',
  'launchpad.launch.step.locks': 'Распределить и заблокировать',
  ...
  'launchpad.launch.bucket.levy': 'Фонд Levy Street',
  ...
  'launchpad.launch.locksTitle': 'Проверить блокировки',
  'launchpad.launch.locksHint':
    'Отчеканьте все предложение, создайте три неотменяемых эскроу Jupiter Lock точно на указанных условиях, откажитесь от права выпуска, затем вставьте сюда адрес каждого эскроу. Все сверяется с блокчейном.',
  'launchpad.launch.lockLabel': 'Адрес эскроу блокировки ({bucket})',
  'launchpad.launch.verifyBtn': 'Проверить в блокчейне',
  'launchpad.launch.checksAria': 'Чек-лист проверки в блокчейне',
  'launchpad.launch.checkPass': 'пройдено',
  'launchpad.launch.checkFail': 'не пройдено',
  'launchpad.launch.check.mint_found': 'Аккаунт минта читается',
  'launchpad.launch.check.mint_profile': 'Чистый профиль токена (без заморозки, хуков и комиссий)',
  'launchpad.launch.check.supply_exact': 'Фиксированное предложение отчеканено точно',
  'launchpad.launch.check.mint_authority_renounced': 'Право выпуска отозвано',
  ...
  'launchpad.launch.check.lock_schedule': 'График вестинга соответствует обязательству',
  'launchpad.launch.check.lock_funded': 'Эскроу блокировки держит токены',
  'launchpad.launch.check.unknown': 'Дополнительная проверка',
  'launchpad.flow.preparingMint': 'Подготовка транзакции минта...',
  'launchpad.flow.signingMint': 'Подтвердите создание минта в кошельке...',
  'launchpad.flow.confirmingMint': 'Проверка минта в блокчейне...',
  'launchpad.flow.mintDone': 'Минт создан и проверен.',
  'launchpad.flow.verifying': 'Проверка блокировок в блокчейне...',
  'launchpad.flow.verified': 'Запуск подтвержден: все блокировки в блокчейне.',
  ...
  'launchpad.err.chain_unavailable': 'Не удалось подключиться к блокчейну. Попробуйте позже.',
  'launchpad.err.launch_not_prepared': 'Сначала подготовьте транзакцию минта.',
  'launchpad.err.mint_not_in_tx': 'Эта транзакция не создала зафиксированный минт.',
  'launchpad.err.mint_not_found': 'Не удалось прочитать аккаунт минта в блокчейне.',
  'launchpad.err.wrong_token_program': 'Минт находится не под ожидаемой программой токена.',
  ...
  'launchpad.err.missing_sig': 'Подтверждение было неполным. Начните заново.',
  'launchpad.curve.title': 'Бондинговая кривая',
  'launchpad.curve.subtitle':
    'Токен торгуется на открытой кривой по одной цене для всех. При достижении порога миграции он выпускается в пул ликвидности с навсегда заблокированным LP.',
  'launchpad.curve.lpLockLine': 'Конфигурация запуска навсегда блокирует {pct}% LP при выпуске.',
  'launchpad.curve.poolLabel': 'Пул кривой:',
  ...
  'launchpad.err.not_live': 'Токен не торгуется на кривой.',
  'launchpad.err.not_migrated': 'Кривая не достигла порога миграции.',
  'launchpad.err.graduation_not_found': 'Пул ликвидности после выпуска еще не найден в блокчейне.',
  'launchpad.err.lp_not_permanently_locked': 'Ликвидность не заблокирована навсегда.',
  'launchpad.err.not_damm_v2': 'Конфигурация запуска не выпускает в заблокированный пул.',
  'launchpad.err.no_locked_vesting': 'В конфигурации запуска нет заблокированного вестинга.',
  'launchpad.err.no_migration_threshold': 'В конфигурации запуска нет порога миграции.',
  'launchpad.fund.open': 'Фонд Levy Street',
  'launchpad.fund.title': 'Фонд Levy Street',
  'launchpad.fund.subtitle':
    'Платформа держит заблокированную долю каждого токена мира, запущенного здесь, и показывает ее в реальном времени. Это прозрачная казна, а не фонд для покупки: ничего на этой странице нельзя купить, продать или погасить.',
  'launchpad.fund.loading': 'Загрузка портфеля...',
  'launchpad.fund.notPublished': 'Портфель еще не опубликован.',
  ...
  'launchpad.fund.colPrice': 'Цена (USD)',
  'launchpad.fund.colValue': 'Стоимость (USD)',
  'launchpad.fund.colWeight': 'Доля',
  'launchpad.fund.colStatus': 'Статус',
  'launchpad.fund.badgeLocked': 'Заблокировано',
  'launchpad.fund.badgeGraduated': 'Выпущено',
  'launchpad.fund.statusIlliquid': 'Неликвидно (исключено из итога)',
