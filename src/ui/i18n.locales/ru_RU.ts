...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.riverboat_dealer.name': 'Крупье Марибель',
  'entities.npcs.riverboat_dealer.title': 'Шулер Большого салона',
  'entities.npcs.riverboat_dealer.greeting': 'Присаживайтесь, {className}. Колода свежая, а раздача честная. Сыграем партию?',
  'entities.npcs.riverboat_pit_boss.name': 'Распорядитель Крейк',
  'entities.npcs.riverboat_pit_boss.title': 'Хозяин ставочного ринга',
  'entities.npcs.riverboat_pit_boss.greeting': 'Двое бойцов, один куш, {className}. Выходи на ринг и назови свою ставку.',
  'entities.npcs.riverboat_slots_attendant.name': 'Тилли Спрокет',
  'entities.npcs.riverboat_slots_attendant.title': 'Хранительница барабанов',
  'entities.npcs.riverboat_slots_attendant.greeting': 'Автоматы смазаны и готовы, {className}. Одно бесплатное вращение в день, и барабаны никогда не лгут.',
  'entities.npcs.riverboat_hilo_croupier.name': 'Интендант Нок',
  'entities.npcs.riverboat_hilo_croupier.title': 'Вещатель костей',
  'entities.npcs.riverboat_hilo_croupier.greeting': 'Больше или меньше, {className}, один бросок решает всё. Дом забирает лишь середину.',
  ...
  'hudChrome.hilo.title': 'Больше-меньше интенданта',
  'hudChrome.hilo.rules': 'Называйте «больше» или «меньше» на броске от 1 до 100. Меньше выигрывает на 1 до 49, больше на 52 до 100. Выплата равная.',
  'hudChrome.hilo.balance': 'Кошелёк: {amount}',
  'hudChrome.hilo.stakeLabel': 'Ставка',
  'hudChrome.hilo.prompt': 'Выберите ставку и назовите: больше или меньше.',
  'hudChrome.hilo.low': 'Меньше (1 до 49)',
  'hudChrome.hilo.high': 'Больше (52 до 100)',
  'hudChrome.hilo.session': 'За эту сессию: побед {wins}, поражений {losses}',
  'hudChrome.hilo.close': 'Закрыть',
  'hudChrome.hilo.wonLine': 'Выпало {roll}. Вы выиграли {amount}.',
  'hudChrome.hilo.lostLine': 'Выпало {roll}. Вы проиграли {amount}.',
  'hudChrome.hilo.wonLog': 'Больше-меньше: выпало {roll}, выигрыш {amount}.',
  'hudChrome.hilo.lostLog': 'Больше-меньше: выпало {roll}, проигрыш {amount}.',
};
