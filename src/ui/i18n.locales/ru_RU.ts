...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocSeason.close': 'Закрыть',
  'hudChrome.wocSeason.colPlayer': 'Игрок',
  'hudChrome.wocSeason.colRating': 'Рейтинг',
  ...
  'hudChrome.wocSeason.statusEnded': 'Завершён',
  'hudChrome.wocSeason.subtitle': 'Выплаты лучшим игрокам из казны',
  'hudChrome.wocSeason.title': 'Сезон наград $WOC',
  ...
  'realmOp.err.price_unavailable': 'Актуальные цены сейчас недоступны. Повторите попытку позже.',
  'realmOp.err.quote_expired': 'Срок котировки истёк. Начните заново.',
  'realmOp.err.quote_not_found': 'Ваша котировка не найдена. Начните заново.',
  'realmOp.err.rate_limited': 'Слишком много запросов. Подождите и повторите.',
  'realmOp.err.realm_cap_reached': 'Достигнут лимит миров на аккаунт.',
  'realmOp.err.realm_name_not_allowed': 'Такое имя мира не допускается.',
  'realmOp.err.realm_name_taken': 'Такое имя мира уже занято.',
  'realmOp.err.realm_not_active': 'Этот мир не активен.',
  'realmOp.err.realm_not_decommissioning': 'Этот мир не находится в процессе закрытия.',
  ...
  'realmOp.flow.closed': 'Мир закрыт. Имя снова свободно.',
  'realmOp.flow.confirming': 'Проверяем ваш стейк в блокчейне...',
  'realmOp.flow.confirmingBuy': 'Проверяем ваш платёж в блокчейне...',
  'realmOp.flow.connecting': 'Подключаем ваш кошелёк...',
  'realmOp.flow.decommissioning': 'Начинаем закрытие...',
  'realmOp.flow.founded': '{name} запущен. Добро пожаловать, оператор.',
  'realmOp.flow.locking': 'Подтвердите стейк в кошельке...',
  'realmOp.flow.paying': 'Подтвердите платёж в кошельке...',
  ...
  'realmOp.status.decommissioning': 'Закрывается',
  'realmOp.status.provisioning': 'Подготовка',
  'realmOp.tier.bronze': 'Бронза',
  'realmOp.tier.priceUnavailable': 'Нет цены',
  'realmOp.tier.share': '{pct}% предложения',
  'realmOp.tier.silver': 'Серебро',
  'launchpad.open': 'Токен-лаунчпад',
  'launchpad.title': 'Лаунчпад токена мира',
  'launchpad.back': 'Назад',
  'launchpad.loading': 'Загрузка состояния токена...',
  'launchpad.symbolBadge': 'Токен {symbol}',
  'launchpad.status.none': 'Токен не зарегистрирован',
  'launchpad.status.prelaunch': 'Перед запуском',
  'launchpad.status.voting': 'Голосование сообщества',
  'launchpad.status.presale': 'Предпродажа',
  'launchpad.status.funded': 'Профинансировано',
  'launchpad.status.refunding': 'Возврат средств',
  'launchpad.status.refunded': 'Средства возвращены',
  'launchpad.status.live': 'Запущен',
  'launchpad.status.graduated': 'Выпущен на биржу',
  'launchpad.status.closed': 'Закрыт',
  'launchpad.checklist.aria': 'Контрольный список запуска',
  'launchpad.checklist.register': 'Регистрация',
  'launchpad.checklist.vote': 'Голосование',
  'launchpad.checklist.presale': 'Предпродажа',
  ...
  'launchpad.vote.tallyYes': 'За: {amount} $WOC',
  'launchpad.vote.tallyNo': 'Против: {amount} $WOC',
  'launchpad.vote.tallyAria': 'Доля голосов «за» в общем весе',
  'launchpad.vote.quorum': 'Кворум: {current} из {required} $WOC',
  'launchpad.vote.quorumAria': 'Прогресс кворума',
  'launchpad.vote.threshold': 'Проходит при кворуме и {pct}% голосов «за»',
  'launchpad.vote.yourVote': 'Ваш голос записан с весом {amount} $WOC.',
  'launchpad.vote.outcomePending': 'Кворум еще не достигнут.',
  ...
  'launchpad.presale.railRaised': 'Собрано {raised} из {cap} {currency}',
  'launchpad.presale.railWalletRemaining': 'Ваш оставшийся лимит: {amount} {currency}',
  'launchpad.presale.railFull': 'Эта валюта достигла лимита.',
  'launchpad.presale.amountLabel': 'Сумма в {currency}',
  ...
  'launchpad.presale.config.walletLabel': 'Лимит на кошелек ({currency})',
  'launchpad.presale.config.submit': 'Открыть предпродажу',
  'launchpad.flow.registering': 'Регистрация токена...',
  'launchpad.flow.openingVote': 'Открытие голосования...',
  'launchpad.flow.castingVote': 'Запись вашего голоса...',
  'launchpad.flow.configuring': 'Открытие приема взносов...',
  'launchpad.flow.quoting': 'Резервирование вашего взноса...',
  'launchpad.flow.paying': 'Подтвердите перевод в кошельке...',
  'launchpad.flow.confirming': 'Проверка вашего взноса в блокчейне...',
  'launchpad.flow.contributed': 'Взнос записан.',
  'launchpad.flow.finalizing': 'Завершение предпродажи...',
  'launchpad.err.not_realm_owner': 'Вы не управляете этим миром.',
  'launchpad.err.realm_not_found': 'Этот мир больше не существует.',
  'launchpad.err.realm_not_active': 'Этот мир не активен.',
  'launchpad.err.invalid_token_symbol': 'Выберите тикер из 2-10 заглавных букв и цифр.',
  'launchpad.err.invalid_token_icon': 'Этот значок токена недопустим.',
  'launchpad.err.invalid_token_policy': 'Выберите политику монетизации.',
  'launchpad.err.token_already_registered': 'У этого мира уже есть зарегистрированный токен.',
  'launchpad.err.token_not_registered': 'У этого мира нет зарегистрированного токена.',
  'launchpad.err.vote_not_open': 'Голосование сообщества не открыто.',
  ...
  'launchpad.err.presale_not_configured': 'Основатель еще не открыл прием взносов.',
  'launchpad.err.presale_already_configured': 'Прием взносов уже открыт.',
  ...
  'launchpad.err.wallet_cap_exceeded': 'Это превысит ваш лимит на кошелек.',
  'launchpad.err.raise_cap_exceeded': 'Это превысит общий потолок сбора.',
  'launchpad.err.quote_not_found': 'Ваша заявка не найдена. Начните заново.',
  'launchpad.err.not_your_quote': 'Эта заявка принадлежит другому аккаунту.',
  'launchpad.err.quote_expired': 'Срок заявки истек. Начните заново.',
  'launchpad.err.contribution_already_recorded': 'Эта транзакция уже записана.',
  'launchpad.err.contribution_not_found': 'Этот взнос не найден.',
  'launchpad.err.already_refunded': 'Этот взнос уже возвращен.',
  'launchpad.err.refund_sig_reused': 'Эта транзакция возврата уже покрывает другой взнос.',
  'launchpad.err.wrong_refunder': 'Возврат должен быть оплачен эскроу-кошельком.',
  'launchpad.err.refund_short': 'Возврат не покрывает взнос.',
  'launchpad.err.bad_signature': 'Подпись транзакции недействительна. Начните заново.',
  'launchpad.err.not_finalized': 'Транзакция еще не финализирована. Попробуйте через минуту.',
  'launchpad.err.tx_failed': 'Транзакция завершилась ошибкой в блокчейне.',
  'launchpad.err.token_2022': 'Эта токен-программа здесь не поддерживается.',
  'launchpad.err.memo_mismatch': 'Транзакция не соответствует вашей заявке. Начните заново.',
  'launchpad.err.wrong_payer': 'Транзакция должна быть подписана привязанным кошельком.',
  'launchpad.err.escrow_short': 'Оплаченная сумма не совпадает с заявкой.',
  'launchpad.err.missing_quoteId_or_paySig': 'Подтверждение было неполным. Начните заново.',
  'launchpad.launches.open': 'Запуски сообщества',
  'launchpad.launches.title': 'Запуски сообщества',
  'launchpad.launches.subtitle':
    'Миры, где сейчас идёт голосование за запуск токена или предпродажа. Голосовать или внести вклад может любой.',
  'launchpad.launches.loading': 'Загрузка запусков сообщества...',
  'launchpad.launches.empty': 'Сейчас ни один мир не голосует и не проводит предпродажу. Загляните позже.',
  'launchpad.launches.statusVoting': 'Голосование сообщества',
  'launchpad.launches.statusPresale': 'Предпродажа',
  'launchpad.launches.powerTag': 'Плати и побеждай',
  'launchpad.launches.progressVoting': '{pct}% кворума',
  'launchpad.launches.progressPresale': '{pct}% мягкого потолка',
  'launchpad.launches.ctaVote': 'Голосовать',
  'launchpad.launches.ctaContribute': 'Внести вклад',
  'launchpad.levy.open': "Фонд Леви-Стрит",
  'launchpad.levy.title': "Фонд Леви-Стрит",
  'launchpad.levy.subtitle': "Прозрачный портфель только для отображения, содержащий долю каждого токена мира, запущенного здесь.",
  'launchpad.levy.displayOnlyNote': "Только для отображения: фонд держит эти токены рядом с вами и не может их продать. Нет доли фонда и нет погашения.",
  'launchpad.levy.loading': "Загрузка портфеля……",
  'launchpad.levy.empty': "Пока нет активов. Запущенные токены миров появятся здесь после листинга.",
  'launchpad.levy.aum': "Общая стоимость (AUM)",
  'launchpad.levy.holdings': "{count} активов",
  'launchpad.levy.excluded': "{count} исключено как неликвидные",
  'launchpad.levy.clamped': "Изменение стоимости при этом обновлении ограничено до подтверждения.",
  'launchpad.levy.updated': "Обновлено {time}",
  'launchpad.levy.colToken': "Токен",
  'launchpad.levy.colAmount': "Количество",
  'launchpad.levy.colPrice': "Цена",
  'launchpad.levy.colValue': "Стоимость",
  'launchpad.levy.colWeight': "Вес",
  'launchpad.levy.illiquidTag': "неликвид",
  'launchpad.levy.sourceCurve': "кривая",
  'launchpad.levy.locked': "Заблокировано в сети",
  'launchpad.err.missing_payTxSig_or_refundSig': 'Данные возврата были неполными.',
  'launchpad.err.mint_not_ready': "Токен можно выпустить только после успешного пресейла.",
  'launchpad.err.token_already_minted': "Этот токен уже выпущен.",
  'launchpad.err.token_not_minted': "Сначала выпустите токен.",
  'launchpad.err.levy_wallet_unconfigured': "Запуск токенов на этом хосте мира еще не включен.",
  'launchpad.err.launch_unavailable': "Сервис запуска временно недоступен. Попробуйте позже.",
  'launchpad.err.launch_sig_reused': "Эта транзакция уже использована другим запуском.",
  'launchpad.err.mint_mismatch': "Минт в сети не соответствует этому запуску. Начните заново.",
  'launchpad.err.already_distributed': "Предложение уже распределено.",
  'launchpad.err.not_distributed': "Сначала распределите предложение.",
  'launchpad.err.distribution_mismatch': "Распределение не соответствует плану аллокации.",
  'launchpad.err.invalid_lock_bucket': "Выберите блокировку основателя, платформы или казны.",
  'launchpad.err.already_locked': "Эта доля уже заблокирована.",
  'launchpad.err.lock_mismatch': "Блокировка в сети не соответствует этому запуску. Начните заново.",
  'launchpad.err.lock_not_immutable': "Эта блокировка не является неизменяемой. Никто не должен иметь возможности ее отменить.",
  'launchpad.err.lock_underfunded': "В блокировке нет полной суммы доли.",
  'launchpad.err.locks_incomplete': "Токен не может выйти на листинг, пока блокировки основателя, платформы и ликвидности не подтверждены в сети.",
  'launchpad.err.missing_quoteId_or_signature': "Подтверждение запуска было неполным. Начните заново.",
  'launchpad.err.curve_disabled': "Запуск через бондинг-кривую на этом хосте мира еще не включен.",
  'launchpad.err.fee_claimer_unconfigured': "Комиссионное хранилище платформы еще не настроено.",
  'launchpad.err.curve_already_launched': "У этого токена уже есть бондинг-кривая.",
  'launchpad.err.curve_not_launched': "Сначала запустите бондинг-кривую.",
  'launchpad.err.curve_mismatch': "Кривая в сети не соответствует этому запуску. Начните заново.",
  'launchpad.err.not_migrated': "Кривая еще не завершила выпуск.",
  'launchpad.err.power_credit_disabled': "Трата этого токена на внутриигровую силу здесь не включена.",
  'launchpad.err.power_sink_unconfigured': "В этом мире еще не настроена трата токенов.",
  'launchpad.err.not_power_realm': "Этот мир только косметический: его токен не может покупать игровую силу.",
  'launchpad.err.token_2022_mismatch': "Этот перевод не соответствует токену мира. Начните заново.",
  'launchpad.err.sink_not_credited': "Перевод не дошел до кошелька мира.",
  'launchpad.err.amount_too_small': "Эта сумма слишком мала для зачисления монет.",
  'launchpad.err.credit_already_recorded': "Этот перевод уже зачислен.",
  'launchpad.err.no_character_to_credit': "Войдите персонажем в этом мире, чтобы получить зачисление.",
  'launchpad.err.missing_payTxSig': "Данные зачисления были неполными.",
  'launchpad.err.rate_limited': 'Слишком много запросов. Помедленнее и попробуйте снова.',
  'launchpad.err.wallet_mismatch': 'Подключите кошелек, привязанный к аккаунту.',
  'launchpad.err.generic': 'Что-то пошло не так. Попробуйте еще раз.',
};
