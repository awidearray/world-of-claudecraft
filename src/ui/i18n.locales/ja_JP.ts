...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'launchpad.launch.title': 'トークンローンチ',
  'launchpad.launch.subtitle':
    'ミントを作成し、固定供給量を配分し、非公開の割り当てをすべてオンチェーンでロックします。すべてのロックが検証されるまで、トークンは公開できません。',
  'launchpad.launch.stepsAria': 'ローンチ手順',
  'launchpad.launch.step.mint': 'ミント作成',
  'launchpad.launch.step.locks': '配分とロック',
  ...
  'launchpad.launch.bucket.levy': 'Levy Street ファンド',
  ...
  'launchpad.launch.locksTitle': 'ロックを検証',
  'launchpad.launch.locksHint':
    '全供給量をミントし、上記の条件どおりに取り消し不能な Jupiter Lock エスクローを 3 つ作成し、ミント権限を放棄してから、各エスクローのアドレスをここに貼り付けてください。すべてがチェーンと照合されます。',
  'launchpad.launch.lockLabel': '{bucket}のロックエスクローアドレス',
  'launchpad.launch.verifyBtn': 'オンチェーンで検証',
  'launchpad.launch.checksAria': 'オンチェーン検証チェックリスト',
  'launchpad.launch.checkPass': '合格',
  'launchpad.launch.checkFail': '不合格',
  'launchpad.launch.check.mint_found': 'ミントアカウントを読み取れる',
  'launchpad.launch.check.mint_profile': 'クリーンなトークン設定(凍結なし、フックなし、手数料なし)',
  'launchpad.launch.check.supply_exact': '固定供給量が正確にミント済み',
  'launchpad.launch.check.mint_authority_renounced': 'ミント権限を放棄済み',
  'launchpad.launch.check.lock_found': 'ロックエスクローを確認',
  'launchpad.launch.check.lock_mint': 'ロックがこのトークンを保持',
  'launchpad.launch.check.lock_recipient': 'ロックの受取人が一致',
  'launchpad.launch.check.lock_immutable': 'ロックは不変(取り消し不可、受取人変更不可)',
  'launchpad.launch.check.lock_token_program': 'ロックが正しいトークンプログラムを使用',
  'launchpad.launch.check.lock_untouched': 'ロックは未請求かつ未取り消し',
  'launchpad.launch.check.lock_amount': 'ロック額が正確',
  'launchpad.launch.check.lock_schedule': 'ベスティング計画が約束を満たす',
  'launchpad.launch.check.lock_funded': 'ロックエスクローがトークンを保持',
  'launchpad.launch.check.unknown': '追加チェック',
  'launchpad.flow.preparingMint': 'ミントトランザクションを準備しています...',
  'launchpad.flow.signingMint': 'ウォレットでミント作成を承認してください...',
  'launchpad.flow.confirmingMint': 'オンチェーンでミントを検証しています...',
  ...
  'launchpad.err.missing_sig': '確認が不完全でした。最初からやり直してください。',
  'launchpad.curve.title': 'ボンディングカーブ',
  'launchpad.curve.subtitle':
    'トークンは誰でも同じ価格のオープンカーブで取引されます。移行しきい値に達すると、LP が永久ロックされる流動性プールへ卒業します。',
  'launchpad.curve.lpLockLine': 'ローンチ設定により、卒業 LP の {pct}% が永久ロックされます。',
  ...
  'launchpad.flow.curveSubmitted': 'プール作成を送信しました。確定後に上場を検証してください。',
  'launchpad.flow.verifyingCurve': 'オンチェーンでカーブを検証しています...',
  ...
  'launchpad.err.lp_not_permanently_locked': '流動性は永久ロックされていません。',
  'launchpad.err.not_damm_v2': 'ローンチ設定はロック付きプールへ卒業しません。',
  'launchpad.err.no_locked_vesting': 'ローンチ設定にロックされたベスティングがありません。',
  'launchpad.err.no_migration_threshold': 'ローンチ設定に移行しきい値がありません。',
  'launchpad.fund.open': 'Levy Street ファンド',
  'launchpad.fund.title': 'Levy Street ファンド',
  'launchpad.fund.subtitle':
    'プラットフォームは、ここでローンチされた各レルムトークンのロック済み持分を保有し、ライブで公開しています。これは透明なトレジャリーであり、購入できるファンドではありません。このページのいかなるものも売買や償還はできません。',
  'launchpad.fund.loading': 'ポートフォリオを読み込んでいます...',
  'launchpad.fund.notPublished': 'ポートフォリオはまだ公開されていません。',
  'launchpad.fund.empty': 'ファンドはまだレルムトークンを保有していません。',
  ...
  'launchpad.fund.colPrice': '価格 (USD)',
  'launchpad.fund.colValue': '評価額 (USD)',
  'launchpad.fund.colWeight': '比率',
  'launchpad.fund.colStatus': '状態',
  'launchpad.fund.badgeLocked': 'ロック済み',
  'launchpad.fund.badgeGraduated': '卒業済み',
  'launchpad.fund.statusIlliquid': '流動性不足(総額から除外)',
