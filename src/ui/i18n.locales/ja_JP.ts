...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.title': 'グッズストア',
  'hudChrome.merch.subtitle': '公式『World of ClaudeCraft』グッズを世界中へお届けします。',
  'hudChrome.merch.loading': 'ストアを読み込み中…',
  'hudChrome.merch.unavailable': 'グッズストアは現在ご利用いただけません。ご注文とお支払いに影響はありません。しばらくしてからもう一度お試しください。',
  'hudChrome.merch.disclosure': 'グッズは印刷パートナーが受注生産で製作・発送します。グッズ購入に使用した Claudium は Claudium として返金できません。カードおよび Solana でのお支払いは利用規約の返金ポリシーに従います。',
  'hudChrome.merch.catalogTitle': 'カタログ',
  'hudChrome.merch.catalogEmpty': '現在購入できるグッズはありません。',
  'hudChrome.merch.variantLabel': 'スタイルとサイズ',
  'hudChrome.merch.addToCart': 'カートに追加',
  'hudChrome.merch.outOfStock': '在庫切れ',
  'hudChrome.merch.cartTitle': 'カート',
  'hudChrome.merch.cartEmpty': 'カートは空です。',
  'hudChrome.merch.removeFromCart': 'カートから削除',
  'hudChrome.merch.totalLabel': '合計',
  'hudChrome.merch.totalNote': '送料と税金はチェックアウト時に加算されます。最終金額はサーバー側で確定します。',
  'hudChrome.merch.claudiumPrice': '{amount} Claudium',
  'hudChrome.merch.checkoutTitle': 'チェックアウト',
  'hudChrome.merch.loginRequired': 'チェックアウトにはアカウントへのログインが必要です。',
  'hudChrome.merch.shipping.name': '氏名',
  'hudChrome.merch.shipping.address1': '住所',
  'hudChrome.merch.shipping.address2': '住所2行目（任意）',
  'hudChrome.merch.shipping.city': '市区町村',
  'hudChrome.merch.shipping.state': '都道府県/州',
  'hudChrome.merch.shipping.zip': '郵便番号',
  'hudChrome.merch.shipping.country': '国',
  'hudChrome.merch.shipping.email': '注文通知用メールアドレス',
  'hudChrome.merch.shippingIncomplete': '必須の配送先項目をすべて入力してください。',
  'hudChrome.merch.railLabel': '支払い方法',
  'hudChrome.merch.railStripe': 'カード',
  'hudChrome.merch.railSol': 'SOL',
  'hudChrome.merch.railClaudium': 'Claudium',
  'hudChrome.merch.payNow': '注文を確定',
  'hudChrome.merch.checkoutPending': '注文処理中です。支払いを完了し、このページを開いたままにしてください。',
  'hudChrome.merch.checkoutFailed': 'チェックアウトを開始できませんでした。もう一度お試しください。',
  'hudChrome.merch.checkoutUnavailable': 'その注文は現在ご利用いただけません。',
  'hudChrome.merch.checkoutNotSettled': 'トランザクションは送信されましたが、注文はまだ確認されていません。しばらくしてから注文をご確認ください。',
  'hudChrome.merch.orderPlaced': '注文 {orderId} を受け付けました。下の注文一覧で追跡できます。',
  'hudChrome.merch.ordersTitle': '注文履歴',
  'hudChrome.merch.trackOrder': '追跡',
  'hudChrome.merch.status.pendingPayment': '支払い待ち',
  'hudChrome.merch.status.paid': '支払い済み',
  'hudChrome.merch.status.submitted': '生産へ送信済み',
  'hudChrome.merch.status.inProduction': '生産中',
  'hudChrome.merch.status.shipped': '発送済み',
  'hudChrome.merch.status.delivered': '配達済み',
  'hudChrome.merch.status.paymentFailed': '支払い失敗',
  'hudChrome.merch.status.expired': '期限切れ',
  'hudChrome.merch.status.canceled': 'キャンセル済み',
  'hudChrome.merch.status.refunded': '返金済み',
  'hudChrome.merch.status.fulfillmentFailed': '発送処理失敗',
  'hudChrome.merch.status.unknown': '処理中',
