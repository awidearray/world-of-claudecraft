...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocSeason.close': '閉じる',
  'hudChrome.wocSeason.colPlayer': 'プレイヤー',
  'hudChrome.wocSeason.colRating': 'レーティング',
  ...
  'hudChrome.wocSeason.statusEnded': '終了',
  'hudChrome.wocSeason.subtitle': 'トレジャリー資金による上位プレイヤーへの支払い',
  ...
  'realmOp.err.realm_cap_reached': 'アカウントごとのワールド数の上限に達しています。',
  'realmOp.err.realm_name_not_allowed': 'そのワールド名は使用できません。',
  'realmOp.err.realm_name_taken': 'そのワールド名はすでに使われています。',
  'realmOp.err.realm_not_active': 'そのワールドはアクティブではありません。',
  ...
  'realmOp.flow.closed': 'ワールドを閉鎖しました。その名前は再び使用できます。',
  'realmOp.flow.confirming': 'ステークをオンチェーンで検証中...',
  'realmOp.flow.confirmingBuy': '支払いをオンチェーンで検証中...',
  'realmOp.flow.connecting': 'ウォレットに接続中...',
  'realmOp.flow.decommissioning': '廃止処理を開始しています...',
  'realmOp.flow.founded': '{name} が稼働しました。ようこそ、運営者どの。',
  'realmOp.flow.locking': 'ウォレットでステークを承認してください...',
  'realmOp.flow.paying': 'ウォレットで支払いを承認してください...',
  ...
  'realmOp.status.decommissioning': '廃止処理中',
  'realmOp.status.provisioning': 'プロビジョニング中',
  'realmOp.tier.bronze': 'ブロンズ',
  'realmOp.tier.priceUnavailable': '価格なし',
  'realmOp.tier.share': '供給量の {pct}%',
  'realmOp.tier.silver': 'シルバー',
  'launchpad.open': 'トークンローンチパッド',
  'launchpad.title': 'ワールドトークン・ローンチパッド',
  'launchpad.back': '戻る',
  'launchpad.loading': 'トークン状態を読み込み中...',
  'launchpad.symbolBadge': '{symbol} トークン',
  'launchpad.status.none': 'トークン未登録',
  'launchpad.status.prelaunch': 'プレローンチ',
  'launchpad.status.voting': 'コミュニティ投票',
  'launchpad.status.presale': 'プレセール',
  'launchpad.status.funded': '達成',
  'launchpad.status.refunding': '返金中',
  'launchpad.status.refunded': '返金済み',
  'launchpad.status.live': '公開中',
  'launchpad.status.graduated': '卒業済み',
  'launchpad.status.closed': '終了',
  'launchpad.checklist.aria': 'ローンチチェックリスト',
  'launchpad.checklist.register': '登録',
  'launchpad.checklist.vote': '投票',
  'launchpad.checklist.presale': 'プレセール',
  ...
  'launchpad.vote.tallyYes': '賛成：{amount} $WOC',
  'launchpad.vote.tallyNo': '反対：{amount} $WOC',
  'launchpad.vote.tallyAria': '投票済みウェイトに占める賛成の割合',
  'launchpad.vote.quorum': 'クォーラム：{current} / {required} $WOC',
  'launchpad.vote.quorumAria': 'クォーラムの進捗',
  'launchpad.vote.threshold': 'クォーラム達成かつ賛成 {pct}% で可決',
  'launchpad.vote.yourVote': 'あなたの投票は {amount} $WOC のウェイトで記録されています。',
  'launchpad.vote.outcomePending': 'まだクォーラムに達していません。',
  ...
  'launchpad.presale.railRaised': '{currency} 調達額 {raised} / {cap}',
  'launchpad.presale.railWalletRemaining': 'あなたの残り上限：{amount} {currency}',
  'launchpad.presale.railFull': 'この通貨は上限に達しました。',
  ...
  'launchpad.presale.config.walletLabel': 'ウォレットごとの上限（{currency}）',
  'launchpad.presale.config.submit': 'プレセールを開始',
  'launchpad.flow.registering': 'トークンを登録中...',
  'launchpad.flow.openingVote': '投票を開始中...',
  'launchpad.flow.castingVote': '投票を記録中...',
  'launchpad.flow.configuring': '貢献受付を準備中...',
  'launchpad.flow.quoting': '貢献枠を確保中...',
  'launchpad.flow.paying': 'ウォレットで送金を承認してください...',
  'launchpad.flow.confirming': '貢献をオンチェーンで検証中...',
  'launchpad.flow.contributed': '貢献が記録されました。',
  'launchpad.flow.finalizing': 'プレセールを確定中...',
  ...
  'launchpad.err.token_not_registered': 'このワールドには登録されたトークンがありません。',
  'launchpad.err.vote_not_open': 'コミュニティ投票は開いていません。',
  ...
  'launchpad.err.wallet_cap_exceeded': 'ウォレットごとの上限を超えてしまいます。',
  'launchpad.err.raise_cap_exceeded': '総調達上限を超えてしまいます。',
  'launchpad.err.quote_not_found': '見積もりが見つかりませんでした。最初からやり直してください。',
  'launchpad.err.not_your_quote': 'その見積もりは別のアカウントのものです。',
  'launchpad.err.quote_expired': '見積もりの期限が切れました。最初からやり直してください。',
  'launchpad.err.contribution_already_recorded': 'そのトランザクションは記録済みです。',
  'launchpad.err.contribution_not_found': 'その貢献が見つかりません。',
  'launchpad.err.already_refunded': 'その貢献はすでに返金済みです。',
  'launchpad.err.refund_sig_reused': 'その返金トランザクションは別の貢献に使われています。',
  ...
  'launchpad.launches.open': 'コミュニティ発射',
  'launchpad.launches.title': 'コミュニティ発射',
  'launchpad.launches.subtitle':
    'トークン発射の投票中、またはプレセール中のサーバー。誰でも投票・貢献できます。',
  'launchpad.launches.loading': 'コミュニティ発射を読み込み中...',
  'launchpad.launches.empty': '現在投票中またはプレセール中のサーバーはありません。またあとで確認してください。',
  'launchpad.launches.statusVoting': 'コミュニティ投票',
  'launchpad.launches.statusPresale': 'プレセール',
  'launchpad.launches.powerTag': 'ペイ・トゥ・ウィン',
  'launchpad.launches.progressVoting': 'クォーラムの {pct}%',
  'launchpad.launches.progressPresale': 'ソフトキャップの {pct}%',
  'launchpad.launches.ctaVote': '投票する',
  'launchpad.launches.ctaContribute': '貢献する',
  'launchpad.levy.open': "レビー・ストリート・ファンド",
  'launchpad.levy.title': "レビー・ストリート・ファンド",
  'launchpad.levy.subtitle': "ここでローンチされたすべてのレルムトークンの一部を保有する、透明で表示専用のポートフォリオです。",
  'launchpad.levy.displayOnlyNote': "表示専用：ファンドはこれらのトークンをあなたと並んで保有し、売却できません。ファンドシェアも償還もありません。",
  'launchpad.levy.loading': "ポートフォリオを読み込んでいます……",
  'launchpad.levy.empty': "まだ保有はありません。ローンチされたレルムトークンは上場後にここに表示されます。",
  'launchpad.levy.aum': "総額（AUM）",
  'launchpad.levy.holdings': "{count} 件の保有",
  'launchpad.levy.excluded': "{count} 件を流動性不足として除外",
  'launchpad.levy.clamped': "この更新の価値変動は確認待ちで制限されました。",
  'launchpad.levy.updated': "{time} に更新",
  'launchpad.levy.colToken': "トークン",
  'launchpad.levy.colAmount': "数量",
  'launchpad.levy.colPrice': "価格",
  'launchpad.levy.colValue': "価値",
  'launchpad.levy.colWeight': "ウェイト",
  'launchpad.levy.illiquidTag': "流動性不足",
  'launchpad.levy.sourceCurve': "カーブ",
  'launchpad.levy.locked': "チェーン上でロック済み",
  'launchpad.err.missing_payTxSig_or_refundSig': '返金の送信情報が不完全でした。',
  'launchpad.err.mint_not_ready': "トークンの発行はプレセールの達成後にのみ行えます。",
  'launchpad.err.token_already_minted': "このトークンは既に発行済みです。",
  'launchpad.err.token_not_minted': "先にトークンを発行してください。",
  'launchpad.err.levy_wallet_unconfigured': "このレルムホストではトークンローンチはまだ有効になっていません。",
  'launchpad.err.launch_unavailable': "ローンチサービスは一時的に利用できません。しばらくしてからもう一度お試しください。",
  'launchpad.err.launch_sig_reused': "そのトランザクションは既に別のローンチで使用されています。",
  'launchpad.err.mint_mismatch': "チェーン上のミントがこのローンチと一致しません。最初からやり直してください。",
  'launchpad.err.already_distributed': "供給量は既に分配済みです。",
  'launchpad.err.not_distributed': "先に供給量を分配してください。",
  'launchpad.err.distribution_mismatch': "分配が割り当て計画と一致しません。",
  'launchpad.err.invalid_lock_bucket': "ファウンダー、レビー、トレジャリーのいずれかのロックを選んでください。",
  'launchpad.err.already_locked': "その割り当ては既にロック済みです。",
  'launchpad.err.lock_mismatch': "チェーン上のロックがこのローンチと一致しません。最初からやり直してください。",
  'launchpad.err.lock_not_immutable': "そのロックは不変ではありません。誰にも取り消せない必要があります。",
  'launchpad.err.lock_underfunded': "ロックに割り当ての全額が入っていません。",
  'launchpad.err.locks_incomplete': "ファウンダー、レビー、流動性のロックがすべてチェーン上で検証されるまで、トークンは上場できません。",
  'launchpad.err.missing_quoteId_or_signature': "ローンチの確認情報が不完全でした。最初からやり直してください。",
  'launchpad.err.curve_disabled': "このレルムホストではボンディングカーブのローンチはまだ有効になっていません。",
  'launchpad.err.fee_claimer_unconfigured': "プラットフォームの手数料ボールトがまだ設定されていません。",
  'launchpad.err.curve_already_launched': "このトークンには既にボンディングカーブがあります。",
  'launchpad.err.curve_not_launched': "先にボンディングカーブをローンチしてください。",
  'launchpad.err.curve_mismatch': "チェーン上のカーブがこのローンチと一致しません。最初からやり直してください。",
  'launchpad.err.not_migrated': "カーブはまだ卒業していません。",
  'launchpad.err.power_credit_disabled': "このトークンをゲーム内パワーに使うことはここでは有効になっていません。",
  'launchpad.err.power_sink_unconfigured': "このレルムはまだトークンの利用を設定していません。",
  'launchpad.err.not_power_realm': "このレルムはコスメティック専用です。トークンでゲームパワーは買えません。",
  'launchpad.err.token_2022_mismatch': "その送金はこのレルムトークンと一致しません。最初からやり直してください。",
  'launchpad.err.sink_not_credited': "送金がレルムのウォレットに届きませんでした。",
  'launchpad.err.amount_too_small': "その金額は小さすぎて通貨に換算できません。",
  'launchpad.err.credit_already_recorded': "その送金は既に反映されています。",
  'launchpad.err.no_character_to_credit': "このレルムのキャラクターにログインして受け取ってください。",
  'launchpad.err.missing_payTxSig': "クレジットの送信情報が不完全でした。",
  'launchpad.err.rate_limited': 'リクエストが多すぎます。少し待ってからもう一度お試しください。',
  'launchpad.err.wallet_mismatch': 'アカウントにリンクしたウォレットを接続してください。',
  'launchpad.err.generic': '問題が発生しました。もう一度お試しください。',
};
