...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.riverboat_dealer.name': 'ディーラー・マリベル',
  'entities.npcs.riverboat_dealer.title': 'グランドサルーンのいかさま師',
  'entities.npcs.riverboat_dealer.greeting': 'お座りください、{className}。山札は新しく、配りは公正です。一勝負いかがですか？',
  'entities.npcs.riverboat_pit_boss.name': 'ピットボス・クレイク',
  'entities.npcs.riverboat_pit_boss.title': '賭け闘技場の主',
  'entities.npcs.riverboat_pit_boss.greeting': '闘士は二人、賞金は一つ、{className}。リングに上がり、賭け金を告げてください。',
  'entities.npcs.riverboat_slots_attendant.name': 'ティリー・スプロケット',
  'entities.npcs.riverboat_slots_attendant.title': 'リールの番人',
  'entities.npcs.riverboat_slots_attendant.greeting': '筐体は油を差して準備万端です、{className}。一日一回の無料回転、リールは決して嘘をつきません。',
  'entities.npcs.riverboat_hilo_croupier.name': '補給官ノック',
  'entities.npcs.riverboat_hilo_croupier.title': '骰子の呼び手',
  'entities.npcs.riverboat_hilo_croupier.greeting': 'ハイかロー、{className}、一振りで決まります。胴元は真ん中だけをいただきます。',
  ...
  'hudChrome.hilo.title': '補給官のハイロー',
  'hudChrome.hilo.rules': '1 から 100 の目でハイかローを宣言。ローは 1 から 49、ハイは 52 から 100 で的中。配当は等倍。',
  'hudChrome.hilo.balance': '所持金：{amount}',
  'hudChrome.hilo.stakeLabel': '賭け金',
  'hudChrome.hilo.prompt': '賭け金を選んで、ハイかローを宣言してください。',
  'hudChrome.hilo.low': 'ロー（1 から 49）',
  'hudChrome.hilo.high': 'ハイ（52 から 100）',
  'hudChrome.hilo.session': '今回：{wins} 勝 {losses} 敗',
  'hudChrome.hilo.close': '閉じる',
  'hudChrome.hilo.wonLine': '{roll} が出ました。{amount} の勝ちです。',
  'hudChrome.hilo.lostLine': '{roll} が出ました。{amount} の負けです。',
  'hudChrome.hilo.wonLog': 'ハイロー：{roll} が出て {amount} の勝ち。',
  'hudChrome.hilo.lostLog': 'ハイロー：{roll} が出て {amount} の負け。',
};
