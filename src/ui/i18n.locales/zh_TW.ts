...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.title': '周邊商店',
  'hudChrome.merch.subtitle': '官方《World of ClaudeCraft》周邊商品，全球配送。',
  'hudChrome.merch.loading': '正在載入商店…',
  'hudChrome.merch.unavailable': '周邊商店暫時無法使用。您的訂單和付款不會受到影響，請稍後再試。',
  'hudChrome.merch.disclosure': '周邊商品由我們的印刷合作夥伴按需製作並出貨。用於購買周邊的 Claudium 無法退還為 Claudium；銀行卡與 Solana 付款依服務條款中的退款政策辦理。',
  'hudChrome.merch.catalogTitle': '商品目錄',
  'hudChrome.merch.catalogEmpty': '目前沒有可用的周邊商品。',
  'hudChrome.merch.variantLabel': '款式與尺寸',
  'hudChrome.merch.addToCart': '加入購物車',
  'hudChrome.merch.outOfStock': '缺貨',
  'hudChrome.merch.cartTitle': '購物車',
  'hudChrome.merch.cartEmpty': '您的購物車是空的。',
  'hudChrome.merch.removeFromCart': '從購物車移除',
  'hudChrome.merch.totalLabel': '總計',
  'hudChrome.merch.totalNote': '運費與稅金將於結帳時加入；最終金額以伺服器確認為準。',
  'hudChrome.merch.claudiumPrice': '{amount} Claudium',
  'hudChrome.merch.checkoutTitle': '結帳',
  'hudChrome.merch.loginRequired': '請登入帳號後再結帳。',
  'hudChrome.merch.shipping.name': '姓名',
  'hudChrome.merch.shipping.address1': '地址',
  'hudChrome.merch.shipping.address2': '地址第二行（選填）',
  'hudChrome.merch.shipping.city': '城市',
  'hudChrome.merch.shipping.state': '州/省',
  'hudChrome.merch.shipping.zip': '郵遞區號',
  'hudChrome.merch.shipping.country': '國家/地區',
  'hudChrome.merch.shipping.email': '接收訂單通知的電子郵件',
  'hudChrome.merch.shippingIncomplete': '請填寫所有必填的收件資訊。',
  'hudChrome.merch.railLabel': '付款方式',
  'hudChrome.merch.railStripe': '銀行卡',
  'hudChrome.merch.railSol': 'SOL',
  'hudChrome.merch.railClaudium': 'Claudium',
  'hudChrome.merch.payNow': '送出訂單',
  'hudChrome.merch.checkoutPending': '訂單處理中。請完成付款，並保持此頁面開啟。',
  'hudChrome.merch.checkoutFailed': '無法開始結帳，請重試。',
  'hudChrome.merch.checkoutUnavailable': '該訂單暫時無法使用。',
  'hudChrome.merch.checkoutNotSettled': '交易已送出，但訂單尚未確認。請稍後查看您的訂單。',
  'hudChrome.merch.orderPlaced': '訂單 {orderId} 已送出。可在下方的訂單中追蹤。',
  'hudChrome.merch.ordersTitle': '我的訂單',
  'hudChrome.merch.trackOrder': '追蹤',
  'hudChrome.merch.status.pendingPayment': '等待付款',
  'hudChrome.merch.status.paid': '已付款',
  'hudChrome.merch.status.submitted': '已送交生產',
  'hudChrome.merch.status.inProduction': '生產中',
  'hudChrome.merch.status.shipped': '已出貨',
  'hudChrome.merch.status.delivered': '已送達',
  'hudChrome.merch.status.paymentFailed': '付款失敗',
  'hudChrome.merch.status.expired': '已過期',
  'hudChrome.merch.status.canceled': '已取消',
  'hudChrome.merch.status.refunded': '已退款',
  'hudChrome.merch.status.fulfillmentFailed': '出貨失敗',
  'hudChrome.merch.status.unknown': '處理中',
