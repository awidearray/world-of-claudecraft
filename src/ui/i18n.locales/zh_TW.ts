...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'realmOp.affiliate.subtitle': '分享一個連結。通過它加入的玩家獲得經驗和金幣加成，你從他們的收益中賺取分成，他們創立的任何世界還會給你 15%。',
  'realmOp.affiliate.title': '推薦與聯盟計畫',
  'realmOp.affiliate.unavailable': '推薦統計暫時不可用。請稍後再試。',
  'realmOp.affiliate.yourLink': '你的推薦連結',
  'realmOp.buy.bondNote': '還需持有 {amount} $WOC，在世界存續期間保留在你綁定的錢包中，否則世界將失效。',
  'realmOp.buy.bondWhy': '這筆持續保證金獨立於你支付的 {currency}：它確保你在營運世界期間保持利益綁定。',
  ...
  'realmOp.found.stakingNote': '你簽署一筆交易，將 {amount} $WOC 鎖入託管。停用後經過 {days} 天時間鎖即可隨時取回。',
  ...
  'realmOp.mine.bondWarning': '保證金低於要求。請持有 {amount} $WOC，並在 {date} 之前補足，否則此世界將失效。',
  'realmOp.mine.decommission': '停用',
  'realmOp.mine.decommissionConfirm': '停用 {name}？這將使世界下線，並啟動 {days} 天的質押釋放時間鎖。',
  ...
  'launchpad.register.subtitle': '為這個世界將要發射的貨幣命名。註冊僅確定身分：鑄造、鎖倉與流動性將在後續階段連同各自的保障機制推出。',
  'launchpad.register.symbolLabel': '代幣代碼',
  'launchpad.register.symbolPlaceholder': '例如 MOON',
  'launchpad.register.policyLabel': '變現政策',
  'launchpad.register.policyHint': '選擇「僅限外觀」可讓這個世界維持無付費變強。「付費變強」會向所有玩家明確標示，並在上線前受到審核限制。',
  'launchpad.register.submit': '註冊代幣',
  'launchpad.vote.title': '這個世界應該發射它的代幣嗎？',
  'launchpad.vote.subtitle': '每個已驗證的關聯錢包一票，依投票時錢包持有的 $WOC 加權。投票僅供參考且免費：不會送出任何交易。',
  ...
  'launchpad.presale.subtitle': '用 SOL、USDC 或 $WOC 為發射出資。資金直接進入創始人託管錢包；本伺服器只驗證您的交易，絕不保管資金。',
  ...
  'launchpad.presale.refundTerms': '如果預售未達軟頂，創始人將從託管錢包退款，每筆退款都會先經鏈上驗證才計入。',
  ...
  'launchpad.presale.config.subtitle': '設定您掌控的託管錢包與各幣種上限。留空即停用該幣種。金額為整單位。',
  ...
  'launchpad.err.invalid_presale_caps': '這些上限無效。每個啟用的幣種需要軟頂、不低於軟頂的籌集上限和單錢包上限。',
  ...
  'launchpad.curve.openHint': '建構由您的錢包簽名的池建立交易。曲線主機鑄造代幣並持有曲線供應量;任何資金都不經過本伺服器。',
  ...
  'launchpad.fund.policyNote': '每筆持倉都按股權表上最嚴格的時間表歸屬(12 個月懸崖期 + 48 個月線性),處置需經治理審批。平台無法拋售這些持倉。',
