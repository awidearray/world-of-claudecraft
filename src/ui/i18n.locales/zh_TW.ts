...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocSeason.close': '關閉',
  'hudChrome.wocSeason.colPlayer': '玩家',
  'hudChrome.wocSeason.colRating': '評分',
  'hudChrome.wocSeason.colReward': '獎勵（$WOC）',
  'hudChrome.wocSeason.emittedLabel': '獎池已發放 {pct}%',
  'hudChrome.wocSeason.ended': '本賽季已結束。',
  'hudChrome.wocSeason.invariant': '派發絕不會超過賽季收入：買入大於賣出，由鏈上強制執行。',
  'hudChrome.wocSeason.menu': '$WOC 賽季',
  'hudChrome.wocSeason.none': '目前沒有進行中的獎勵賽季。',
  'hudChrome.wocSeason.noneHint': '當競技場抽成和回購開始注入獎池時，賽季即會開啟。',
  'hudChrome.wocSeason.openEnded': '無固定期限',
  'hudChrome.wocSeason.poolLabel': '可用獎池',
  'hudChrome.wocSeason.projectedNote': '根據當前獎池和競技場排名預估；最終派發在賽季結束時結算。',
  'hudChrome.wocSeason.sinkLabel': '已注入',
  'hudChrome.wocSeason.standingsTitle': '預計最高收益者',
  'hudChrome.wocSeason.statusActive': '進行中',
  'hudChrome.wocSeason.statusEnded': '已結束',
  'hudChrome.wocSeason.subtitle': '由金庫出資，向頂尖玩家派發',
  'hudChrome.wocSeason.title': '$WOC 獎勵賽季',
  'realmOp.open': '創立世界',
  'realmOp.panelTitle': '世界營運者',
  'realmOp.affiliate.bonusRealm': '另外，他們創立的任何世界都會給你 15% 的 USDC 佣金。',
  'realmOp.affiliate.bonusReferee': '通過你的連結加入的玩家在前 30 天獲得 +10% 經驗和金幣。',
  'realmOp.affiliate.bonusReferrer': '在此期間，你可獲得他們收益的 +5%，直接計入你的角色。',
  'realmOp.affiliate.bonusTitle': '你的連結如何賺錢',
  'realmOp.affiliate.commission': '{pct}% 佣金',
  'realmOp.affiliate.copied': '已複製',
  'realmOp.affiliate.copy': '複製連結',
  'realmOp.affiliate.earningsSoon': '當世界內收入上線後，USDC 佣金即開始發放。',
  'realmOp.affiliate.empty': '還沒有被推薦的世界。分享你的連結開始賺取收益。',
  'realmOp.affiliate.loading': '正在載入你的推薦統計...',
  'realmOp.affiliate.open': '推薦計畫',
  'realmOp.affiliate.referredCount': '{count} 個活躍的被推薦世界',
  'realmOp.affiliate.referredCountPlural': '{count} 個活躍的被推薦世界',
  'realmOp.affiliate.referredTitle': '你推薦的世界',
  'realmOp.affiliate.rewardsEmpty': '推薦玩家即可開始賺取。獎勵將在你下次登入時發放到角色。',
  'realmOp.affiliate.rewardsLifetime': '累計已獲得 {xp} 經驗和 {gold}',
  'realmOp.affiliate.rewardsPending': '{xp} 經驗和 {gold} 待發放，將在你下次登入時到帳',
  'realmOp.affiliate.rewardsReferred': '已推薦玩家：{count}',
  'realmOp.affiliate.rewardsTitle': '你的推薦獎勵',
  'realmOp.affiliate.subtitle':
    '分享一個連結。通過它加入的玩家獲得經驗和金幣加成，你從他們的收益中賺取分成，他們創立的任何世界還會給你 15%。',
  'realmOp.affiliate.title': '推薦與聯盟計畫',
  'realmOp.affiliate.unavailable': '推薦統計暫時不可用。請稍後再試。',
  'realmOp.affiliate.yourLink': '你的推薦連結',
  'realmOp.buy.bondNote':
    '還需持有 {amount} $WOC，在世界存續期間保留在你綁定的錢包中，否則世界將失效。',
  'realmOp.buy.bondWhy':
    '這筆持續保證金獨立於你支付的 {currency}：它確保你在營運世界期間保持利益綁定。',
  'realmOp.buy.currencyLabel': '支付方式',
  'realmOp.buy.currencyUnavailable': '{currency} 暫時不可用（沒有兌換路徑）。',
  'realmOp.buy.finalNote': '購買為最終交易，不可退款。與質押不同，停用世界時不會返還。',
  'realmOp.buy.note': '你簽署一筆交易，支付 {amount} {currency} 來創立此世界。世界立即啟用。',
  'realmOp.buy.splitNote': '你支付的 {treasuryPct}% 注入金庫，其餘用於回購並銷毀 $WOC。',
  'realmOp.buy.submit': '購買並創立',
  'realmOp.buy.submitConnect': '連接錢包以購買',
  'realmOp.buy.unavailable': '目前無法購買世界。請改為質押 $WOC 來創立。',
  'realmOp.err.bad_signature': '該支付簽名無效。請重新開始。',
  'realmOp.err.bond_required': '購買此等級需要在綁定錢包中持有 {amount} $WOC。請儲值後重試。',
  'realmOp.err.buy_unavailable': '目前無法購買世界。請改為質押 $WOC 來創立。',
  'realmOp.err.buyback_short': '支付金額與你的報價不符。',
  'realmOp.err.generic': '出了點問題。請重試。',
  'realmOp.err.invalid_amount': '質押數量無效。請選擇一個等級後重試。',
  'realmOp.err.invalid_currency': '請選擇 SOL 或 USDC 後重試。',
  'realmOp.err.invalid_realm_name': '該世界名稱不被允許。請使用字母、數字、空格或連字號。',
  'realmOp.err.invalid_tier': '請選擇一個等級後重試。',
  'realmOp.err.legs_collide': '無法驗證該支付。請重新開始。',
  'realmOp.err.link_wallet': '請先將錢包綁定到你的帳戶。',
  'realmOp.err.memo_mismatch': '該支付與你的報價不符。請重新開始。',
  'realmOp.err.not_finalized': '你的支付尚未最終確認。請稍後再確認一次。',
  'realmOp.err.not_realm_owner': '你不是該世界的營運者。',
  'realmOp.err.not_your_quote': '該報價屬於其他帳戶。',
  'realmOp.err.payment_already_recorded': '該支付已被記錄。',
  'realmOp.err.price_unavailable': '即時價格暫時不可用。請稍後再試。',
  'realmOp.err.quote_expired': '你的報價已過期。請重新開始。',
  'realmOp.err.quote_not_found': '未找到你的報價。請重新開始。',
  'realmOp.err.rate_limited': '請求過於頻繁。請放慢速度後重試。',
  'realmOp.err.realm_cap_reached': '你已達到每個帳戶的世界數量上限。',
  'realmOp.err.realm_name_not_allowed': '該世界名稱不被允許。',
  'realmOp.err.realm_name_taken': '該世界名稱已被佔用。',
  'realmOp.err.realm_not_active': '該世界未處於啟用狀態。',
  'realmOp.err.realm_not_decommissioning': '該世界未處於停用流程中。',
  'realmOp.err.realm_not_found': '該世界已不存在。',
  'realmOp.err.stake_already_recorded': '該質押已被記錄。',
  'realmOp.err.stake_below_minimum': '該質押低於最低等級。請選擇更高的等級。',
  'realmOp.err.stake_not_released_onchain': '請先在鏈上釋放你的質押，然後再完成關閉。',
  'realmOp.err.stake_service_unavailable': '質押服務暫時不可用。請稍後再確認一次。',
  'realmOp.err.supply_unavailable': '$WOC 供應量數據暫時不可用。請稍後再試。',
  'realmOp.err.timelock_not_elapsed': '質押的時間鎖尚未到期。',
  'realmOp.err.token_2022': '此 $WOC 鑄幣不支援用於質押。',
  'realmOp.err.treasury_short': '支付金額與你的報價不符。',
  'realmOp.err.tx_failed': '質押交易在鏈上失敗。',
  'realmOp.err.tx_not_finalized': '你的質押尚未最終確認。請稍後再確認一次。',
  'realmOp.err.wallet_mismatch': '請連接你綁定到帳戶的錢包。',
  'realmOp.err.wrong_payer': '質押必須由你綁定的錢包簽署。',
  'realmOp.err.wrong_vault_amount': '鎖定的數量與你的報價不符。',
  'realmOp.flow.closed': '世界已關閉。該名稱重新可用。',
  'realmOp.flow.confirming': '正在鏈上驗證你的質押...',
  'realmOp.flow.confirmingBuy': '正在鏈上驗證你的支付...',
  'realmOp.flow.connecting': '正在連接你的錢包...',
  'realmOp.flow.decommissioning': '正在開始停用...',
  'realmOp.flow.founded': '{name} 已上線。歡迎，營運者。',
  'realmOp.flow.locking': '請在錢包中核准質押...',
  'realmOp.flow.paying': '請在錢包中核准支付...',
  'realmOp.flow.quoting': '正在為你預留世界...',
  'realmOp.flow.released': '世界已關閉。該名稱重新可用。',
  'realmOp.flow.releasing': '正在完成關閉...',
  'realmOp.found.affiliateNote': '由聯盟推薦。他們將獲得該世界收入 15% 的佣金。',
  'realmOp.found.badgeNote': '你質押的 $WOC 仍計入你的持有者徽章，因此創立世界絕不會降低你的等級。',
  'realmOp.found.methodBuy': '用 SOL 或 USDC 購買',
  'realmOp.found.methodBuyHint': '用 SOL 或 USDC 一次性支付。購買為最終交易，沒有可取回的質押。',
  'realmOp.found.methodLabel': '支付方式',
  'realmOp.found.methodStake': '質押 $WOC',
  'realmOp.found.methodStakeHint': '將 $WOC 鎖入託管。停用時全額返還。',
  'realmOp.found.nameLabel': '世界名稱',
  'realmOp.found.namePlaceholder': '為你的世界命名',
  'realmOp.found.nameTaken': '請換一個名稱；該名稱已被佔用。',
  'realmOp.found.stakingNote':
    '你簽署一筆交易，將 {amount} $WOC 鎖入託管。停用後經過 {days} 天時間鎖即可隨時取回。',
  'realmOp.found.submit': '質押並創立',
  'realmOp.found.submitConnect': '連接錢包以創立',
  'realmOp.found.subtitle': '將 $WOC 質押到非託管的鏈上託管帳戶，以開設並營運你自己的世界。',
  'realmOp.found.supplyNote': '每個等級的價格按 $WOC 即時供應量的一定比例計算。',
  'realmOp.found.tierHint': '更大的質押解鎖更高等級：更多玩家、更多自訂預算，以及營運者收益通道。',
  'realmOp.found.tierLabel': '質押等級',
  'realmOp.found.tiersUnavailable': '即時等級價格暫時不可用。請稍後再試。',
  'realmOp.found.title': '創立世界',
  'realmOp.found.typeLabel': '世界類型',
  'realmOp.mine.bondInfo': '保證金：在綁定錢包中持有 {amount} $WOC。',
  'realmOp.mine.bondWarning':
    '保證金低於要求。請持有 {amount} $WOC，並在 {date} 之前補足，否則此世界將失效。',
  'realmOp.mine.decommission': '停用',
  'realmOp.mine.decommissionConfirm':
    '停用 {name}？這將使世界下線，並啟動 {days} 天的質押釋放時間鎖。',
  'realmOp.mine.eligible': '質押可於 {date} 釋放',
  'realmOp.mine.empty': '你還沒有營運任何世界。在上方創立一個即可開始。',
  'realmOp.mine.enter': '進入',
  'realmOp.mine.loading': '正在載入你的世界...',
  'realmOp.mine.release': '完成關閉',
  'realmOp.mine.releaseHint': '先在鏈上釋放你的質押，然後完成關閉以關停世界並釋放其名稱。',
  'realmOp.mine.tier': '{tier} 等級',
  'realmOp.mine.title': '我的世界',
  'realmOp.status.active': '啟用',
  'realmOp.status.decommissioning': '停用中',
  'realmOp.status.provisioning': '開通中',
  'realmOp.tier.bronze': '青銅',
  'realmOp.tier.priceUnavailable': '暫無價格',
  'realmOp.tier.share': '供應量的 {pct}%',
  'realmOp.tier.silver': '白銀',
  'launchpad.open': '代幣發射台',
  'launchpad.title': '世界代幣發射台',
  'launchpad.back': '返回',
  'launchpad.loading': '正在載入代幣狀態...',
  'launchpad.symbolBadge': '{symbol} 代幣',
  'launchpad.status.none': '未註冊代幣',
  'launchpad.status.prelaunch': '發射前',
  'launchpad.status.voting': '社群投票',
  'launchpad.status.presale': '預售',
  'launchpad.status.funded': '已達標',
  'launchpad.status.refunding': '退款中',
  'launchpad.status.refunded': '已退款',
  'launchpad.status.live': '已上線',
  'launchpad.status.graduated': '已畢業',
  'launchpad.status.closed': '已關閉',
  'launchpad.checklist.aria': '發射清單',
  'launchpad.checklist.register': '註冊',
  'launchpad.checklist.vote': '投票',
  'launchpad.checklist.presale': '預售',
  'launchpad.checklist.launch': '發射',
  'launchpad.policy.cosmetic': '僅限外觀',
  'launchpad.policy.power': '付費變強',
  'launchpad.policy.powerBanner': '付費變強世界：該代幣上線後可在此購買遊戲優勢。',
  'launchpad.register.title': '註冊世界代幣',
  'launchpad.register.subtitle':
    '為這個世界將要發射的貨幣命名。註冊僅確定身分：鑄造、鎖倉與流動性將在後續階段連同各自的保障機制推出。',
  'launchpad.register.symbolLabel': '代幣代碼',
  'launchpad.register.symbolPlaceholder': '例如 MOON',
  'launchpad.register.policyLabel': '變現政策',
  'launchpad.register.policyHint':
    '選擇「僅限外觀」可讓這個世界維持無付費變強。「付費變強」會向所有玩家明確標示，並在上線前受到審核限制。',
  'launchpad.register.submit': '註冊代幣',
  'launchpad.vote.title': '這個世界應該發射它的代幣嗎？',
  'launchpad.vote.subtitle':
    '每個已驗證的關聯錢包一票，依投票時錢包持有的 $WOC 加權。投票僅供參考且免費：不會送出任何交易。',
  'launchpad.vote.openBtn': '開啟社群投票',
  'launchpad.vote.yes': '投贊成票',
  'launchpad.vote.no': '投反對票',
  'launchpad.vote.tallyYes': '贊成：{amount} $WOC',
  'launchpad.vote.tallyNo': '反對：{amount} $WOC',
  'launchpad.vote.tallyAria': '贊成票權重佔比',
  'launchpad.vote.quorum': '法定人數：{current} / {required} $WOC',
  'launchpad.vote.quorumAria': '法定人數進度',
  'launchpad.vote.threshold': '達到法定人數且贊成率達 {pct}% 時通過',
  'launchpad.vote.yourVote': '您的投票已記錄，權重 {amount} $WOC。',
  'launchpad.vote.outcomePending': '尚未達到法定人數。',
  'launchpad.vote.outcomePassed': '投票已通過。預售已解鎖。',
  'launchpad.vote.outcomeFailed': '贊成票低於門檻。',
  'launchpad.presale.title': '預售',
  'launchpad.presale.subtitle':
    '用 SOL、USDC 或 $WOC 為發射出資。資金直接進入創始人託管錢包；本伺服器只驗證您的交易，絕不保管資金。',
  'launchpad.presale.stripeDeferred': '本階段暫不支援銀行卡支付。',
  'launchpad.presale.progress': '軟頂進度 {pct}%',
  'launchpad.presale.progressAria': '預售軟頂進度',
  'launchpad.presale.railRaised': '已籌 {raised} / {cap} {currency}',
  'launchpad.presale.railWalletRemaining': '您的剩餘額度：{amount} {currency}',
  'launchpad.presale.railFull': '該幣種已達上限。',
  'launchpad.presale.amountLabel': '金額（{currency}）',
  'launchpad.presale.contribute': '出資',
  'launchpad.presale.contributeConnect': '連接錢包以出資',
  'launchpad.presale.escrowNote': '託管錢包：{address}',
  'launchpad.presale.refundTerms':
    '如果預售未達軟頂，創始人將從託管錢包退款，每筆退款都會先經鏈上驗證才計入。',
  'launchpad.presale.softCapMet': '已達到軟頂。',
  'launchpad.presale.finalize': '結束預售',
  'launchpad.presale.finalizeHint': '結束預售：達到軟頂則判定為已達標，否則開啟退款。',
  'launchpad.presale.notConfigured': '創始人尚未開放出資。',
  'launchpad.presale.refundTitle': '退款',
  'launchpad.presale.refundNote': '本次預售未達軟頂。退款由託管錢包支付並經鏈上驗證。',
  'launchpad.presale.refundRemaining': '等待退款驗證的出資：{count}',
  'launchpad.presale.refundDone': '所有出資都已完成經驗證的退款。',
  'launchpad.presale.config.title': '開放出資',
  'launchpad.presale.config.subtitle':
    '設定您掌控的託管錢包與各幣種上限。留空即停用該幣種。金額為整單位。',
  'launchpad.presale.config.escrowLabel': '託管錢包地址',
  'launchpad.presale.config.softLabel': '軟頂（{currency}）',
  'launchpad.presale.config.raiseLabel': '籌集上限（{currency}）',
  'launchpad.presale.config.walletLabel': '單錢包上限（{currency}）',
  'launchpad.presale.config.submit': '開啟預售',
  'launchpad.flow.registering': '正在註冊代幣...',
  'launchpad.flow.openingVote': '正在開啟投票...',
  'launchpad.flow.castingVote': '正在記錄您的投票...',
  'launchpad.flow.configuring': '正在開放出資...',
  'launchpad.flow.quoting': '正在預留您的出資...',
  'launchpad.flow.paying': '請在錢包中批准轉帳...',
  'launchpad.flow.confirming': '正在鏈上驗證您的出資...',
  'launchpad.flow.contributed': '出資已記錄。',
  'launchpad.flow.finalizing': '正在結束預售...',
  'launchpad.err.not_realm_owner': '您不是該世界的營運者。',
  'launchpad.err.realm_not_found': '該世界已不存在。',
  'launchpad.err.realm_not_active': '該世界未處於活躍狀態。',
  'launchpad.err.invalid_token_symbol': '請選擇 2 到 10 個字元的大寫字母和數字代碼。',
  'launchpad.err.invalid_token_icon': '該代幣圖示無效。',
  'launchpad.err.invalid_token_policy': '請選擇變現政策。',
  'launchpad.err.token_already_registered': '該世界已註冊代幣。',
  'launchpad.err.token_not_registered': '該世界沒有註冊代幣。',
  'launchpad.err.vote_not_open': '社群投票尚未開啟。',
  'launchpad.err.vote_not_openable': '目前狀態無法開啟投票。',
  'launchpad.err.invalid_vote_choice': '請選擇贊成或反對。',
  'launchpad.err.wallet_not_linked': '請先在您的帳戶上驗證錢包。',
  'launchpad.err.vote_weight_unavailable': '無法讀取您的 $WOC 餘額。請稍後再試。',
  'launchpad.err.no_vote_weight': '您的已驗證錢包沒有可用於投票的整數 $WOC。',
  'launchpad.err.already_voted': '該錢包或帳戶已經投過票。',
  'launchpad.err.presale_not_open': '預售未開啟。',
  'launchpad.err.presale_not_configured': '創始人尚未開放出資。',
  'launchpad.err.presale_already_configured': '出資已經開放。',
  'launchpad.err.presale_not_refunding': '本次預售不在退款階段。',
  'launchpad.err.presale_unavailable': '預售暫時不可用。請稍後再試。',
  'launchpad.err.invalid_escrow_wallet': '該託管錢包地址無效。',
  'launchpad.err.invalid_presale_caps':
    '這些上限無效。每個啟用的幣種需要軟頂、不低於軟頂的籌集上限和單錢包上限。',
  'launchpad.err.invalid_currency': '請選擇 SOL、USDC 或 $WOC。',
  'launchpad.err.currency_not_enabled': '本次預售不接受該幣種。',
  'launchpad.err.invalid_amount': '請輸入有效金額。',
  'launchpad.err.wallet_cap_exceeded': '這將超過您的單錢包上限。',
  'launchpad.err.raise_cap_exceeded': '這將超過總籌集上限。',
  'launchpad.err.quote_not_found': '找不到您的報價。請重新開始。',
  'launchpad.err.not_your_quote': '該報價屬於其他帳戶。',
  'launchpad.err.quote_expired': '您的報價已過期。請重新開始。',
  'launchpad.err.contribution_already_recorded': '該交易已被記錄。',
  'launchpad.err.contribution_not_found': '找不到該出資。',
  'launchpad.err.already_refunded': '該出資已退款。',
  'launchpad.err.refund_sig_reused': '該退款交易已用於另一筆出資。',
  'launchpad.err.wrong_refunder': '退款必須由託管錢包支付。',
  'launchpad.err.refund_short': '退款金額不足以覆蓋該出資。',
  'launchpad.err.bad_signature': '該交易簽名無效。請重新開始。',
  'launchpad.err.not_finalized': '您的交易尚未最終確認。請稍後再試。',
  'launchpad.err.tx_failed': '交易在鏈上失敗。',
  'launchpad.err.token_2022': '此處不支援該代幣程式。',
  'launchpad.err.memo_mismatch': '該交易與您的報價不符。請重新開始。',
  'launchpad.err.wrong_payer': '交易必須由您的關聯錢包簽名。',
  'launchpad.err.escrow_short': '支付金額與您的報價不符。',
  'launchpad.err.missing_quoteId_or_paySig': '確認資訊不完整。請重新開始。',
  'launchpad.err.missing_payTxSig_or_refundSig': '退款提交資訊不完整。',
  'launchpad.err.rate_limited': '請求過多。請放慢速度後再試。',
  'launchpad.err.wallet_mismatch': '請連接您帳戶所關聯的錢包。',
  'launchpad.err.generic': '出了點問題。請重試。',
  'launchpad.launch.title': '代幣發射',
  'launchpad.launch.subtitle':
    '建立鑄幣、分配固定供應量,並將所有非公開份額鎖定在鏈上。所有鎖倉通過驗證之前,代幣無法上線。',
  'launchpad.launch.stepsAria': '發射流程步驟',
  'launchpad.launch.step.mint': '建立鑄幣',
  'launchpad.launch.step.locks': '分配並鎖倉',
  'launchpad.launch.step.verify': '鏈上驗證',
  'launchpad.launch.step.list': '正式上線',
  'launchpad.launch.supply': '固定供應量:{amount} {symbol}',
  'launchpad.launch.allocLine': '公開曲線 {publicPct}%,流動性 {liquidityPct}%(畢業時永久鎖定)',
  'launchpad.launch.bucketLine':
    '{bucket}:{pct}%,{amount} {symbol},{cliff} 個月懸崖期 + {linear} 個月線性解鎖',
  'launchpad.launch.bucket.founder': '創始人',
  'launchpad.launch.bucket.levy': 'Levy Street 基金',
  'launchpad.launch.bucket.treasury': '伺服器金庫',
  'launchpad.launch.lockProof': '{bucket}鎖倉:',
  'launchpad.launch.mintCreated': '鑄幣:',
  'launchpad.launch.verifiedNote': '所有鎖倉均已在鏈上驗證。曲線開放後代幣即可上線。',
  'launchpad.launch.createTitle': '建立鑄幣',
  'launchpad.launch.createHint':
    '您的錢包支付租金並作為鑄幣權限簽名。伺服器從不持有能轉移資金的金鑰:它只建構交易、鎖定鑄幣地址,並在鏈上驗證結果。',
  'launchpad.launch.treasuryLabel': '伺服器金庫錢包',
  'launchpad.launch.treasuryHint': '接收歸屬解鎖的伺服器金庫份額。請使用您的伺服器掌控的錢包。',
  'launchpad.launch.nameLabel': '代幣名稱(可選)',
  'launchpad.launch.uriLabel': '中繼資料網址(可選)',
  'launchpad.launch.createBtn': '建立鑄幣',
  'launchpad.launch.locksTitle': '驗證鎖倉',
  'launchpad.launch.locksHint':
    '鑄出全部供應量,按上述確切條款建立三個不可撤銷的 Jupiter Lock 託管,放棄鑄幣權限,然後在此貼上每個託管地址。所有內容都會對照鏈上核驗。',
  'launchpad.launch.lockLabel': '{bucket}鎖倉託管地址',
  'launchpad.launch.verifyBtn': '鏈上驗證',
  'launchpad.launch.checksAria': '鏈上驗證清單',
  'launchpad.launch.checkPass': '通過',
  'launchpad.launch.checkFail': '未通過',
  'launchpad.launch.check.mint_found': '鑄幣帳戶可讀取',
  'launchpad.launch.check.mint_profile': '乾淨的代幣配置(無凍結、無掛鉤、無費用)',
  'launchpad.launch.check.supply_exact': '固定供應量足額鑄出',
  'launchpad.launch.check.mint_authority_renounced': '鑄幣權限已放棄',
  'launchpad.launch.check.lock_found': '找到鎖倉託管',
  'launchpad.launch.check.lock_mint': '鎖倉持有本代幣',
  'launchpad.launch.check.lock_recipient': '鎖倉接收人相符',
  'launchpad.launch.check.lock_immutable': '鎖倉不可變(不可取消、不可更換接收人)',
  'launchpad.launch.check.lock_token_program': '鎖倉使用正確的代幣程式',
  'launchpad.launch.check.lock_untouched': '鎖倉未領取且從未取消',
  'launchpad.launch.check.lock_amount': '鎖定數量精確',
  'launchpad.launch.check.lock_schedule': '解鎖計畫滿足承諾',
  'launchpad.launch.check.lock_funded': '鎖倉託管持有代幣',
  'launchpad.launch.check.unknown': '附加檢查',
  'launchpad.flow.preparingMint': '正在準備鑄幣交易...',
  'launchpad.flow.signingMint': '請在錢包中批准鑄幣建立...',
  'launchpad.flow.confirmingMint': '正在鏈上驗證鑄幣...',
  'launchpad.flow.mintDone': '鑄幣已建立並通過驗證。',
  'launchpad.flow.verifying': '正在鏈上驗證鎖倉...',
  'launchpad.flow.verified': '發射已驗證:所有鎖倉均在鏈上。',
  'launchpad.flow.notVerified': '驗證發現問題。請查看下方清單。',
  'launchpad.err.mint_already_created': '鑄幣已建立。',
  'launchpad.err.presale_not_funded': '預售尚未達標完成。',
  'launchpad.err.levy_fund_unconfigured': '平台基金錢包尚未設定。請稍後再試。',
  'launchpad.err.invalid_treasury_wallet': '該金庫錢包地址無效。',
  'launchpad.err.invalid_token_name': '代幣名稱為 1 到 32 個普通字元。',
  'launchpad.err.invalid_token_uri': '中繼資料網址必須是 https 地址。',
  'launchpad.err.chain_unavailable': '無法連接鏈上網路。請稍後再試。',
  'launchpad.err.launch_not_prepared': '請先準備鑄幣交易。',
  'launchpad.err.mint_not_in_tx': '該交易沒有建立鎖定的鑄幣。',
  'launchpad.err.mint_not_found': '無法在鏈上讀取鑄幣帳戶。',
  'launchpad.err.wrong_token_program': '鑄幣不在預期的代幣程式之下。',
  'launchpad.err.wrong_decimals': '鑄幣的小數位數不符合預期。',
  'launchpad.err.freeze_authority_set': '鑄幣設有凍結權限。必須沒有凍結權限。',
  'launchpad.err.bad_metadata_pointer': '鑄幣中繼資料指標錯誤或仍可更改。',
  'launchpad.err.metadata_symbol_mismatch': '鏈上代碼與已註冊代幣不符。',
  'launchpad.err.unexpected_extension': '鑄幣帶有不被允許的擴充。',
  'launchpad.err.launch_sig_replayed': '該發射交易已被使用。',
  'launchpad.err.mint_not_created': '請先建立並確認鑄幣。',
  'launchpad.err.invalid_lock_address': '請輸入三個互不相同的有效鎖倉託管地址。',
  'launchpad.err.launch_not_verifiable': '發射尚未準備好進行驗證。',
  'launchpad.err.locks_not_verified': '鎖倉尚未在鏈上驗證。',
  'launchpad.err.not_listable': '目前狀態下代幣無法上線。',
  'launchpad.err.missing_sig': '確認資訊不完整。請重新開始。',
  'launchpad.curve.title': '聯合曲線',
  'launchpad.curve.subtitle':
    '代幣在公開曲線上交易,人人同價。達到遷移門檻後,它將畢業進入流動性池,LP 永久鎖定。',
  'launchpad.curve.lpLockLine': '發射設定將畢業 LP 的 {pct}% 永久鎖定。',
  'launchpad.curve.poolLabel': '曲線池:',
  'launchpad.curve.progressAria': '遷移門檻進度',
  'launchpad.curve.progress': '已籌集 {raised},遷移目標 {threshold}',
  'launchpad.curve.migratedNote': '曲線已達到門檻並完成遷移。請在下方驗證畢業。',
  'launchpad.curve.graduatedNote': '已畢業:LP 永久鎖定的流動性池:',
  'launchpad.curve.openBtn': '開啟曲線',
  'launchpad.curve.openHint':
    '建構由您的錢包簽名的池建立交易。曲線主機鑄造代幣並持有曲線供應量;任何資金都不經過本伺服器。',
  'launchpad.curve.verifyBtn': '驗證曲線上線',
  'launchpad.curve.verifyHint': '池建立交易最終確認後,驗證它以使代幣上線。',
  'launchpad.curve.graduateBtn': '驗證畢業',
  'launchpad.flow.preparingCurve': '正在準備曲線池...',
  'launchpad.flow.signingCurve': '請在錢包中批准池建立...',
  'launchpad.flow.curveSubmitted': '池建立已送出。最終確認後請驗證上線。',
  'launchpad.flow.verifyingCurve': '正在鏈上驗證曲線...',
  'launchpad.flow.curveListed': '代幣已在曲線上線。',
  'launchpad.flow.verifyingGraduation': '正在鏈上驗證畢業...',
  'launchpad.flow.graduated': '已畢業:LP 已永久鎖定。',
  'launchpad.err.launchpad_disabled': '本伺服器尚未啟用曲線發射台。',
  'launchpad.err.launchpad_config_unreadable': '無法讀取發射設定。請稍後再試。',
  'launchpad.err.curve_already_created': '曲線已存在。',
  'launchpad.err.host_requires_dbc_mint': '該曲線主機自行建立代幣;預先鑄造的代幣無法進入。',
  'launchpad.err.invalid_base_mint': '該基礎鑄幣地址無效。',
  'launchpad.err.curve_not_found': '尚未在鏈上找到曲線池。請稍後再試。',
  'launchpad.err.wrong_curve_creator': '曲線池必須由您的關聯錢包建立。',
  'launchpad.err.not_live': '代幣未在曲線上線。',
  'launchpad.err.not_migrated': '曲線尚未達到遷移門檻。',
  'launchpad.err.graduation_not_found': '尚未在鏈上找到畢業後的流動性池。',
  'launchpad.err.lp_not_permanently_locked': '流動性未被永久鎖定。',
  'launchpad.err.not_damm_v2': '發射設定不會畢業到鎖定池。',
  'launchpad.err.no_locked_vesting': '發射設定不含鎖定歸屬。',
  'launchpad.err.no_migration_threshold': '發射設定沒有遷移門檻。',
  'launchpad.fund.open': 'Levy Street 基金',
  'launchpad.fund.title': 'Levy Street 基金',
  'launchpad.fund.subtitle':
    '平台持有在此發射的每個伺服器代幣的鎖定份額,即時展示。這是一個透明的金庫,不是可以買入的基金:本頁面的任何內容都不可買賣或贖回。',
  'launchpad.fund.loading': '正在載入投資組合...',
  'launchpad.fund.notPublished': '投資組合尚未發佈。',
  'launchpad.fund.empty': '基金尚未持有任何伺服器代幣。',
  'launchpad.fund.aum': '總價值:{amount} USD',
  'launchpad.fund.updated': '更新於 {time}',
  'launchpad.fund.clampedNote': '單次重新整理出現的大幅變動正在等待確認重新整理。',
  'launchpad.fund.policyNote':
    '每筆持倉都按股權表上最嚴格的時間表歸屬(12 個月懸崖期 + 48 個月線性),處置需經治理審批。平台無法拋售這些持倉。',
  'launchpad.fund.tableAria': '基金持倉',
  'launchpad.fund.colToken': '代幣',
  'launchpad.fund.colAmount': '數量',
  'launchpad.fund.colPrice': '價格(USD)',
  'launchpad.fund.colValue': '價值(USD)',
  'launchpad.fund.colWeight': '權重',
  'launchpad.fund.colStatus': '狀態',
  'launchpad.fund.badgeLocked': '已鎖定',
  'launchpad.fund.badgeGraduated': '已畢業',
  'launchpad.fund.statusIlliquid': '流動性不足(不計入總額)',
  'launchpad.fund.confidence.high': '已定價(交叉核驗)',
  'launchpad.fund.confidence.medium': '已定價',
  'launchpad.fund.confidence.low': '已定價(信賴度低)',
  'launchpad.fund.illiquidNote': '沒有可信價格的持倉:{count}。僅展示,從不計入。',
  'launchpad.flow.quotingPower': '正在為您的兌換報價...',
  'launchpad.flow.powerQuoted': '您將獲得 {copper} 銅幣。請在錢包中核准轉帳...',
  'launchpad.flow.confirmingPower': '正在鏈上驗證您的轉帳...',
  'launchpad.flow.powerCredited': '已向您的角色發放 {copper} 銅幣。',
  'launchpad.flow.powerBanked': '已記入 {copper} 銅幣。該角色下次登入時到帳。',
  'launchpad.power.title': '兌換銅幣',
  'launchpad.power.subtitle':
    '此付費變強世界可將 {symbol} 兌換為遊戲內銅幣。代幣將發送至世界金庫,轉帳在鏈上最終確認後發放銅幣。',
  'launchpad.power.charLabel': '發放到角色',
  'launchpad.power.amountLabel': '數量({symbol})',
  'launchpad.power.convertBtn': '兌換銅幣',
  'launchpad.power.convertConnect': '連接錢包並兌換',
  'launchpad.power.noCharacters': '請先在此世界建立角色以接收銅幣。',
  'launchpad.err.power_disabled': '本伺服器未啟用代幣兌換銅幣。',
  'launchpad.err.realm_not_power': '此世界不允許代幣兌換銅幣。',
  'launchpad.err.token_not_live': '代幣必須先在曲線上線。',
  'launchpad.err.power_rate_unset': '兌換匯率尚未設定。',
  'launchpad.err.power_sink_unavailable': '世界金庫尚不可用。',
  'launchpad.err.amount_below_minimum': '數量太小,無法兌換。',
