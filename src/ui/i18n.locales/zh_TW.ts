...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'launchpad.launches.open': '社群發射',
  'launchpad.launches.title': '社群發射',
  'launchpad.launches.subtitle': '正在進行代幣發射投票或預售的伺服器。任何人都可以投票或出資。',
  'launchpad.launches.loading': '正在載入社群發射……',
  'launchpad.launches.empty': '目前沒有伺服器在投票或預售中，請稍後再來查看。',
  'launchpad.launches.statusVoting': '社群投票',
  'launchpad.launches.statusPresale': '預售',
  'launchpad.launches.powerTag': '付費變強',
  'launchpad.launches.progressVoting': '法定人數進度 {pct}%',
  'launchpad.launches.progressPresale': '軟頂進度 {pct}%',
  'launchpad.launches.ctaVote': '投票',
  'launchpad.launches.ctaContribute': '出資',
  'launchpad.levy.open': "萊維街基金",
  'launchpad.levy.title': "萊維街基金",
  'launchpad.levy.subtitle': "一個透明、僅供展示的投資組合，持有本平台發射的每個領域代幣的一部分。",
  'launchpad.levy.displayOnlyNote': "僅供展示：基金與你一同持有這些代幣，無法出售。沒有基金份額，也沒有贖回。",
  'launchpad.levy.loading': "正在載入投資組合……",
  'launchpad.levy.empty': "尚無持倉。已發射的領域代幣在上架後會顯示在此處。",
  'launchpad.levy.aum': "總價值（AUM）",
  'launchpad.levy.holdings': "{count} 項持倉",
  'launchpad.levy.excluded': "{count} 項因流動性不足被排除",
  'launchpad.levy.clamped': "本次重新整理的價值變動已被限制，等待確認。",
  'launchpad.levy.updated': "更新於 {time}",
  'launchpad.levy.colToken': "代幣",
  'launchpad.levy.colAmount': "數量",
  'launchpad.levy.colPrice': "價格",
  'launchpad.levy.colValue': "價值",
  'launchpad.levy.colWeight': "權重",
  'launchpad.levy.illiquidTag': "流動性不足",
  'launchpad.levy.sourceCurve': "曲線",
  'launchpad.levy.locked': "已在鏈上鎖定",
  'launchpad.err.missing_payTxSig_or_refundSig': '退款提交資訊不完整。',
  'launchpad.err.mint_not_ready': "只有在預售達標後才能鑄造代幣。",
  'launchpad.err.token_already_minted': "該代幣已鑄造。",
  'launchpad.err.token_not_minted': "請先鑄造代幣。",
  'launchpad.err.levy_wallet_unconfigured': "該伺服器主機尚未啟用代幣發射。",
  'launchpad.err.launch_unavailable': "發射服務暫時無法使用。請稍後再試。",
  'launchpad.err.launch_sig_reused': "該交易已被其他發射使用。",
  'launchpad.err.mint_mismatch': "鏈上鑄幣與本次發射不符。請重新開始。",
  'launchpad.err.already_distributed': "供應量已分配。",
  'launchpad.err.not_distributed': "請先分配供應量。",
  'launchpad.err.distribution_mismatch': "分配結果與分配方案不符。",
  'launchpad.err.invalid_lock_bucket': "請選擇創始人、平台或金庫鎖倉。",
  'launchpad.err.already_locked': "該份額已鎖倉。",
  'launchpad.err.lock_mismatch': "鏈上鎖倉與本次發射不符。請重新開始。",
  'launchpad.err.lock_not_immutable': "該鎖倉並非不可變。必須任何人都無法取消。",
  'launchpad.err.lock_underfunded': "鎖倉未持有全部份額。",
  'launchpad.err.locks_incomplete': "在創始人、平台與流動性鎖倉全部通過鏈上驗證之前，代幣無法上架。",
  'launchpad.err.missing_quoteId_or_signature': "發射確認資訊不完整。請重新開始。",
  'launchpad.err.curve_disabled': "該伺服器主機尚未啟用聯合曲線發射。",
  'launchpad.err.fee_claimer_unconfigured': "平台費用金庫尚未設定。",
  'launchpad.err.curve_already_launched': "該代幣已有聯合曲線。",
  'launchpad.err.curve_not_launched': "請先啟動聯合曲線。",
  'launchpad.err.curve_mismatch': "鏈上曲線與本次發射不符。請重新開始。",
  'launchpad.err.not_migrated': "曲線尚未畢業。",
  'launchpad.err.power_credit_disabled': "此處未啟用使用該代幣兌換遊戲內力量。",
  'launchpad.err.power_sink_unconfigured': "該領域尚未設定代幣消費。",
  'launchpad.err.not_power_realm': "該領域僅為裝飾性：其代幣無法購買遊戲力量。",
  'launchpad.err.token_2022_mismatch': "該轉帳與此領域代幣不符。請重新開始。",
  'launchpad.err.sink_not_credited': "轉帳未到達領域錢包。",
  'launchpad.err.amount_too_small': "該金額太小，無法兌換任何貨幣。",
  'launchpad.err.credit_already_recorded': "該轉帳已入帳。",
  'launchpad.err.no_character_to_credit': "請登入該領域的角色以接收入帳。",
  'launchpad.err.missing_payTxSig': "入帳提交資訊不完整。",
