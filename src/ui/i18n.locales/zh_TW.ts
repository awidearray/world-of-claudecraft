...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.riverboat_dealer.name': '荷官瑪麗貝爾',
  'entities.npcs.riverboat_dealer.title': '大沙龍的老千',
  'entities.npcs.riverboat_dealer.greeting': '請坐，{className}。牌堆是新的，發牌絕對公道。來一局嗎？',
  'entities.npcs.riverboat_pit_boss.name': '賭檯經理克雷克',
  'entities.npcs.riverboat_pit_boss.title': '賭鬥擂臺之主',
  'entities.npcs.riverboat_pit_boss.greeting': '兩名鬥士，一份彩金，{className}。上擂臺，報出你的賭注吧。',
  'entities.npcs.riverboat_slots_attendant.name': '蒂莉·斯普羅基特',
  'entities.npcs.riverboat_slots_attendant.title': '轉輪看守人',
  'entities.npcs.riverboat_slots_attendant.greeting': '機櫃已上好油，躍躍欲試，{className}。每天一次免費轉動，轉輪從不說謊。',
  'entities.npcs.riverboat_hilo_croupier.name': '軍需官諾克',
  'entities.npcs.riverboat_hilo_croupier.title': '擲骰唱數人',
  'entities.npcs.riverboat_hilo_croupier.greeting': '猜大或猜小，{className}，一擲定勝負。莊家只吃中間那一點。',
  'entities.npcs.riverboat_cashier_purser.name': '帳房奧達莉·芬奇',
  'entities.npcs.riverboat_cashier_purser.title': '錢籠看守人',
  'entities.npcs.riverboat_cashier_purser.greeting': '錢籠已開，{className}。籌碼進，錢幣出，每一本帳到天亮都要平。',
  'hudChrome.casino.stationTitle': '賭桌',
  'hudChrome.casino.cardDuelTitle': '牌桌',
  'hudChrome.casino.wagerPitTitle': '對賭擂臺',
  'hudChrome.casino.slotsTitle': '角子機',
  'hudChrome.casino.gachaTitle': '珍玩櫃',
  'hudChrome.casino.hiloTitle': '軍需官的猜大小',
  'hudChrome.casino.cashierTitle': '收銀籠',
  'hudChrome.casino.comingSoon': '遊戲即將開放。船上的夥計還在佈置牌桌。',
  'hudChrome.casino.close': '關閉',
  'hudChrome.hilo.title': '軍需官的猜大小',
  'hudChrome.hilo.rules': '在 1 到 100 的點數上猜大或猜小。小猜中 1 到 49，大猜中 52 到 100。等額賠付。',
  'hudChrome.hilo.balance': '錢袋：{amount}',
  'hudChrome.hilo.stakeLabel': '賭注',
  'hudChrome.hilo.prompt': '先選擇賭注，再猜大或猜小。',
  'hudChrome.hilo.low': '小（1 到 49）',
  'hudChrome.hilo.high': '大（52 到 100）',
  'hudChrome.hilo.session': '本次：勝 {wins}，負 {losses}',
  'hudChrome.hilo.close': '關閉',
  'hudChrome.hilo.wonLine': '擲出 {roll}。你贏得 {amount}。',
  'hudChrome.hilo.lostLine': '擲出 {roll}。你輸掉 {amount}。',
  'hudChrome.hilo.wonLog': '猜大小：擲出 {roll}，贏得 {amount}。',
  'hudChrome.hilo.lostLog': '猜大小：擲出 {roll}，輸掉 {amount}。',
};
