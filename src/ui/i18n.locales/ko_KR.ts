...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocSeason.subtitle': '트레저리 재원으로 상위 플레이어에게 지급',
  ...
  'realmOp.affiliate.copy': '링크 복사',
  'realmOp.affiliate.earningsSoon': '월드 내 수익이 시작되면 USDC 수수료 지급이 시작됩니다.',
  'realmOp.affiliate.empty': '아직 추천한 월드가 없습니다. 링크를 공유하여 수익을 시작하세요.',
  'realmOp.affiliate.loading': '추천 통계를 불러오는 중...',
  'realmOp.affiliate.open': '추천 프로그램',
  ...
  'realmOp.err.memo_mismatch': '해당 결제가 견적과 일치하지 않습니다. 다시 시작하세요.',
  'realmOp.err.not_finalized': '결제가 아직 확정되지 않았습니다. 잠시 후 다시 확인하세요.',
  ...
  'realmOp.err.realm_cap_reached': '계정당 월드 수 한도에 도달했습니다.',
  'realmOp.err.realm_name_not_allowed': '해당 월드 이름은 허용되지 않습니다.',
  'realmOp.err.realm_name_taken': '해당 월드 이름은 이미 사용 중입니다.',
  'realmOp.err.realm_not_active': '해당 월드는 활성 상태가 아닙니다.',
  ...
  'realmOp.err.tx_failed': '스테이크 트랜잭션이 온체인에서 실패했습니다.',
  'realmOp.err.tx_not_finalized': '스테이크가 아직 확정되지 않았습니다. 잠시 후 다시 확인하세요.',
  'realmOp.err.wallet_mismatch': '계정에 연결한 지갑을 연결하세요.',
  'realmOp.err.wrong_payer': '스테이크는 연결된 지갑으로 서명해야 합니다.',
  'realmOp.err.wrong_vault_amount': '잠긴 수량이 견적과 일치하지 않습니다.',
  'realmOp.flow.closed': '월드가 닫혔습니다. 이름을 다시 사용할 수 있습니다.',
  'realmOp.flow.confirming': '스테이크를 온체인에서 확인하는 중...',
  'realmOp.flow.confirmingBuy': '결제를 온체인에서 확인하는 중...',
  'realmOp.flow.connecting': '지갑에 연결하는 중...',
  'realmOp.flow.decommissioning': '해체를 시작하는 중...',
  'realmOp.flow.founded': '{name}이(가) 가동되었습니다. 운영자님, 환영합니다.',
  'realmOp.flow.locking': '지갑에서 스테이크를 승인하세요...',
  'realmOp.flow.paying': '지갑에서 결제를 승인하세요...',
  ...
  'realmOp.status.decommissioning': '해체 중',
  'realmOp.status.provisioning': '준비 중',
  'realmOp.tier.bronze': '브론즈',
  'realmOp.tier.priceUnavailable': '가격 없음',
  'realmOp.tier.share': '공급량의 {pct}%',
  'realmOp.tier.silver': '실버',
  'launchpad.open': '토큰 런치패드',
  'launchpad.title': '월드 토큰 런치패드',
  'launchpad.back': '뒤로',
  'launchpad.loading': '토큰 상태 불러오는 중...',
  'launchpad.symbolBadge': '{symbol} 토큰',
  'launchpad.status.none': '등록된 토큰 없음',
  'launchpad.status.prelaunch': '출시 전',
  'launchpad.status.voting': '커뮤니티 투표',
  'launchpad.status.presale': '사전 판매',
  'launchpad.status.funded': '목표 달성',
  'launchpad.status.refunding': '환불 진행 중',
  'launchpad.status.refunded': '환불 완료',
  'launchpad.status.live': '운영 중',
  'launchpad.status.graduated': '졸업 완료',
  'launchpad.status.closed': '종료됨',
  'launchpad.checklist.aria': '출시 체크리스트',
  'launchpad.checklist.register': '등록',
  'launchpad.checklist.vote': '투표',
  'launchpad.checklist.presale': '사전 판매',
  ...
  'launchpad.vote.tallyYes': '찬성: {amount} $WOC',
  'launchpad.vote.tallyNo': '반대: {amount} $WOC',
  'launchpad.vote.tallyAria': '전체 투표 가중치 중 찬성 비율',
  'launchpad.vote.quorum': '정족수: {current} / {required} $WOC',
  'launchpad.vote.quorumAria': '정족수 진행도',
  'launchpad.vote.threshold': '정족수 충족 및 찬성 {pct}% 이상이면 통과',
  'launchpad.vote.yourVote': '회원님의 투표가 {amount} $WOC 가중치로 기록되었습니다.',
  'launchpad.vote.outcomePending': '아직 정족수에 도달하지 않았습니다.',
  ...
  'launchpad.presale.railRaised': '{currency} 모금액 {raised} / {cap}',
  'launchpad.presale.railWalletRemaining': '남은 한도: {amount} {currency}',
  'launchpad.presale.railFull': '이 화폐는 한도에 도달했습니다.',
  'launchpad.presale.amountLabel': '금액 ({currency})',
  ...
  'launchpad.presale.config.walletLabel': '지갑당 한도 ({currency})',
  'launchpad.presale.config.submit': '사전 판매 열기',
  'launchpad.flow.registering': '토큰 등록 중...',
  'launchpad.flow.openingVote': '투표 여는 중...',
  'launchpad.flow.castingVote': '투표 기록 중...',
  'launchpad.flow.configuring': '기여 받기 여는 중...',
  'launchpad.flow.quoting': '기여 예약 중...',
  'launchpad.flow.paying': '지갑에서 전송을 승인하세요...',
  'launchpad.flow.confirming': '온체인에서 기여 검증 중...',
  'launchpad.flow.contributed': '기여가 기록되었습니다.',
  'launchpad.flow.finalizing': '사전 판매 마감 중...',
  'launchpad.err.not_realm_owner': '해당 월드를 운영하고 있지 않습니다.',
  'launchpad.err.realm_not_found': '해당 월드가 더 이상 존재하지 않습니다.',
  'launchpad.err.realm_not_active': '해당 월드가 활성 상태가 아닙니다.',
  'launchpad.err.invalid_token_symbol': '대문자와 숫자로 된 2에서 10자 티커를 선택하세요.',
  'launchpad.err.invalid_token_icon': '해당 토큰 아이콘이 유효하지 않습니다.',
  'launchpad.err.invalid_token_policy': '수익화 정책을 선택하세요.',
  'launchpad.err.token_already_registered': '이 월드에는 이미 등록된 토큰이 있습니다.',
  'launchpad.err.token_not_registered': '이 월드에는 등록된 토큰이 없습니다.',
  'launchpad.err.vote_not_open': '커뮤니티 투표가 열려 있지 않습니다.',
  'launchpad.err.vote_not_openable': '이 상태에서는 투표를 열 수 없습니다.',
  'launchpad.err.invalid_vote_choice': '찬성 또는 반대를 선택하세요.',
  'launchpad.err.wallet_not_linked': '먼저 계정에 지갑을 인증하세요.',
  'launchpad.err.vote_weight_unavailable': '$WOC 잔액을 읽을 수 없습니다. 잠시 후 다시 시도하세요.',
  'launchpad.err.no_vote_weight': '인증된 지갑에 투표할 수 있는 1 $WOC 이상이 없습니다.',
  'launchpad.err.already_voted': '이 지갑 또는 계정의 투표가 이미 기록되어 있습니다.',
  'launchpad.err.presale_not_open': '사전 판매가 열려 있지 않습니다.',
  ...
  'launchpad.err.wallet_cap_exceeded': '지갑당 한도를 초과하게 됩니다.',
  'launchpad.err.raise_cap_exceeded': '총 모금 상한을 초과하게 됩니다.',
  'launchpad.err.quote_not_found': '견적을 찾을 수 없습니다. 다시 시작하세요.',
  'launchpad.err.not_your_quote': '해당 견적은 다른 계정의 것입니다.',
  'launchpad.err.quote_expired': '견적이 만료되었습니다. 다시 시작하세요.',
  'launchpad.err.contribution_already_recorded': '해당 트랜잭션은 이미 기록되었습니다.',
  'launchpad.err.contribution_not_found': '해당 기여를 찾을 수 없습니다.',
  'launchpad.err.already_refunded': '해당 기여는 이미 환불되었습니다.',
  'launchpad.err.refund_sig_reused': '해당 환불 트랜잭션은 이미 다른 기여에 사용되었습니다.',
  'launchpad.err.wrong_refunder': '환불은 에스크로 지갑에서 지급되어야 합니다.',
  'launchpad.err.refund_short': '환불 금액이 기여를 충당하지 못합니다.',
  'launchpad.err.bad_signature': '해당 트랜잭션 서명이 유효하지 않습니다. 다시 시작하세요.',
  'launchpad.err.not_finalized': '트랜잭션이 아직 확정되지 않았습니다. 잠시 후 다시 시도하세요.',
  'launchpad.err.tx_failed': '트랜잭션이 온체인에서 실패했습니다.',
  'launchpad.err.token_2022': '해당 토큰 프로그램은 여기에서 지원되지 않습니다.',
  'launchpad.err.memo_mismatch': '해당 트랜잭션이 견적과 일치하지 않습니다. 다시 시작하세요.',
  'launchpad.err.wrong_payer': '트랜잭션은 연결된 지갑으로 서명해야 합니다.',
  'launchpad.err.escrow_short': '지불 금액이 견적과 일치하지 않습니다.',
  'launchpad.err.missing_quoteId_or_paySig': '확인 정보가 불완전합니다. 다시 시작하세요.',
  'launchpad.err.missing_payTxSig_or_refundSig': '환불 제출 정보가 불완전합니다.',
  'launchpad.err.rate_limited': '요청이 너무 많습니다. 잠시 후 다시 시도하세요.',
  'launchpad.err.wallet_mismatch': '계정에 연결한 지갑을 연결하세요.',
  'launchpad.err.generic': '문제가 발생했습니다. 다시 시도하세요.',
  'launchpad.launch.title': '토큰 런치',
  'launchpad.launch.subtitle':
    '민트를 생성하고 고정 공급량을 배분하며 모든 비공개 몫을 온체인에 잠급니다. 모든 잠금이 검증되기 전에는 토큰이 상장될 수 없습니다.',
  'launchpad.launch.stepsAria': '런치 단계',
  'launchpad.launch.step.mint': '민트 생성',
  'launchpad.launch.step.locks': '배분 및 잠금',
  ...
  'launchpad.launch.bucket.levy': 'Levy Street 펀드',
  ...
  'launchpad.launch.locksTitle': '잠금 검증',
  'launchpad.launch.locksHint':
    '전체 공급량을 민트하고 위의 정확한 조건으로 취소 불가능한 Jupiter Lock 에스크로 3개를 생성한 뒤 민트 권한을 포기하고, 각 에스크로 주소를 여기에 붙여 넣으세요. 모든 내용이 체인과 대조 확인됩니다.',
  'launchpad.launch.lockLabel': '{bucket} 잠금 에스크로 주소',
  'launchpad.launch.verifyBtn': '온체인 검증',
  'launchpad.launch.checksAria': '온체인 검증 체크리스트',
  'launchpad.launch.checkPass': '통과',
  'launchpad.launch.checkFail': '실패',
  'launchpad.launch.check.mint_found': '민트 계정 읽기 가능',
  'launchpad.launch.check.mint_profile': '깨끗한 토큰 구성 (동결 없음, 후크 없음, 수수료 없음)',
  'launchpad.launch.check.supply_exact': '고정 공급량이 정확히 민트됨',
  'launchpad.launch.check.mint_authority_renounced': '민트 권한 포기됨',
  'launchpad.launch.check.lock_found': '잠금 에스크로 확인됨',
  'launchpad.launch.check.lock_mint': '잠금이 이 토큰을 보유',
  'launchpad.launch.check.lock_recipient': '잠금 수령인 일치',
  'launchpad.launch.check.lock_immutable': '잠금 불변 (취소 불가, 수령인 변경 불가)',
  'launchpad.launch.check.lock_token_program': '잠금이 올바른 토큰 프로그램 사용',
  'launchpad.launch.check.lock_untouched': '잠금이 미청구 상태이며 취소된 적 없음',
  'launchpad.launch.check.lock_amount': '잠금 수량 정확',
  'launchpad.launch.check.lock_schedule': '베스팅 일정이 약속을 충족',
  'launchpad.launch.check.lock_funded': '잠금 에스크로가 토큰 보유',
  'launchpad.launch.check.unknown': '추가 확인',
  'launchpad.flow.preparingMint': '민트 트랜잭션을 준비하는 중...',
  'launchpad.flow.signingMint': '지갑에서 민트 생성을 승인하세요...',
  'launchpad.flow.confirmingMint': '온체인에서 민트를 검증하는 중...',
  'launchpad.flow.mintDone': '민트가 생성되고 검증되었습니다.',
  'launchpad.flow.verifying': '온체인에서 잠금을 검증하는 중...',
  'launchpad.flow.verified': '런치 검증 완료: 모든 잠금이 온체인에 있습니다.',
  ...
  'launchpad.err.chain_unavailable': '체인에 연결할 수 없습니다. 잠시 후 다시 시도하세요.',
  'launchpad.err.launch_not_prepared': '먼저 민트 트랜잭션을 준비하세요.',
  'launchpad.err.mint_not_in_tx': '해당 트랜잭션은 고정된 민트를 생성하지 않았습니다.',
  'launchpad.err.mint_not_found': '온체인에서 민트 계정을 읽을 수 없습니다.',
  ...
  'launchpad.err.mint_not_created': '먼저 민트를 생성하고 확인하세요.',
  'launchpad.err.invalid_lock_address': '서로 다른 유효한 잠금 에스크로 주소 3개를 입력하세요.',
  'launchpad.err.launch_not_verifiable': '런치가 아직 검증할 준비가 되지 않았습니다.',
  'launchpad.err.locks_not_verified': '잠금이 아직 온체인에서 검증되지 않았습니다.',
  'launchpad.err.not_listable': '이 상태에서는 토큰을 상장할 수 없습니다.',
  'launchpad.err.missing_sig': '확인 정보가 불완전합니다. 처음부터 다시 시작하세요.',
  'launchpad.curve.title': '본딩 커브',
  'launchpad.curve.subtitle':
    '토큰은 모두에게 같은 가격의 공개 커브에서 거래됩니다. 이전 임계값에 도달하면 LP가 영구 잠기는 유동성 풀로 졸업합니다.',
  'launchpad.curve.lpLockLine': '런치 구성이 졸업 LP의 {pct}%를 영구 잠급니다.',
  ...
  'launchpad.flow.preparingCurve': '커브 풀을 준비하는 중...',
  'launchpad.flow.signingCurve': '지갑에서 풀 생성을 승인하세요...',
  'launchpad.flow.curveSubmitted': '풀 생성이 전송되었습니다. 확정 후 상장을 검증하세요.',
  'launchpad.flow.verifyingCurve': '온체인에서 커브를 검증하는 중...',
  'launchpad.flow.curveListed': '토큰이 커브에서 라이브 상태입니다.',
  ...
  'launchpad.err.graduation_not_found': '졸업한 유동성 풀을 아직 온체인에서 찾을 수 없습니다.',
  'launchpad.err.lp_not_permanently_locked': '유동성이 영구 잠기지 않았습니다.',
  'launchpad.err.not_damm_v2': '런치 구성이 잠금 풀로 졸업하지 않습니다.',
  'launchpad.err.no_locked_vesting': '런치 구성에 잠긴 베스팅이 없습니다.',
  'launchpad.err.no_migration_threshold': '런치 구성에 이전 임계값이 없습니다.',
  'launchpad.fund.open': 'Levy Street 펀드',
  'launchpad.fund.title': 'Levy Street 펀드',
  'launchpad.fund.subtitle':
    '플랫폼은 여기서 런치된 모든 렐름 토큰의 잠긴 지분을 보유하며 실시간으로 공개합니다. 이것은 투명한 트레저리이지 매수할 수 있는 펀드가 아닙니다. 이 페이지의 어떤 것도 사고팔거나 상환할 수 없습니다.',
  'launchpad.fund.loading': '포트폴리오를 불러오는 중...',
  'launchpad.fund.notPublished': '포트폴리오가 아직 게시되지 않았습니다.',
  ...
  'launchpad.fund.colPrice': '가격 (USD)',
  'launchpad.fund.colValue': '가치 (USD)',
  'launchpad.fund.colWeight': '비중',
  'launchpad.fund.colStatus': '상태',
  'launchpad.fund.badgeLocked': '잠김',
  'launchpad.fund.badgeGraduated': '졸업',
  'launchpad.fund.statusIlliquid': '유동성 부족 (총액에서 제외)',
