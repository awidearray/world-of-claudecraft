...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.riverboat_dealer.name': '딜러 마리벨',
  'entities.npcs.riverboat_dealer.title': '그랜드 살롱의 타짜',
  'entities.npcs.riverboat_dealer.greeting': '앉으시죠, {className}. 카드는 새것이고 딜은 정직합니다. 한 판 하시겠어요?',
  'entities.npcs.riverboat_pit_boss.name': '핏 보스 크레이크',
  'entities.npcs.riverboat_pit_boss.title': '베팅 링의 주인',
  'entities.npcs.riverboat_pit_boss.greeting': '두 명의 투사, 하나의 상금, {className}. 링에 올라 판돈을 말하십시오.',
  'entities.npcs.riverboat_slots_attendant.name': '틸리 스프로켓',
  'entities.npcs.riverboat_slots_attendant.title': '릴의 관리인',
  'entities.npcs.riverboat_slots_attendant.greeting': '기계는 기름칠이 되어 준비됐습니다, {className}. 하루 한 번 무료 회전, 릴은 결코 거짓말하지 않죠.',
  'entities.npcs.riverboat_hilo_croupier.name': '병참관 노크',
  'entities.npcs.riverboat_hilo_croupier.title': '주사위를 부르는 자',
  'entities.npcs.riverboat_hilo_croupier.greeting': '하이 아니면 로, {className}, 한 번의 굴림으로 정해집니다. 하우스는 가운데만 가져갑니다.',
  ...
  'hudChrome.hilo.title': '병참관의 하이로',
  'hudChrome.hilo.rules': '1에서 100 사이의 값에 하이 또는 로를 부릅니다. 로는 1에서 49, 하이는 52에서 100에서 이깁니다. 배당은 1대 1.',
  'hudChrome.hilo.balance': '지갑: {amount}',
  'hudChrome.hilo.stakeLabel': '판돈',
  'hudChrome.hilo.prompt': '판돈을 고른 뒤 하이나 로를 부르세요.',
  'hudChrome.hilo.low': '로 (1에서 49)',
  'hudChrome.hilo.high': '하이 (52에서 100)',
  'hudChrome.hilo.session': '이번 판: {wins}승 {losses}패',
  'hudChrome.hilo.close': '닫기',
  'hudChrome.hilo.wonLine': '{roll}이 나왔습니다. {amount}을 땄습니다.',
  'hudChrome.hilo.lostLine': '{roll}이 나왔습니다. {amount}을 잃었습니다.',
  'hudChrome.hilo.wonLog': '하이로: {roll}이 나와 {amount} 획득.',
  'hudChrome.hilo.lostLog': '하이로: {roll}이 나와 {amount} 손실.',
};
