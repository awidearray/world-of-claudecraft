...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'launchpad.launches.open': '커뮤니티 발사',
  'launchpad.launches.title': '커뮤니티 발사',
  'launchpad.launches.subtitle':
    '토큰 발사 투표가 진행 중이거나 사전 판매 중인 서버입니다. 누구나 투표하거나 기여할 수 있습니다.',
  'launchpad.launches.loading': '커뮤니티 발사를 불러오는 중...',
  'launchpad.launches.empty': '현재 투표 중이거나 사전 판매 중인 서버가 없습니다. 나중에 다시 확인해 주세요.',
  'launchpad.launches.statusVoting': '커뮤니티 투표',
  'launchpad.launches.statusPresale': '사전 판매',
  'launchpad.launches.powerTag': '페이 투 윈',
  'launchpad.launches.progressVoting': '정족수의 {pct}%',
  'launchpad.launches.progressPresale': '소프트캡의 {pct}%',
  'launchpad.launches.ctaVote': '투표하기',
  'launchpad.launches.ctaContribute': '기여하기',
  'launchpad.levy.open': "레비 스트리트 펀드",
  'launchpad.levy.title': "레비 스트리트 펀드",
  'launchpad.levy.subtitle': "여기서 런치된 모든 렐름 토큰의 일부를 보유하는 투명한 표시 전용 포트폴리오입니다.",
  'launchpad.levy.displayOnlyNote': "표시 전용: 펀드는 이 토큰들을 여러분과 함께 보유하며 매도할 수 없습니다. 펀드 지분도 상환도 없습니다.",
  'launchpad.levy.loading': "포트폴리오를 불러오는 중……",
  'launchpad.levy.empty': "아직 보유 자산이 없습니다. 런치된 렐름 토큰은 상장되면 여기에 표시됩니다.",
  'launchpad.levy.aum': "총 가치(AUM)",
  'launchpad.levy.holdings': "{count}개 보유",
  'launchpad.levy.excluded': "{count}개는 비유동으로 제외됨",
  'launchpad.levy.clamped': "이번 새로고침의 가치 변동은 확인 대기 중으로 제한되었습니다.",
  'launchpad.levy.updated': "{time}에 업데이트됨",
  'launchpad.levy.colToken': "토큰",
  'launchpad.levy.colAmount': "수량",
  'launchpad.levy.colPrice': "가격",
  'launchpad.levy.colValue': "가치",
  'launchpad.levy.colWeight': "비중",
  'launchpad.levy.illiquidTag': "비유동",
  'launchpad.levy.sourceCurve': "커브",
  'launchpad.levy.locked': "체인에 잠김",
  'launchpad.err.missing_payTxSig_or_refundSig': '환불 제출 정보가 불완전합니다.',
  'launchpad.err.mint_not_ready': "토큰은 프리세일이 목표를 달성한 후에만 발행할 수 있습니다.",
  'launchpad.err.token_already_minted': "이 토큰은 이미 발행되었습니다.",
  'launchpad.err.token_not_minted': "먼저 토큰을 발행하세요.",
  'launchpad.err.levy_wallet_unconfigured': "이 렐름 호스트에서는 토큰 런치가 아직 활성화되지 않았습니다.",
  'launchpad.err.launch_unavailable': "런치 서비스를 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
  'launchpad.err.launch_sig_reused': "해당 트랜잭션은 이미 다른 런치에 사용되었습니다.",
  'launchpad.err.mint_mismatch': "체인상의 민트가 이 런치와 일치하지 않습니다. 다시 시작하세요.",
  'launchpad.err.already_distributed': "공급량이 이미 분배되었습니다.",
  'launchpad.err.not_distributed': "먼저 공급량을 분배하세요.",
  'launchpad.err.distribution_mismatch': "분배가 할당 계획과 일치하지 않습니다.",
  'launchpad.err.invalid_lock_bucket': "파운더, 레비, 트레저리 락 중 하나를 선택하세요.",
  'launchpad.err.already_locked': "해당 할당량은 이미 잠겨 있습니다.",
  'launchpad.err.lock_mismatch': "체인상의 락이 이 런치와 일치하지 않습니다. 다시 시작하세요.",
  'launchpad.err.lock_not_immutable': "해당 락은 불변이 아닙니다. 누구도 취소할 수 없어야 합니다.",
  'launchpad.err.lock_underfunded': "락에 할당량 전액이 들어 있지 않습니다.",
  'launchpad.err.locks_incomplete': "파운더, 레비, 유동성 락이 모두 체인에서 검증될 때까지 토큰을 상장할 수 없습니다.",
  'launchpad.err.missing_quoteId_or_signature': "런치 확인 정보가 불완전했습니다. 다시 시작하세요.",
  'launchpad.err.curve_disabled': "이 렐름 호스트에서는 본딩 커브 런치가 아직 활성화되지 않았습니다.",
  'launchpad.err.fee_claimer_unconfigured': "플랫폼 수수료 금고가 아직 설정되지 않았습니다.",
  'launchpad.err.curve_already_launched': "이 토큰에는 이미 본딩 커브가 있습니다.",
  'launchpad.err.curve_not_launched': "먼저 본딩 커브를 런치하세요.",
  'launchpad.err.curve_mismatch': "체인상의 커브가 이 런치와 일치하지 않습니다. 다시 시작하세요.",
  'launchpad.err.not_migrated': "커브가 아직 졸업하지 않았습니다.",
  'launchpad.err.power_credit_disabled': "이 토큰을 게임 내 파워로 사용하는 것은 여기서 활성화되지 않았습니다.",
  'launchpad.err.power_sink_unconfigured': "이 렐름은 아직 토큰 사용을 설정하지 않았습니다.",
  'launchpad.err.not_power_realm': "이 렐름은 외형 전용입니다: 토큰으로 게임 파워를 살 수 없습니다.",
  'launchpad.err.token_2022_mismatch': "그 전송은 이 렐름 토큰과 일치하지 않습니다. 다시 시작하세요.",
  'launchpad.err.sink_not_credited': "전송이 렐름 지갑에 도달하지 않았습니다.",
  'launchpad.err.amount_too_small': "그 금액은 너무 작아 화폐로 환산할 수 없습니다.",
  'launchpad.err.credit_already_recorded': "그 전송은 이미 반영되었습니다.",
  'launchpad.err.no_character_to_credit': "이 렐름의 캐릭터로 로그인하여 받으세요.",
  'launchpad.err.missing_payTxSig': "크레딧 제출 정보가 불완전했습니다.",
