...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.merch.unavailable': '굿즈 스토어를 지금은 이용할 수 없습니다. 주문과 결제에는 영향이 없습니다. 잠시 후 다시 시도해 주세요.',
  'hudChrome.merch.disclosure': '굿즈는 인쇄 파트너가 주문 제작하여 배송합니다. 굿즈 구매에 사용한 Claudium은 Claudium으로 환불되지 않으며, 카드 및 Solana 결제는 서비스 약관의 환불 정책을 따릅니다.',
  ...
  'hudChrome.merch.checkoutPending': '주문을 처리 중입니다. 결제를 완료하고 이 페이지를 열어 두세요.',
  'hudChrome.merch.checkoutFailed': '결제를 시작할 수 없습니다. 다시 시도해 주세요.',
  'hudChrome.merch.checkoutUnavailable': '해당 주문은 지금 이용할 수 없습니다.',
  'hudChrome.merch.checkoutNotSettled': '트랜잭션은 전송되었지만 주문이 아직 확인되지 않았습니다. 잠시 후 주문 내역을 확인해 주세요.',
  'hudChrome.merch.orderPlaced': '주문 {orderId}이(가) 접수되었습니다. 아래 주문 내역에서 추적할 수 있습니다.',
