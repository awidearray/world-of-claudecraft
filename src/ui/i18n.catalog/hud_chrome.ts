...
export const hudChromeStrings = {
  ...
  // Merch store (Printful dropship) on the homepage Store tab. Physical goods
  // paid with Claudium, card (Stripe), or Solana; the economy service owns every
  // price and the client renders what it gets (see docs/prd/woc/merch-store.md).
  merch: {
    title: 'Merch Store',
    subtitle: 'Official World of ClaudeCraft merchandise, shipped worldwide.',
    loading: 'Loading the store...',
    unavailable:
      'The merch store is unavailable right now. No orders or payments are affected; please check back shortly.',
    disclosure:
      'Merch is produced and shipped on demand by our print partner. Claudium spent on merch is not refundable as Claudium; card and Solana payments follow the refund policy in the Terms of Service.',
    ...
    checkoutNotSettled:
      'The transaction was sent but the order is not confirmed yet. Check your orders shortly.',
