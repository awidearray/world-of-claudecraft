...
const ITEM_ENTITY_IDS = [
  ...
  "charter_ashmane", "charter_emberhoof", "charter_bronzeflank", "charter_silvermane", "charter_stormhoof",
  "charter_goldcrest", "charter_verdant", "charter_voidstrider", "charter_celestial", "charter_worldbearer",
] as const;
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Cragwalker Boots", "Windguard Leggings", "Ogre Toe Ring", "Inert Storm Shard", "Frayed Prayer Beads", "Cracked Wyrm Scale",
          ...
          "Charter: Ashmane Courser", "Charter: Emberhoof Charger", "Charter: Bronzeflank Destrier", "Charter: Silvermane Stallion", "Charter: Stormhoof Charger",
          "Charter: Goldcrest Skystrider", "Charter: Verdant Wildwing", "Charter: Voidwing Strider", "Charter: Celestial Seraph", "Charter: Worldbearer's Roc",
    ]),
  },
};
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas Caminarrocas", "Leotardos Guardavientos", "Anillo de dedo de ogro", "Fragmento de tormenta inerte", "Cuentas de oración deshilachadas", "Escama de wyrm agrietada",
            ...
            "Título: Ashmane Courser", "Título: Emberhoof Charger", "Título: Bronzeflank Destrier", "Título: Silvermane Stallion", "Título: Stormhoof Charger",
            "Título: Goldcrest Skystrider", "Título: Verdant Wildwing", "Título: Voidwing Strider", "Título: Celestial Seraph", "Título: Worldbearer's Roc",
    ]),
    },
  },
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Bottes Marchecrag", "Jambières Gardevent", "Anneau d'orteil ogre", "Éclat de tempête inerte", "Perles de prière effilochées", "Écaille de wyrm fendue",
            ...
            "Titre : Ashmane Courser", "Titre : Emberhoof Charger", "Titre : Bronzeflank Destrier", "Titre : Silvermane Stallion", "Titre : Stormhoof Charger",
            "Titre : Goldcrest Skystrider", "Titre : Verdant Wildwing", "Titre : Voidwing Strider", "Titre : Celestial Seraph", "Titre : Worldbearer's Roc",
    ]),
    },
  },
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Stivali Camminarocce", "Gambiere Guardavento", "Anello da dito d'ogre", "Scheggia di tempesta inerte", "Grani di preghiera sfilacciati", "Scaglia di wyrm incrinata",
            ...
            "Brevetto: Ashmane Courser", "Brevetto: Emberhoof Charger", "Brevetto: Bronzeflank Destrier", "Brevetto: Silvermane Stallion", "Brevetto: Stormhoof Charger",
            "Brevetto: Goldcrest Skystrider", "Brevetto: Verdant Wildwing", "Brevetto: Voidwing Strider", "Brevetto: Celestial Seraph", "Brevetto: Worldbearer's Roc",
    ]),
    },
  },
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Felswandererstiefel", "Windwachtgamaschen", "Ogerzehenring", "Träger Sturmsplitter", "Ausgefranste Gebetsperlen", "Gesprungene Wyrmschuppe",
            ...
            "Urkunde: Ashmane Courser", "Urkunde: Emberhoof Charger", "Urkunde: Bronzeflank Destrier", "Urkunde: Silvermane Stallion", "Urkunde: Stormhoof Charger",
            "Urkunde: Goldcrest Skystrider", "Urkunde: Verdant Wildwing", "Urkunde: Voidwing Strider", "Urkunde: Celestial Seraph", "Urkunde: Worldbearer's Roc",
    ]),
    },
  },
  zh_CN: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "岩行者长靴", "风卫护腿", "食人魔趾环", "惰性风暴碎片", "磨损的祈祷珠", "裂开的龙鳞",
            ...
            "证书：Ashmane Courser", "证书：Emberhoof Charger", "证书：Bronzeflank Destrier", "证书：Silvermane Stallion", "证书：Stormhoof Charger",
            "证书：Goldcrest Skystrider", "证书：Verdant Wildwing", "证书：Voidwing Strider", "证书：Celestial Seraph", "证书：Worldbearer's Roc",
    ]),
    },
  },
  zh_TW: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "岩行者長靴", "風衛護腿", "巨魔趾環", "惰性風暴碎片", "磨損的祈禱珠", "裂開的龍鱗",
            ...
            "證書：Ashmane Courser", "證書：Emberhoof Charger", "證書：Bronzeflank Destrier", "證書：Silvermane Stallion", "證書：Stormhoof Charger",
            "證書：Goldcrest Skystrider", "證書：Verdant Wildwing", "證書：Voidwing Strider", "證書：Celestial Seraph", "證書：Worldbearer's Roc",
    ]),
    },
  },
  ko_KR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "바위걸음 장화", "바람수호 다리보호구", "오우거 발가락 반지", "비활성 폭풍 파편", "해진 기도 구슬", "갈라진 고룡 비늘",
            ...
            "증서: Ashmane Courser", "증서: Emberhoof Charger", "증서: Bronzeflank Destrier", "증서: Silvermane Stallion", "증서: Stormhoof Charger",
            "증서: Goldcrest Skystrider", "증서: Verdant Wildwing", "증서: Voidwing Strider", "증서: Celestial Seraph", "증서: Worldbearer's Roc",
    ]),
    },
  },
  ja_JP: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "岩歩きのブーツ", "風守りのレギンス", "オーガの足指輪", "不活性の嵐片", "ほつれた祈りの数珠", "割れたワームの鱗",
            ...
            "証書：Ashmane Courser", "証書：Emberhoof Charger", "証書：Bronzeflank Destrier", "証書：Silvermane Stallion", "証書：Stormhoof Charger",
            "証書：Goldcrest Skystrider", "証書：Verdant Wildwing", "証書：Voidwing Strider", "証書：Celestial Seraph", "証書：Worldbearer's Roc",
    ]),
    },
  },
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Сапоги Камнехода", "Поножи Ветростража", "Кольцо на палец огра", "Инертный осколок бури", "Истрепанные молитвенные четки", "Треснувшая чешуя вирма",
            ...
            "Грамота: Ashmane Courser", "Грамота: Emberhoof Charger", "Грамота: Bronzeflank Destrier", "Грамота: Silvermane Stallion", "Грамота: Stormhoof Charger",
            "Грамота: Goldcrest Skystrider", "Грамота: Verdant Wildwing", "Грамота: Voidwing Strider", "Грамота: Celestial Seraph", "Грамота: Worldbearer's Roc",
    ]),
    },
  },
};
