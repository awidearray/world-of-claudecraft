...
export const realmOperatorStrings = {
  ...
  found: {
    ...
    tierHint:
      'A larger stake unlocks a higher tier: more players, more customization budget, and operator payout rails.',
    supplyNote: 'Each tier is priced as a share of the live $WOC supply.',
    badgeNote:
      'Your staked $WOC keeps counting toward your holder badge, so founding a realm never lowers your tier.',
    ...
    stakingNote:
      'You sign one transaction locking {amount} $WOC into escrow. Recover it any time after a {days}-day timelock by decommissioning.',
  ...
  buy: {
    ...
    splitNote:
      '{treasuryPct}% of your payment funds the treasury. The rest buys back and burns $WOC.',
    finalNote:
      'A purchase is final and non-refundable. Unlike a stake, it is not returned when you decommission.',
    ...
    bondNote:
      "Also hold {amount} $WOC, kept in your linked wallet for the realm's life or the realm lapses.",
    bondWhy:
      'This ongoing bond is separate from the {currency} you pay: it keeps your skin in the game while you operate the realm.',
  },
  mine: {
    title: 'My Realms',
    ...
    decommissionConfirm:
      'Decommission {name}? This takes the realm offline and starts the {days}-day stake-release timelock.',
    bondInfo: 'Bond: hold {amount} $WOC in your linked wallet.',
    bondWarning:
      'Bond below requirement. Hold {amount} $WOC and top up before {date} or this realm lapses.',
  },
  status: {
    active: 'Active',
  ...
  affiliate: {
    ...
    subtitle:
      'Share one link. Players who join through it get an XP and gold head start, you earn from what they earn, and you get 15% of any realm they found.',
    ...
    bonusReferee:
      'Players who join through your link get +10% XP and gold for their first 30 days.',
    ...
    rewardsEmpty:
      'Refer players to start earning. Rewards land on your character at your next login.',
  ...
  err: {
    ...
    stake_service_unavailable:
      'Staking is temporarily unavailable. Try confirming again in a moment.',
    ...
    bond_required:
      'You must hold {amount} $WOC in your linked wallet to buy this tier. Top up and try again.',
