...
export const ja_JP: EnTranslations = {
  ...
  "launchpad": {
    ...
    "levy": {
      ...
      "subtitle": "ここでローンチされたすべてのレルムトークンの一部を保有する、透明で表示専用のポートフォリオです。",
      "displayOnlyNote": "表示専用：ファンドはこれらのトークンをあなたと並んで保有し、売却できません。ファンドシェアも償還もありません。",
      "loading": "ポートフォリオを読み込んでいます……",
      "empty": "まだ保有はありません。ローンチされたレルムトークンは上場後にここに表示されます。",
      "aum": "総額（AUM）",
      "aumSol": "in SOL",
      "holdings": "{count} 件の保有",
      "excluded": "{count} 件を流動性不足として除外",
      "clamped": "この更新の価値変動は確認待ちで制限されました。",
      "updated": "{time} に更新",
      "colToken": "トークン",
      "colAmount": "数量",
      "colPrice": "価格",
    ...
    "err": {
      ...
      "mint_not_ready": "トークンの発行はプレセールの達成後にのみ行えます。",
      "token_already_minted": "このトークンは既に発行済みです。",
      "token_not_minted": "先にトークンを発行してください。",
      "levy_wallet_unconfigured": "このレルムホストではトークンローンチはまだ有効になっていません。",
      "launch_unavailable": "ローンチサービスは一時的に利用できません。しばらくしてからもう一度お試しください。",
      "launch_sig_reused": "そのトランザクションは既に別のローンチで使用されています。",
      "mint_mismatch": "チェーン上のミントがこのローンチと一致しません。最初からやり直してください。",
      "already_distributed": "供給量は既に分配済みです。",
      "not_distributed": "先に供給量を分配してください。",
      "distribution_mismatch": "分配が割り当て計画と一致しません。",
      "invalid_lock_bucket": "ファウンダー、レビー、トレジャリーのいずれかのロックを選んでください。",
      "already_locked": "その割り当ては既にロック済みです。",
      "lock_mismatch": "チェーン上のロックがこのローンチと一致しません。最初からやり直してください。",
      "lock_not_immutable": "そのロックは不変ではありません。誰にも取り消せない必要があります。",
      ...
      "power_credit_disabled": "このトークンをゲーム内パワーに使うことはここでは有効になっていません。",
      "power_sink_unconfigured": "このレルムはまだトークンの利用を設定していません。",
      "not_power_realm": "このレルムはコスメティック専用です。トークンでゲームパワーは買えません。",
      "token_2022_mismatch": "その送金はこのレルムトークンと一致しません。最初からやり直してください。",
      "sink_not_credited": "送金がレルムのウォレットに届きませんでした。",
      "amount_too_small": "その金額は小さすぎて通貨に換算できません。",
      "credit_already_recorded": "その送金は既に反映されています。",
      "no_character_to_credit": "このレルムのキャラクターにログインして受け取ってください。",
      "missing_payTxSig": "クレジットの送信情報が不完全でした。",
      "rate_limited": "リクエストが多すぎます。少し待ってからもう一度お試しください。",
      "wallet_mismatch": "アカウントにリンクしたウォレットを接続してください。",
      "generic": "問題が発生しました。もう一度お試しください。"
    }
