...
export const ja_JP: EnTranslations = {
  ...
  "realmOp": {
    ...
    "found": {
      "title": "ワールドを設立",
      "subtitle": "$WOC をノンカストディアルのエスクローにステークして、自分のワールドを開設・運営しましょう。",
      "nameLabel": "ワールド名",
      "namePlaceholder": "ワールドに名前を付ける",
      "typeLabel": "ワールドタイプ",
      "tierLabel": "ステークティア",
      "tierHint": "ステークが大きいほど高いティアが解放されます。より多くのプレイヤー、より多くのカスタマイズ予算、運営者向け収益レールが手に入ります。",
      "supplyNote": "各ティアの価格は $WOC の現在供給量に対する割合で決まります。",
      "badgeNote": "ステークした $WOC はホルダーバッジに引き続きカウントされるため、ワールドを設立してもティアが下がることはありません。",
      "affiliateNote": "アフィリエイトの紹介によるものです。彼らはこのワールドの収益から 15% のコミッションを得ます。",
      "tiersUnavailable": "ティアのライブ価格は現在利用できません。しばらくしてからもう一度お試しください。",
      "submit": "ステークして設立",
      "submitConnect": "設立するにはウォレットを接続",
      "stakingNote": "{amount} $WOC をエスクローにロックするトランザクションに 1 回署名します。廃止後、{days} 日のタイムロック経過後にいつでも回収できます。",
      "nameTaken": "別の名前を選んでください。その名前は使われています。",
      "methodLabel": "支払い方法",
      "methodStake": "$WOC をステーク",
      "methodStakeHint": "$WOC をエスクローにロックします。廃止時に全額返還されます。",
      "methodBuy": "SOL か USDC で購入",
      "methodBuyHint": "SOL か USDC で 1 回だけ支払います。最終購入で、回収できるステークはありません。"
    },
    "tier": {
      "bronze": "ブロンズ",
      "silver": "シルバー",
      ...
      "priceUnavailable": "価格なし"
    },
    "buy": {
      "currencyLabel": "支払い通貨",
      "currencySol": "SOL",
      "currencyUsdc": "USDC",
      "currencyUnavailable": "{currency} は現在利用できません（スワップ経路がありません）。",
      "splitNote": "支払いの {treasuryPct}% はトレジャリーに入り、残りは $WOC の買い戻しと焼却に使われます。",
      "finalNote": "購入は最終的なもので返金できません。ステークと異なり、ワールドを廃止しても返還されません。",
      "unavailable": "ワールドの購入は現在利用できません。代わりに $WOC をステークして設立してください。",
      "submit": "購入して設立",
      "submitConnect": "購入するにはウォレットを接続",
      "note": "{amount} {currency} を支払うトランザクションに 1 回署名して、このワールドを設立します。ワールドは即時に有効になります。",
      "bondNote": "さらに {amount} $WOC を保有し、ワールドの存続期間中はリンク済みウォレットに保持する必要があります。失うとワールドは失効します。",
      "bondWhy": "この継続ボンドは支払う {currency} とは別のものです。ワールドを運営する間、あなたの利害を結び付けておくためのものです。"
    },
    "mine": {
      "title": "マイワールド",
      "loading": "ワールドを読み込み中...",
      "empty": "まだワールドを運営していません。上で設立して始めましょう。",
      "tier": "{tier} ティア",
      "decommission": "廃止",
      "release": "閉鎖を完了",
      "enter": "入る",
      "eligible": "ステークは {date} に解放可能",
      "releaseHint": "オンチェーンでステークを解放してから最終処理を行うと、ワールドが閉鎖され名前が解放されます。",
      "decommissionConfirm": "{name} を廃止しますか？ワールドはオフラインになり、{days} 日のステーク解放タイムロックが始まります。",
      "bondInfo": "ボンド：リンク済みウォレットに {amount} $WOC を保有。",
      "bondWarning": "ボンドが必要額を下回っています。{amount} $WOC を保有し、{date} までに補充しないとこのワールドは失効します。"
    },
    "status": {
      "active": "アクティブ",
      "provisioning": "プロビジョニング中",
      "decommissioning": "廃止処理中"
    },
    "affiliate": {
      "open": "紹介プログラム",
      "title": "紹介・アフィリエイトプログラム",
      "subtitle": "リンクを 1 つ共有しましょう。参加したプレイヤーは XP とゴールドのブーストを獲得し、あなたは彼らの獲得分から報酬を得て、彼らが設立したワールドからは 15% を受け取れます。",
      "yourLink": "あなたの紹介リンク",
      "copy": "リンクをコピー",
      "copied": "コピーしました",
      "loading": "紹介の統計を読み込み中...",
      "bonusTitle": "リンクの報酬の仕組み",
      "bonusReferee": "あなたのリンクから参加したプレイヤーは、最初の 30 日間 XP とゴールドが +10% になります。",
      "bonusReferrer": "その期間中、彼らの獲得分の +5% があなたのキャラクターに加算されます。",
      "bonusRealm": "さらに、彼らが設立したワールドから 15% の USDC コミッションを獲得できます。",
      "rewardsTitle": "紹介報酬",
      "rewardsPending": "{xp} XP と {gold} が保留中。次回ログイン時に付与されます",
      "rewardsLifetime": "累計 {xp} XP と {gold} を獲得",
      "rewardsReferred": "紹介したプレイヤー：{count}",
      "rewardsEmpty": "プレイヤーを紹介して獲得を始めましょう。報酬は次回ログイン時にキャラクターへ付与されます。",
      "referredTitle": "紹介したワールド",
      "referredCount": "紹介した稼働中ワールド {count} 件",
      "referredCountPlural": "紹介した稼働中ワールド {count} 件",
      "empty": "紹介したワールドはまだありません。リンクを共有して獲得を始めましょう。",
      "commission": "{pct}% のコミッション",
      "earningsSoon": "ワールド内収益が稼働すると、USDC コミッションの支払いが始まります。",
      "unavailable": "紹介の統計は現在利用できません。しばらくしてからもう一度お試しください。"
    },
    "flow": {
      "connecting": "ウォレットに接続中...",
      "quoting": "ワールドを予約しています...",
      "locking": "ウォレットでステークを承認してください...",
      "confirming": "ステークをオンチェーンで検証中...",
      "paying": "ウォレットで支払いを承認してください...",
      "confirmingBuy": "支払いをオンチェーンで検証中...",
      "decommissioning": "廃止処理を開始しています...",
      "releasing": "閉鎖処理を完了しています...",
      "released": "ワールドを閉鎖しました。その名前は再び使用できます。",
      "closed": "ワールドを閉鎖しました。その名前は再び使用できます。",
      "founded": "{name} が稼働しました。ようこそ、運営者どの。"
    },
    "err": {
      "invalid_realm_name": "そのワールド名は使用できません。英数字、スペース、ハイフンを使ってください。",
      "realm_name_not_allowed": "そのワールド名は使用できません。",
      "realm_name_taken": "そのワールド名はすでに使われています。",
      "realm_cap_reached": "アカウントごとのワールド数の上限に達しています。",
      "stake_below_minimum": "そのステークは最低ティアを下回っています。より高いティアを選んでください。",
      "supply_unavailable": "$WOC の供給量データは一時的に利用できません。しばらくしてからもう一度お試しください。",
      "invalid_amount": "そのステーク額は無効です。ティアを選んでからもう一度お試しください。",
      "link_wallet": "先にウォレットをアカウントにリンクしてください。",
      "wallet_mismatch": "アカウントにリンクしたウォレットを接続してください。",
      "quote_expired": "見積もりの有効期限が切れました。最初からやり直してください。",
      "quote_not_found": "見積もりが見つかりませんでした。最初からやり直してください。",
      "not_your_quote": "その見積もりは別のアカウントのものです。",
      "stake_already_recorded": "そのステークはすでに記録されています。",
      "tx_not_finalized": "ステークはまだ最終確定していません。しばらくしてからもう一度確認してください。",
      "tx_failed": "ステークのトランザクションがオンチェーンで失敗しました。",
      "token_2022": "この $WOC ミントはステーキングに対応していません。",
      "wrong_vault_amount": "ロックされた額が見積もりと一致しません。",
      "wrong_payer": "ステークはリンク済みウォレットで署名する必要があります。",
      "stake_service_unavailable": "ステーキングは一時的に利用できません。しばらくしてからもう一度確認してください。",
      "not_realm_owner": "あなたはそのワールドの運営者ではありません。",
      "realm_not_found": "そのワールドはもう存在しません。",
      "realm_not_active": "そのワールドはアクティブではありません。",
      "realm_not_decommissioning": "そのワールドは廃止処理中ではありません。",
      "timelock_not_elapsed": "ステークのタイムロックがまだ経過していません。",
      "stake_not_released_onchain": "先にオンチェーンでステークを解放してから、最終処理を行ってください。",
      "rate_limited": "リクエストが多すぎます。少し待ってからもう一度お試しください。",
      "buy_unavailable": "ワールドの購入は現在利用できません。代わりに $WOC をステークして設立してください。",
      "invalid_currency": "SOL か USDC を選んでからもう一度お試しください。",
      "invalid_tier": "ティアを選んでからもう一度お試しください。",
      "price_unavailable": "ライブ価格は現在利用できません。しばらくしてからもう一度お試しください。",
      "payment_already_recorded": "その支払いはすでに記録されています。",
      "bad_signature": "その支払い署名は無効です。最初からやり直してください。",
      "legs_collide": "支払いを検証できませんでした。最初からやり直してください。",
      "not_finalized": "支払いはまだ最終確定していません。しばらくしてからもう一度確認してください。",
      "memo_mismatch": "その支払いは見積もりと一致しません。最初からやり直してください。",
      "treasury_short": "支払われた金額が見積もりと一致しません。",
      "buyback_short": "支払われた金額が見積もりと一致しません。",
      "bond_required": "このティアを購入するにはリンク済みウォレットに {amount} $WOC が必要です。補充してからもう一度お試しください。",
      "generic": "問題が発生しました。もう一度お試しください。"
    }
  },
  "launchpad": {
    "open": "トークンローンチパッド",
    "title": "ワールドトークン・ローンチパッド",
    "back": "戻る",
    ...
    "register": {
      "title": "ワールドトークンを登録",
      "subtitle": "このワールドが発行する通貨の名前を決めます。登録はアイデンティティのみ：ミント、ロック、流動性はそれぞれの保護機構とともに後のフェーズで導入されます。",
      "symbolLabel": "トークンシンボル",
      "symbolPlaceholder": "例：MOON",
      "policyLabel": "マネタイズポリシー",
      "policyHint": "「コスメティックのみ」を選ぶとこのワールドはペイ・トゥ・ウィンなしを維持します。「ペイ・トゥ・ウィン」は全プレイヤーに明示され、ローンチ前にゲートされます。",
      "submit": "トークンを登録"
    },
    "vote": {
      "title": "このワールドはトークンをローンチすべきですか？",
      "subtitle": "検証済みリンクウォレットごとに1票、投票時に保有する $WOC で加重されます。投票は勧告的かつ無料：トランザクションは送信されません。",
      "openBtn": "コミュニティ投票を開始",
      "yes": "賛成に投票",
      "no": "反対に投票",
      "tallyYes": "賛成：{amount} $WOC",
      "tallyNo": "反対：{amount} $WOC",
      "tallyAria": "投票済みウェイトに占める賛成の割合",
      "quorum": "クォーラム：{current} / {required} $WOC",
      "quorumAria": "クォーラムの進捗",
      "threshold": "クォーラム達成かつ賛成 {pct}% で可決",
      "yourVote": "あなたの投票は {amount} $WOC のウェイトで記録されています。",
      "outcomePending": "まだクォーラムに達していません。",
      "outcomePassed": "投票は可決されました。プレセールが解放されました。",
      "outcomeFailed": "賛成がしきい値を下回っています。"
    },
    "presale": {
      "title": "プレセール",
      "subtitle": "SOL、USDC、または $WOC でローンチに貢献します。資金は創設者のエスクローウォレットに直接送られ、このサーバーはトランザクションを検証するだけで資金を保持しません。",
      "stripeDeferred": "このフェーズではカード決済は利用できません。",
      "progress": "ソフトキャップの {pct}%",
      "progressAria": "ソフトキャップに向けたプレセール進捗",
      "railRaised": "{currency} 調達額 {raised} / {cap}",
      "railWalletRemaining": "あなたの残り上限：{amount} {currency}",
      "railFull": "この通貨は上限に達しました。",
      "amountLabel": "金額（{currency}）",
      "amountPlaceholder": "0.0",
      "contribute": "貢献する",
      "contributeConnect": "ウォレットを接続して貢献",
      "escrowNote": "エスクローウォレット：{address}",
      "refundTerms": "プレセールがソフトキャップに届かない場合、創設者はエスクローウォレットから返金し、各返金はオンチェーンで検証されてから計上されます。",
      "softCapMet": "ソフトキャップ達成。",
      "finalize": "プレセールを確定",
      "finalizeHint": "プレセールを終了します：ソフトキャップ達成なら達成扱い、未達なら返金が始まります。",
      "notConfigured": "創設者はまだ貢献受付を開始していません。",
      "refundTitle": "返金",
      "refundNote": "このプレセールはソフトキャップに届きませんでした。返金はエスクローウォレットから支払われ、オンチェーンで検証されます。",
      "refundRemaining": "返金検証待ちの貢献：{count}",
      "refundDone": "すべての貢献に検証済みの返金があります。",
      "config": {
        "title": "貢献受付を開始",
        "subtitle": "自分が管理するエスクローウォレットと通貨ごとの上限を設定します。空欄の通貨は無効になります。金額は通貨単位です。",
        "escrowLabel": "エスクローウォレットのアドレス",
        "softLabel": "ソフトキャップ（{currency}）",
        "raiseLabel": "調達上限（{currency}）",
        "walletLabel": "ウォレットごとの上限（{currency}）",
        "submit": "プレセールを開始"
      }
    },
    "launch": {
      "title": "トークンローンチ",
      "subtitle": "ミントを作成し、固定供給量を配分し、非公開の割り当てをすべてオンチェーンでロックします。すべてのロックが検証されるまで、トークンは公開できません。",
      "stepsAria": "ローンチ手順",
      "step": {
        "mint": "ミント作成",
        "locks": "配分とロック",
      ...
      "supply": "固定供給量: {amount} {symbol}",
      "allocLine": "パブリックカーブ {publicPct}%、流動性 {liquidityPct}%(卒業時に永久ロック)",
      "bucketLine": "{bucket}: {pct}%、{amount} {symbol}、クリフ {cliff} か月 + 線形 {linear} か月",
      "bucket": {
        "founder": "ファウンダー",
        "levy": "Levy Street ファンド",
        "treasury": "レルム財務"
      },
      "lockProof": "{bucket}のロック:",
      "mintCreated": "ミント:",
      "verifiedNote": "すべてのロックがオンチェーンで検証されました。カーブが開けばトークンは公開できます。",
      "createTitle": "ミントを作成",
      "createHint": "あなたのウォレットが手数料を支払い、ミント権限として署名します。サーバーは資金を動かせる鍵を一切保持しません。トランザクションの構築、ミントアドレスの固定、オンチェーンでの検証だけを行います。",
      "treasuryLabel": "レルム財務ウォレット",
      "treasuryHint": "ベスティングされるレルム財務分を受け取ります。レルムが管理するウォレットを使ってください。",
      "nameLabel": "トークン名(任意)",
      "uriLabel": "メタデータURL(任意)",
      "createBtn": "ミントを作成",
      "locksTitle": "ロックを検証",
      "locksHint": "全供給量をミントし、上記の条件どおりに取り消し不能な Jupiter Lock エスクローを 3 つ作成し、ミント権限を放棄してから、各エスクローのアドレスをここに貼り付けてください。すべてがチェーンと照合されます。",
      "lockLabel": "{bucket}のロックエスクローアドレス",
      "verifyBtn": "オンチェーンで検証",
      "checksAria": "オンチェーン検証チェックリスト",
      "checkPass": "合格",
      "checkFail": "不合格",
      "check": {
        "mint_found": "ミントアカウントを読み取れる",
        "mint_profile": "クリーンなトークン設定(凍結なし、フックなし、手数料なし)",
        "supply_exact": "固定供給量が正確にミント済み",
        "mint_authority_renounced": "ミント権限を放棄済み",
        "lock_found": "ロックエスクローを確認",
        "lock_mint": "ロックがこのトークンを保持",
        "lock_recipient": "ロックの受取人が一致",
        "lock_immutable": "ロックは不変(取り消し不可、受取人変更不可)",
        "lock_token_program": "ロックが正しいトークンプログラムを使用",
        "lock_untouched": "ロックは未請求かつ未取り消し",
        "lock_amount": "ロック額が正確",
        "lock_schedule": "ベスティング計画が約束を満たす",
        "lock_funded": "ロックエスクローがトークンを保持",
        "unknown": "追加チェック"
      }
    },
    "flow": {
      ...
      "openingVote": "投票を開始中...",
      "castingVote": "投票を記録中...",
      "configuring": "貢献受付を準備中...",
      "quoting": "貢献枠を確保中...",
      "paying": "ウォレットで送金を承認してください...",
      "confirming": "貢献をオンチェーンで検証中...",
      "contributed": "貢献が記録されました。",
      "finalizing": "プレセールを確定中...",
      "preparingMint": "ミントトランザクションを準備しています...",
      "signingMint": "ウォレットでミント作成を承認してください...",
      "confirmingMint": "オンチェーンでミントを検証しています...",
    ...
    "err": {
      ...
      "realm_not_found": "そのワールドはもう存在しません。",
      "realm_not_active": "そのワールドはアクティブではありません。",
      "invalid_token_symbol": "大文字と数字からなる 2 から 10 文字のティッカーを選んでください。",
      "invalid_token_icon": "そのトークンアイコンは無効です。",
      "invalid_token_policy": "マネタイズポリシーを選択してください。",
      "token_already_registered": "このワールドには登録済みのトークンがあります。",
      "token_not_registered": "このワールドには登録されたトークンがありません。",
      "vote_not_open": "コミュニティ投票は開いていません。",
      "vote_not_openable": "この状態からは投票を開始できません。",
      "invalid_vote_choice": "賛成か反対を選んでください。",
      "wallet_not_linked": "まずアカウントでウォレットを検証してください。",
      "vote_weight_unavailable": "$WOC 残高を読み取れませんでした。しばらくしてからもう一度お試しください。",
      "no_vote_weight": "検証済みウォレットに投票に使える 1 $WOC 以上がありません。",
      "already_voted": "このウォレットまたはアカウントの投票は記録済みです。",
      "presale_not_open": "プレセールは開いていません。",
      "presale_not_configured": "創設者はまだ貢献受付を開始していません。",
      "presale_already_configured": "貢献受付はすでに開始されています。",
      "presale_not_refunding": "このプレセールは返金中ではありません。",
      "presale_unavailable": "プレセールは一時的に利用できません。しばらくしてからもう一度お試しください。",
      "invalid_escrow_wallet": "そのエスクローウォレットのアドレスは無効です。",
      "invalid_presale_caps": "その上限は無効です。有効な通貨ごとにソフトキャップ、それ以上の調達上限、ウォレットごとの上限が必要です。",
      "invalid_currency": "SOL、USDC、または $WOC を選んでください。",
      "currency_not_enabled": "このプレセールはその通貨を受け付けていません。",
      "invalid_amount": "有効な金額を入力してください。",
      "wallet_cap_exceeded": "ウォレットごとの上限を超えてしまいます。",
      "raise_cap_exceeded": "総調達上限を超えてしまいます。",
      "quote_not_found": "見積もりが見つかりませんでした。最初からやり直してください。",
      "not_your_quote": "その見積もりは別のアカウントのものです。",
      "quote_expired": "見積もりの期限が切れました。最初からやり直してください。",
      "contribution_already_recorded": "そのトランザクションは記録済みです。",
      "contribution_not_found": "その貢献が見つかりません。",
      "already_refunded": "その貢献はすでに返金済みです。",
      "refund_sig_reused": "その返金トランザクションは別の貢献に使われています。",
      "wrong_refunder": "返金はエスクローウォレットから支払われる必要があります。",
      "refund_short": "返金額が貢献をカバーしていません。",
      "bad_signature": "そのトランザクション署名は無効です。最初からやり直してください。",
      "not_finalized": "トランザクションはまだファイナライズされていません。少し待ってからもう一度お試しください。",
      "tx_failed": "トランザクションはチェーン上で失敗しました。",
      "token_2022": "そのトークンプログラムはここではサポートされていません。",
      "memo_mismatch": "そのトランザクションは見積もりと一致しません。最初からやり直してください。",
      "wrong_payer": "トランザクションはリンク済みウォレットで署名する必要があります。",
      "escrow_short": "支払われた金額が見積もりと一致しません。",
      "missing_quoteId_or_paySig": "確認情報が不完全でした。最初からやり直してください。",
      "missing_payTxSig_or_refundSig": "返金の送信情報が不完全でした。",
      "mint_already_created": "ミントは作成済みです。",
      "presale_not_funded": "プレセールはまだ調達を完了していません。",
      "levy_fund_unconfigured": "プラットフォームのファンドウォレットが未設定です。後でもう一度お試しください。",
      "invalid_treasury_wallet": "その財務ウォレットアドレスは無効です。",
      "invalid_token_name": "トークン名は 1 から 32 文字の標準文字です。",
      "invalid_token_uri": "メタデータURLは https アドレスである必要があります。",
      "chain_unavailable": "チェーンに接続できませんでした。しばらくしてからお試しください。",
      "launch_not_prepared": "先にミントトランザクションを準備してください。",
      "mint_not_in_tx": "そのトランザクションは固定されたミントを作成していません。",
      "mint_not_found": "ミントアカウントをオンチェーンで読み取れませんでした。",
      "wrong_token_program": "ミントが想定のトークンプログラム下にありません。",
      "wrong_decimals": "ミントの小数桁数が想定と異なります。",
      "freeze_authority_set": "ミントに凍結権限が設定されています。凍結権限は不可です。",
      "bad_metadata_pointer": "ミントのメタデータポインタが誤っているか、まだ変更可能です。",
      "metadata_symbol_mismatch": "オンチェーンのシンボルが登録トークンと一致しません。",
      "unexpected_extension": "ミントに許可されていない拡張が付いています。",
      "launch_sig_replayed": "そのローンチトランザクションは使用済みです。",
      "mint_not_created": "先にミントを作成して確認してください。",
      "invalid_lock_address": "相異なる有効なロックエスクローアドレスを 3 つ入力してください。",
      "launch_not_verifiable": "ローンチはまだ検証できる状態ではありません。",
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      ...
      "noneHint": "アリーナ手数料と買い戻しがプールに資金を入れ始めると、シーズンが開始されます。",
      "statusActive": "開催中",
      "statusEnded": "終了",
      "endsIn": "Ends in",
      ...
      "wocUnit": "$WOC",
      "emittedLabel": "プールの {pct}% を支払い済み",
      "sinkLabel": "供給済み",
      "emissionLabel": "Paid out",
      "invariant": "支払いがシーズンの収入を超えることはありません。買いが売りを上回ることがオンチェーンで保証されます。",
      "standingsTitle": "上位獲得者の予測",
      "colRank": "#",
      "colPlayer": "プレイヤー",
      "colRating": "レーティング",
      "colReward": "報酬（$WOC）",
      "projectedNote": "現在のプールとアリーナ順位からの予測です。最終支払いはシーズン終了時に確定します。"
    },
    "account": {
      "title": "アカウント",
