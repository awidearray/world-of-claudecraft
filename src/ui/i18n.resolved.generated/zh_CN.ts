...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "周边商店",
      "subtitle": "官方《World of ClaudeCraft》周边商品，全球配送。",
      "loading": "正在加载商店…",
      "unavailable": "周边商店暂时不可用。您的订单和付款不会受到影响，请稍后再试。",
      "disclosure": "周边商品由我们的印刷合作伙伴按需制作并发货。用于购买周边的 Claudium 不可退还为 Claudium；银行卡和 Solana 付款遵循服务条款中的退款政策。",
      "catalogTitle": "商品目录",
      "catalogEmpty": "目前没有可用的周边商品。",
      "variantLabel": "款式与尺码",
      "addToCart": "加入购物车",
      "outOfStock": "缺货",
      "cartTitle": "购物车",
      ...
      "totalLabel": "总计",
      "totalNote": "运费和税费将在结账时添加；最终金额以服务器确认为准。",
      "claudiumPrice": "{amount} Claudium",
      "checkoutTitle": "结账",
      "loginRequired": "请登录帐户后再结账。",
      "shipping": {
        "name": "姓名",
        "address1": "地址",
        "address2": "地址第二行（可选）",
      ...
      "shippingIncomplete": "请填写所有必填的收货信息。",
      "railLabel": "付款方式",
      "railStripe": "银行卡",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "提交订单",
      "checkoutPending": "订单正在处理。请完成付款，并保持此页面打开。",
      "checkoutFailed": "无法开始结账，请重试。",
      "checkoutUnavailable": "该订单暂时不可用。",
      "checkoutNotSettled": "交易已发送，但订单尚未确认。请稍后查看您的订单。",
      "orderPlaced": "订单 {orderId} 已提交。可在下方的订单中跟踪。",
      "ordersTitle": "我的订单",
      "trackOrder": "跟踪",
      "status": {
        "pendingPayment": "等待付款",
