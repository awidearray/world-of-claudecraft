...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "railSol": "SOL",
      "railUsdc": "USDC",
      "railDisabled": "此支付方式当前不可用。",
      "oracleUnavailable": "实时价格当前不可用。请稍后再试。",
      "quoteButton": "获取报价",
      "amountRow": "{usd} 兑换 {claudium} 克劳迪姆",
      "sendExactly": "精确发送 {amount} {rail}",
      "addressLabel": "发送至",
      "memoLabel": "备注 (必填)",
      "splitLabel": "拆分",
      "splitBurn": "销毁 {amount} {rail}",
      "splitTreasury": "{amount} {rail} 进入金库",
      "splitSummary": "销毁 {burn} {rail}，{treasury} {rail} 转入金库",
      "reviewLabel": "确认",
      "reviewLine": "您支付 {pay} {rail}，获得 {claudium} 克劳迪姆（{usd}）。",
      ...
      "signatureLabel": "交易签名",
      "signaturePlaceholder": "粘贴签名",
      "confirmButton": "确认支付",
      "confirmCredited": "已入账 {amount} 克劳迪姆。",
      "confirmFailed": "暂时无法确认此笔支付。请稍后再试。",
      "confirmPending": "正在等待链上确认，这可能需要一点时间。",
      "confirmNotFinalized": "您的付款尚未在链上确认。这是正常现象，请稍等片刻后再次确认。",
      "confirmRequote": "价格已变动。请重新获取报价后再试。",
      "retryButton": "重试",
      "requoteButton": "重新获取报价",
      "insufficientBalance": "克劳迪姆不足",
      "topUpButton": "Top up",
      "redeemTitle": "兑换礼品卡",
      "enterCode": "输入你的礼品卡代码",
      "codePlaceholder": "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX",
      "redeemButton": "兑换",
      "redeemed": "已兑换 {amount} 克劳迪姆。新余额：{balance}。",
      "redeemFailed": "无法兑换此代码。请检查代码后重试。",
      "back": "返回"
    },
    "theme": {
      "preset": "界面主题",
