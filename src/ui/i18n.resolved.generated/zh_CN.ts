...
export const zh_CN: EnTranslations = {
  ...
  "newspaper": {
    "title": "The Claudemoon Gazette",
    "edition": "Realm Edition",
    "priceTag": "Price: One Copper",
    "leadHead": "Adventurers Flock to the Realm",
    "loreHead": "Word from the Realm",
    "classifiedsHead": "Classifieds",
    "continue": "Continue to the World",
    "preparing": "Setting the press — preparing the realm…",
    "preloadProgress": "Setting the press… {done}/{total}",
    "ready": "The realm awaits — press Continue.",
    "buyAd": "Advertise in the Gazette →",
    "houseAdTitle": "Your Banner Here",
    "houseAdBody": "Reach every adventurer at the gates. Buy a spot in the Gazette.",
    "classifiedsEmpty": "No notices posted today. Be the first — buy a classified.",
    "sponsoredBy": "Sponsored by {advertiser}",
    "lore1": "Caravans report safe passage along the Eastbrook road after the militia cleared the old toll bridge of bandits.",
    "lore2": "The Mage's Guild seeks apprentices; inquire within the tower. Pay is modest, the reading list is not.",
    "lore3": "Rumors of a rare beast stirring in the deep crypts have doubled the bounty on its hide.",
    "lore4": "Tavern keepers across the realm raise a toast to the founders. May your blades stay sharp and your bags stay full."
  },
  "ticker": {
    "label": "Town Crier"
  },
  "adbuy": {
    "title": "Place an Ad — The Claudemoon Gazette",
    "subtitle": "Reach every adventurer at the gates. In-game goods or real-world apps, stores, and offers — pay in USDC, SOL, or $WOC.",
    "close": "Close",
    "connectWallet": "Connect wallet to begin",
    "connecting": "Connecting…",
    "signedInAs": "Signed in: {pubkey}",
    "signOut": "Sign out",
    "placementLabel": "Placement",
    "assetLabel": "Pay with",
    "dayLabel": "Day (UTC)",
    "startLabel": "Start time (UTC)",
    "minutesLabel": "Minutes",
    "pricePerMin": "{price} {asset} / min",
    "totalLabel": "Total",
    "creativeHeading": "Your ad",
    "creativeImage": "Ad image (PNG)",
    "creativeText": "Ad text",
    "clickUrl": "Link (https://…) — optional, for real-world offers",
    "cta": "Call to action (e.g. “Get the app”) — optional",
    "realWorldHint": "Advertising a real-world app, shop, or discount? Add a link and a call-to-action so players can act on it.",
    "reservePay": "Reserve & pay",
    "working": "Working…",
    "success": "Submitted for review — it goes live once an admin approves it.",
    "myBookings": "Your bookings",
    "noBookings": "No bookings yet.",
    "leadHint": "Bookings must start at least {minutes} minutes ahead.",
    "needWallet": "Connect your wallet first.",
    "needCreative": "Add your ad creative first.",
    "errPrefix": "Could not place the ad: {error}",
    "slotBusy": "That window is taken — pick another time."
  },
  "seo": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "charter_ashmane": {
        "name": "证书：Ashmane Courser"
      },
      "charter_emberhoof": {
        "name": "证书：Emberhoof Charger"
      },
      "charter_bronzeflank": {
        "name": "证书：Bronzeflank Destrier"
      },
      "charter_silvermane": {
        "name": "证书：Silvermane Stallion"
      },
      "charter_stormhoof": {
        "name": "证书：Stormhoof Charger"
      },
      "charter_goldcrest": {
        "name": "证书：Goldcrest Skystrider"
      },
      "charter_verdant": {
        "name": "证书：Verdant Wildwing"
      },
      "charter_voidstrider": {
        "name": "证书：Voidwing Strider"
      },
      "charter_celestial": {
        "name": "证书：Celestial Seraph"
      },
      "charter_worldbearer": {
        "name": "证书：Worldbearer's Roc"
      },
      "bristleback_maul": {
        "name": "硬鬃重槌"
      },
