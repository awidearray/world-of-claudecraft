...
export const zh_CN: EnTranslations = {
  ...
  "realmOp": {
    ...
    "found": {
      "title": "创立服务器",
      "subtitle": "将 $WOC 质押到非托管的链上托管账户，以开设并运营你自己的服务器。",
      "nameLabel": "服务器名称",
      "namePlaceholder": "为你的服务器命名",
      "typeLabel": "服务器类型",
      "tierLabel": "质押等级",
      "tierHint": "更大的质押解锁更高等级：更多玩家、更多自定义预算，以及运营者收益通道。",
      "supplyNote": "每个等级的价格按 $WOC 实时供应量的一定比例计算。",
      "badgeNote": "你质押的 $WOC 仍计入你的持有者徽章，因此创立服务器绝不会降低你的等级。",
      "affiliateNote": "由联盟推荐。他们将获得该服务器收入 15% 的佣金。",
      "tiersUnavailable": "实时等级价格暂时不可用。请稍后再试。",
      "submit": "质押并创立",
      "submitConnect": "连接钱包以创立",
      "stakingNote": "你签署一笔交易，将 {amount} $WOC 锁入托管。停用后经过 {days} 天时间锁即可随时取回。",
      "nameTaken": "请换一个名称；该名称已被占用。",
      "methodLabel": "支付方式",
      "methodStake": "质押 $WOC",
      "methodStakeHint": "将 $WOC 锁入托管。停用时全额返还。",
      "methodBuy": "用 SOL 或 USDC 购买",
      "methodBuyHint": "用 SOL 或 USDC 一次性支付。购买为最终交易，没有可取回的质押。"
    },
    "tier": {
      "bronze": "青铜",
      "silver": "白银",
    ...
    "buy": {
      ...
      "currencySol": "SOL",
      "currencyUsdc": "USDC",
      "currencyUnavailable": "{currency} 暂时不可用（没有兑换路径）。",
      "splitNote": "你支付的 {treasuryPct}% 注入金库，其余用于回购并销毁 $WOC。",
      "finalNote": "购买为最终交易，不可退款。与质押不同，停用服务器时不会返还。",
      "unavailable": "目前无法购买服务器。请改为质押 $WOC 来创立。",
      "submit": "购买并创立",
      "submitConnect": "连接钱包以购买",
      "note": "你签署一笔交易，支付 {amount} {currency} 来创立此服务器。服务器立即激活。",
      "bondNote": "还需持有 {amount} $WOC，在服务器存续期间保留在你绑定的钱包中，否则服务器将失效。",
      "bondWhy": "这笔持续保证金独立于你支付的 {currency}：它确保你在运营服务器期间保持利益绑定。"
    },
    "mine": {
      "title": "我的服务器",
      "loading": "正在加载你的服务器...",
      "empty": "你还没有运营任何服务器。在上方创立一个即可开始。",
      "tier": "{tier} 等级",
      "decommission": "停用",
      "release": "完成关闭",
      "enter": "进入",
      "eligible": "质押可于 {date} 释放",
      "releaseHint": "先在链上释放你的质押，然后完成关闭以关停服务器并释放其名称。",
      "decommissionConfirm": "停用 {name}？这将使服务器下线，并启动 {days} 天的质押释放时间锁。",
      "bondInfo": "保证金：在绑定钱包中持有 {amount} $WOC。",
      "bondWarning": "保证金低于要求。请持有 {amount} $WOC，并在 {date} 之前补足，否则此服务器将失效。"
    },
    "status": {
      "active": "激活",
      "provisioning": "开通中",
    ...
    "affiliate": {
      "open": "推荐计划",
      "title": "推荐与联盟计划",
      "subtitle": "分享一个链接。通过它加入的玩家获得经验和金币加成，你从他们的收益中赚取分成，他们创立的任何服务器还会给你 15%。",
      "yourLink": "你的推荐链接",
      "copy": "复制链接",
      "copied": "已复制",
      "loading": "正在加载你的推荐统计...",
      "bonusTitle": "你的链接如何赚钱",
      "bonusReferee": "通过你的链接加入的玩家在前 30 天获得 +10% 经验和金币。",
      "bonusReferrer": "在此期间，你可获得他们收益的 +5%，直接计入你的角色。",
      "bonusRealm": "另外，他们创立的任何服务器都会给你 15% 的 USDC 佣金。",
      "rewardsTitle": "你的推荐奖励",
      "rewardsPending": "{xp} 经验和 {gold} 待发放，将在你下次登录时到账",
      "rewardsLifetime": "累计已获得 {xp} 经验和 {gold}",
      "rewardsReferred": "已推荐玩家：{count}",
      "rewardsEmpty": "推荐玩家即可开始赚取。奖励将在你下次登录时发放到角色。",
      "referredTitle": "你推荐的服务器",
      "referredCount": "{count} 个活跃的被推荐服务器",
      "referredCountPlural": "{count} 个活跃的被推荐服务器",
      "empty": "还没有被推荐的服务器。分享你的链接开始赚取收益。",
      "commission": "{pct}% 佣金",
      "earningsSoon": "当服务器内收入上线后，USDC 佣金即开始发放。",
      "unavailable": "推荐统计暂时不可用。请稍后再试。"
    },
    "flow": {
      "connecting": "正在连接你的钱包...",
      "quoting": "正在为你预留服务器...",
      "locking": "请在钱包中批准质押...",
      "confirming": "正在链上验证你的质押...",
      "paying": "请在钱包中批准支付...",
      "confirmingBuy": "正在链上验证你的支付...",
      "decommissioning": "正在开始停用...",
      "releasing": "正在完成关闭...",
      "released": "服务器已关闭。该名称重新可用。",
      "closed": "服务器已关闭。该名称重新可用。",
      "founded": "{name} 已上线。欢迎，运营者。"
    },
    "err": {
      "invalid_realm_name": "该服务器名称不被允许。请使用字母、数字、空格或连字符。",
      "realm_name_not_allowed": "该服务器名称不被允许。",
      "realm_name_taken": "该服务器名称已被占用。",
      "realm_cap_reached": "你已达到每个账户的服务器数量上限。",
      "stake_below_minimum": "该质押低于最低等级。请选择更高的等级。",
      "supply_unavailable": "$WOC 供应量数据暂时不可用。请稍后再试。",
      "invalid_amount": "质押数量无效。请选择一个等级后重试。",
      "link_wallet": "请先将钱包绑定到你的账户。",
      "wallet_mismatch": "请连接你绑定到账户的钱包。",
      "quote_expired": "你的报价已过期。请重新开始。",
      "quote_not_found": "未找到你的报价。请重新开始。",
      "not_your_quote": "该报价属于其他账户。",
      "stake_already_recorded": "该质押已被记录。",
      "tx_not_finalized": "你的质押尚未最终确认。请稍后再确认一次。",
      "tx_failed": "质押交易在链上失败。",
      "token_2022": "此 $WOC 铸币不支持用于质押。",
      "wrong_vault_amount": "锁定的数量与你的报价不符。",
      "wrong_payer": "质押必须由你绑定的钱包签署。",
      "stake_service_unavailable": "质押服务暂时不可用。请稍后再确认一次。",
      "not_realm_owner": "你不是该服务器的运营者。",
      "realm_not_found": "该服务器已不存在。",
      "realm_not_active": "该服务器未处于激活状态。",
      "realm_not_decommissioning": "该服务器未处于停用流程中。",
      "timelock_not_elapsed": "质押的时间锁尚未到期。",
      "stake_not_released_onchain": "请先在链上释放你的质押，然后再完成关闭。",
      "rate_limited": "请求过于频繁。请放慢速度后重试。",
      "buy_unavailable": "目前无法购买服务器。请改为质押 $WOC 来创立。",
      "invalid_currency": "请选择 SOL 或 USDC 后重试。",
      "invalid_tier": "请选择一个等级后重试。",
      "price_unavailable": "实时价格暂时不可用。请稍后再试。",
      "payment_already_recorded": "该支付已被记录。",
      "bad_signature": "该支付签名无效。请重新开始。",
      "legs_collide": "无法验证该支付。请重新开始。",
      "not_finalized": "你的支付尚未最终确认。请稍后再确认一次。",
      "memo_mismatch": "该支付与你的报价不符。请重新开始。",
      "treasury_short": "支付金额与你的报价不符。",
      "buyback_short": "支付金额与你的报价不符。",
      "bond_required": "购买此等级需要在绑定钱包中持有 {amount} $WOC。请充值后重试。",
      "generic": "出了点问题。请重试。"
    }
  },
  "launchpad": {
    ...
    "register": {
      "title": "注册服务器代币",
      "subtitle": "为这个服务器将要发射的货币命名。注册仅确定身份：铸造、锁仓和流动性将在后续阶段带着各自的保障机制推出。",
      "symbolLabel": "代币代码",
      "symbolPlaceholder": "例如 MOON",
      "policyLabel": "变现政策",
      "policyHint": "选择“仅限外观”可保持该服务器无付费变强。“付费变强”会向所有玩家明示标注，并在上线前受到审核限制。",
      "submit": "注册代币"
    },
    "vote": {
      "title": "这个服务器应该发射它的代币吗？",
      "subtitle": "每个已验证的关联钱包一票，按投票时钱包持有的 $WOC 加权。投票仅供参考且免费：不会发送任何交易。",
      "openBtn": "开启社区投票",
      "yes": "投赞成票",
      "no": "投反对票",
      "tallyYes": "赞成：{amount} $WOC",
      "tallyNo": "反对：{amount} $WOC",
      "tallyAria": "赞成票权重占比",
      "quorum": "法定人数：{current} / {required} $WOC",
      "quorumAria": "法定人数进度",
      "threshold": "达到法定人数且赞成率达 {pct}% 时通过",
      "yourVote": "您的投票已记录，权重 {amount} $WOC。",
      "outcomePending": "尚未达到法定人数。",
      "outcomePassed": "投票已通过。预售已解锁。",
      "outcomeFailed": "赞成票低于门槛。"
    },
    "presale": {
      "title": "预售",
      "subtitle": "用 SOL、USDC 或 $WOC 为发射出资。资金直接进入创始人托管钱包；本服务器只验证您的交易，绝不保管资金。",
      "stripeDeferred": "本阶段暂不支持银行卡支付。",
      "progress": "软顶进度 {pct}%",
      "progressAria": "预售软顶进度",
      "railRaised": "已筹 {raised} / {cap} {currency}",
      "railWalletRemaining": "您的剩余额度：{amount} {currency}",
      "railFull": "该币种已达上限。",
      "amountLabel": "金额（{currency}）",
      "amountPlaceholder": "0.0",
      "contribute": "出资",
      "contributeConnect": "连接钱包以出资",
      "escrowNote": "托管钱包：{address}",
      "refundTerms": "如果预售未达软顶，创始人将从托管钱包退款，每笔退款都会先经链上验证才计入。",
      "softCapMet": "已达到软顶。",
      "finalize": "结束预售",
      "finalizeHint": "结束预售：达到软顶则判定为已达标，否则开启退款。",
      "notConfigured": "创始人尚未开放出资。",
      "refundTitle": "退款",
      "refundNote": "本次预售未达软顶。退款由托管钱包支付并经链上验证。",
      "refundRemaining": "等待退款验证的出资：{count}",
      "refundDone": "所有出资都已完成经验证的退款。",
      "config": {
        "title": "开放出资",
        "subtitle": "设置您掌控的托管钱包和各币种上限。留空即停用该币种。金额为整单位。",
        "escrowLabel": "托管钱包地址",
        "softLabel": "软顶（{currency}）",
        "raiseLabel": "筹集上限（{currency}）",
        "walletLabel": "单钱包上限（{currency}）",
        "submit": "开启预售"
      }
    },
    "launch": {
      "title": "代币发射",
      "subtitle": "创建铸币、分配固定供应量,并将所有非公开份额锁定在链上。所有锁仓通过验证之前,代币无法上线。",
      "stepsAria": "发射流程步骤",
      "step": {
        "mint": "创建铸币",
        "locks": "分配并锁仓",
      ...
      "supply": "固定供应量:{amount} {symbol}",
      "allocLine": "公开曲线 {publicPct}%,流动性 {liquidityPct}%(毕业时永久锁定)",
      "bucketLine": "{bucket}:{pct}%,{amount} {symbol},{cliff} 个月悬崖期 + {linear} 个月线性解锁",
      "bucket": {
        "founder": "创始人",
        "levy": "Levy Street 基金",
        "treasury": "服务器金库"
      ...
      "lockProof": "{bucket}锁仓:",
      "mintCreated": "铸币:",
      "verifiedNote": "所有锁仓均已在链上验证。曲线开放后代币即可上线。",
      "createTitle": "创建铸币",
      "createHint": "您的钱包支付租金并作为铸币权限签名。服务器从不持有能转移资金的密钥:它只构建交易、锁定铸币地址,并在链上验证结果。",
      "treasuryLabel": "服务器金库钱包",
      "treasuryHint": "接收归属解锁的服务器金库份额。请使用您的服务器掌控的钱包。",
      "nameLabel": "代币名称(可选)",
      "uriLabel": "元数据网址(可选)",
      "createBtn": "创建铸币",
      "locksTitle": "验证锁仓",
      "locksHint": "铸出全部供应量,按上述确切条款创建三个不可撤销的 Jupiter Lock 托管,放弃铸币权限,然后在此粘贴每个托管地址。所有内容都会对照链上核验。",
      "lockLabel": "{bucket}锁仓托管地址",
      "verifyBtn": "链上验证",
      "checksAria": "链上验证清单",
      "checkPass": "通过",
      "checkFail": "未通过",
      "check": {
        "mint_found": "铸币账户可读取",
        "mint_profile": "干净的代币配置(无冻结、无挂钩、无费用)",
        "supply_exact": "固定供应量足额铸出",
        "mint_authority_renounced": "铸币权限已放弃",
        "lock_found": "找到锁仓托管",
        "lock_mint": "锁仓持有本代币",
        "lock_recipient": "锁仓接收人相符",
        "lock_immutable": "锁仓不可变(不可取消、不可更换接收人)",
        "lock_token_program": "锁仓使用正确的代币程序",
        "lock_untouched": "锁仓未领取且从未取消",
        "lock_amount": "锁定数量精确",
        "lock_schedule": "解锁计划满足承诺",
        "lock_funded": "锁仓托管持有代币",
        "unknown": "附加检查"
      }
    },
    "curve": {
    ...
    "fund": {
      ...
      "subtitle": "平台持有在此发射的每个服务器代币的锁定份额,实时展示。这是一个透明的金库,不是可以买入的基金:本页面的任何内容都不可买卖或赎回。",
      "loading": "正在加载投资组合...",
      "notPublished": "投资组合尚未发布。",
      "empty": "基金尚未持有任何服务器代币。",
      "aum": "总价值:{amount} USD",
      "updated": "更新于 {time}",
      "clampedNote": "单次刷新出现的大幅变动正在等待确认刷新。",
      "policyNote": "每笔持仓都按股权表上最严格的时间表归属(12 个月悬崖期 + 48 个月线性),处置需经治理审批。平台无法抛售这些持仓。",
      "tableAria": "基金持仓",
      "colToken": "代币",
      "colAmount": "数量",
      "colPrice": "价格(USD)",
      ...
      "badgeLocked": "已锁定",
      "badgeGraduated": "已毕业",
      "statusIlliquid": "流动性不足(不计入总额)",
      "confidence": {
        "high": "已定价(交叉核验)",
        "medium": "已定价",
        "low": "已定价(置信度低)"
      },
      "illiquidNote": "没有可信价格的持仓:{count}。仅展示,从不计入。"
    },
    "flow": {
      "registering": "正在注册代币...",
      "openingVote": "正在开启投票...",
      "castingVote": "正在记录您的投票...",
      "configuring": "正在开放出资...",
      "quoting": "正在预留您的出资...",
      "paying": "请在钱包中批准转账...",
      "confirming": "正在链上验证您的出资...",
      "contributed": "出资已记录。",
      "finalizing": "正在结束预售...",
      "preparingMint": "正在准备铸币交易...",
      "signingMint": "请在钱包中批准铸币创建...",
      "confirmingMint": "正在链上验证铸币...",
      "mintDone": "铸币已创建并通过验证。",
      "verifying": "正在链上验证锁仓...",
    ...
    "err": {
      ...
      "realm_not_found": "该服务器已不存在。",
      "realm_not_active": "该服务器未处于活跃状态。",
      "invalid_token_symbol": "请选择 2 到 10 个字符的大写字母和数字代码。",
      "invalid_token_icon": "该代币图标无效。",
      "invalid_token_policy": "请选择变现政策。",
      "token_already_registered": "该服务器已注册代币。",
      "token_not_registered": "该服务器没有注册代币。",
      "vote_not_open": "社区投票尚未开启。",
      "vote_not_openable": "当前状态无法开启投票。",
      "invalid_vote_choice": "请选择赞成或反对。",
      "wallet_not_linked": "请先在您的账户上验证钱包。",
      "vote_weight_unavailable": "无法读取您的 $WOC 余额。请稍后再试。",
      "no_vote_weight": "您的已验证钱包没有可用于投票的整数 $WOC。",
      "already_voted": "该钱包或账户已经投过票。",
      "presale_not_open": "预售未开启。",
      "presale_not_configured": "创始人尚未开放出资。",
      "presale_already_configured": "出资已经开放。",
      "presale_not_refunding": "本次预售不在退款阶段。",
      "presale_unavailable": "预售暂时不可用。请稍后再试。",
      "invalid_escrow_wallet": "该托管钱包地址无效。",
      "invalid_presale_caps": "这些上限无效。每个启用的币种需要软顶、不低于软顶的筹集上限和单钱包上限。",
      "invalid_currency": "请选择 SOL、USDC 或 $WOC。",
      "currency_not_enabled": "本次预售不接受该币种。",
      "invalid_amount": "请输入有效金额。",
      "wallet_cap_exceeded": "这将超过您的单钱包上限。",
      "raise_cap_exceeded": "这将超过总筹集上限。",
      "quote_not_found": "找不到您的报价。请重新开始。",
      "not_your_quote": "该报价属于其他账户。",
      "quote_expired": "您的报价已过期。请重新开始。",
      "contribution_already_recorded": "该交易已被记录。",
      "contribution_not_found": "找不到该出资。",
      "already_refunded": "该出资已退款。",
      "refund_sig_reused": "该退款交易已用于另一笔出资。",
      "wrong_refunder": "退款必须由托管钱包支付。",
      "refund_short": "退款金额不足以覆盖该出资。",
      "bad_signature": "该交易签名无效。请重新开始。",
      "not_finalized": "您的交易尚未最终确认。请稍后再试。",
      "tx_failed": "交易在链上失败。",
      "token_2022": "此处不支持该代币程序。",
      "memo_mismatch": "该交易与您的报价不符。请重新开始。",
      "wrong_payer": "交易必须由您的关联钱包签名。",
      "escrow_short": "支付金额与您的报价不符。",
      "missing_quoteId_or_paySig": "确认信息不完整。请重新开始。",
      "missing_payTxSig_or_refundSig": "退款提交信息不完整。",
      "mint_already_created": "铸币已创建。",
      "presale_not_funded": "预售尚未达标完成。",
      "levy_fund_unconfigured": "平台基金钱包尚未配置。请稍后再试。",
      "invalid_treasury_wallet": "该金库钱包地址无效。",
      "invalid_token_name": "代币名称为 1 到 32 个普通字符。",
      "invalid_token_uri": "元数据网址必须是 https 地址。",
      "chain_unavailable": "无法连接链上网络。请稍后再试。",
      "launch_not_prepared": "请先准备铸币交易。",
      "mint_not_in_tx": "该交易没有创建锁定的铸币。",
      "mint_not_found": "无法在链上读取铸币账户。",
      "wrong_token_program": "铸币不在预期的代币程序之下。",
      "wrong_decimals": "铸币的小数位数不符合预期。",
      "freeze_authority_set": "铸币设有冻结权限。必须没有冻结权限。",
      "bad_metadata_pointer": "铸币元数据指针错误或仍可更改。",
      "metadata_symbol_mismatch": "链上代码与已注册代币不符。",
      "unexpected_extension": "铸币带有不被允许的扩展。",
      "launch_sig_replayed": "该发射交易已被使用。",
      "mint_not_created": "请先创建并确认铸币。",
      "invalid_lock_address": "请输入三个互不相同的有效锁仓托管地址。",
      "launch_not_verifiable": "发射尚未准备好进行验证。",
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "$WOC 赛季",
      "title": "$WOC 奖励赛季",
      "subtitle": "由金库出资，向顶尖玩家派发",
      "close": "关闭",
      "none": "当前没有进行中的奖励赛季。",
      "noneHint": "当竞技场抽成和回购开始注入奖池时，赛季即会开启。",
      "statusActive": "进行中",
      "statusEnded": "已结束",
      "endsIn": "Ends in",
      ...
      "poolLabel": "可用奖池",
      "wocUnit": "$WOC",
      "emittedLabel": "奖池已发放 {pct}%",
      "sinkLabel": "已注入",
      "emissionLabel": "Paid out",
      "invariant": "派发绝不会超过赛季收入：买入大于卖出，由链上强制执行。",
      "standingsTitle": "预计最高收益者",
      "colRank": "#",
      "colPlayer": "玩家",
      "colRating": "评分",
      "colReward": "奖励（$WOC）",
      "projectedNote": "根据当前奖池和竞技场排名预估；最终派发在赛季结束时结算。"
    },
    "account": {
      "title": "账户",
