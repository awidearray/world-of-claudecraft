...
export const zh_CN: EnTranslations = {
  ...
  "launchpad": {
    ...
    "levy": {
      "open": "莱维街基金",
      "title": "莱维街基金",
      "subtitle": "一个透明、仅供展示的投资组合，持有本平台发射的每个领域代币的一部分。",
      "displayOnlyNote": "仅供展示：基金与你一同持有这些代币，无法出售。没有基金份额，也没有赎回。",
      "loading": "正在加载投资组合……",
      "empty": "暂无持仓。已发射的领域代币在上线后会显示在此处。",
      "aum": "总价值（AUM）",
      "aumSol": "in SOL",
      "holdings": "{count} 项持仓",
      "excluded": "{count} 项因流动性不足被排除",
      "clamped": "本次刷新的价值变动已被限制，等待确认。",
      "updated": "更新于 {time}",
      "colToken": "代币",
      "colAmount": "数量",
      "colPrice": "价格",
    ...
    "err": {
      ...
      "mint_not_ready": "只有在预售达标后才能铸造代币。",
      "token_already_minted": "该代币已铸造。",
      "token_not_minted": "请先铸造代币。",
      "levy_wallet_unconfigured": "该服务器主机尚未启用代币发射。",
      "launch_unavailable": "发射服务暂时不可用。请稍后再试。",
      "launch_sig_reused": "该交易已被其他发射使用。",
      "mint_mismatch": "链上铸币与本次发射不匹配。请重新开始。",
      "already_distributed": "供应量已分配。",
      "not_distributed": "请先分配供应量。",
      "distribution_mismatch": "分配结果与分配方案不符。",
      "invalid_lock_bucket": "请选择创始人、平台或金库锁仓。",
      "already_locked": "该份额已锁仓。",
      "lock_mismatch": "链上锁仓与本次发射不匹配。请重新开始。",
      "lock_not_immutable": "该锁仓不是不可变的。必须任何人都无法取消。",
      ...
      "not_migrated": "曲线尚未毕业。",
      "power_credit_disabled": "此处未启用使用该代币兑换游戏内力量。",
      "power_sink_unconfigured": "该领域尚未设置代币消费。",
      "not_power_realm": "该领域仅为装饰性：其代币无法购买游戏力量。",
      "token_2022_mismatch": "该转账与此领域代币不匹配。请重新开始。",
      "sink_not_credited": "转账未到达领域钱包。",
      "amount_too_small": "该金额太小，无法兑换任何货币。",
      "credit_already_recorded": "该转账已入账。",
      "no_character_to_credit": "请登录该领域的角色以接收入账。",
      "missing_payTxSig": "入账提交信息不完整。",
