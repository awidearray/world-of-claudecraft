...
export const ru_RU: EnTranslations = {
  ...
  "realmOp": {
    "open": "Основать мир",
    "panelTitle": "Оператор мира",
    "back": "Back",
    "found": {
      "title": "Основать мир",
      "subtitle": "Застейкайте $WOC в некастодиальном эскроу, чтобы открыть и вести собственный мир.",
      "nameLabel": "Имя мира",
      "namePlaceholder": "Назовите свой мир",
      "typeLabel": "Тип мира",
      "tierLabel": "Уровень стейка",
      "tierHint": "Больший стейк открывает уровень выше: больше игроков, больший бюджет кастомизации и каналы выплат оператору.",
      "supplyNote": "Цена каждого уровня — доля от текущего предложения $WOC.",
      "badgeNote": "Застейканные $WOC продолжают учитываться в значке держателя, так что основание мира никогда не понизит ваш уровень.",
      "affiliateNote": "Приглашение от партнёра. Он получает комиссию 15% с дохода этого мира.",
      "tiersUnavailable": "Актуальные цены уровней сейчас недоступны. Повторите попытку позже.",
      "submit": "Застейкать и основать",
      "submitConnect": "Подключите кошелёк, чтобы основать",
      "stakingNote": "Вы подписываете одну транзакцию, блокирующую {amount} $WOC в эскроу. Верните их в любой момент после {days}-дневного таймлока, закрыв мир.",
      "nameTaken": "Выберите другое имя; это уже занято.",
      "methodLabel": "Способ оплаты",
      "methodStake": "Застейкать $WOC",
      "methodStakeHint": "Заблокируйте $WOC в эскроу. Возвращается полностью при закрытии.",
      "methodBuy": "Купить за SOL или USDC",
      "methodBuyHint": "Разовый платёж в SOL или USDC. Покупка окончательна, возвращаемого стейка нет."
    },
    "tier": {
      "bronze": "Бронза",
      "silver": "Серебро",
      "gold": "Gold",
      "cost": "{amount} $WOC",
      "share": "{pct}% предложения",
      "price": "{amount} {currency}",
      "priceUnavailable": "Нет цены"
    },
    "buy": {
      "currencyLabel": "Оплата в",
      "currencySol": "SOL",
      "currencyUsdc": "USDC",
      "currencyUnavailable": "{currency} сейчас недоступна (нет маршрута обмена).",
      "splitNote": "{treasuryPct}% платежа идёт в казну, остальное выкупает и сжигает $WOC.",
      "finalNote": "Покупка окончательна и не возвращается. В отличие от стейка, при закрытии мира она не возвращается.",
      "unavailable": "Покупка мира сейчас недоступна. Вместо этого застейкайте $WOC, чтобы основать его.",
      "submit": "Купить и основать",
      "submitConnect": "Подключите кошелёк для покупки",
      "note": "Вы подписываете одну транзакцию на {amount} {currency}, чтобы основать этот мир. Мир активируется сразу.",
      "bondNote": "Также держите {amount} $WOC в привязанном кошельке всё время жизни мира, иначе мир будет утрачен.",
      "bondWhy": "Этот постоянный залог отделён от оплачиваемой {currency}: он сохраняет вашу заинтересованность, пока вы управляете миром."
    },
    "mine": {
      "title": "Мои миры",
      "loading": "Загрузка ваших миров...",
      "empty": "Вы пока не управляете мирами. Основайте один выше, чтобы начать.",
      "tier": "Уровень {tier}",
      "decommission": "Закрыть",
      "release": "Завершить закрытие",
      "enter": "Войти",
      "eligible": "Стейк можно высвободить {date}",
      "releaseHint": "Высвободите стейк в блокчейне, затем завершите закрытие: мир будет закрыт, а имя освобождено.",
      "decommissionConfirm": "Закрыть {name}? Мир уйдёт в офлайн, и начнётся {days}-дневный таймлок высвобождения стейка.",
      "bondInfo": "Залог: держите {amount} $WOC в привязанном кошельке.",
      "bondWarning": "Залог ниже требуемого. Держите {amount} $WOC и пополните до {date}, иначе этот мир будет утрачен."
    },
    "status": {
      "active": "Активен",
      "provisioning": "Подготовка",
      "decommissioning": "Закрывается"
    },
    "affiliate": {
      "open": "Реферальная программа",
      "title": "Реферальная и партнёрская программа",
      "subtitle": "Поделитесь одной ссылкой. Пришедшие по ней игроки получают бонус к опыту и золоту, вы зарабатываете с их дохода и получаете 15% с любого основанного ими мира.",
      "yourLink": "Ваша реферальная ссылка",
      "copy": "Копировать ссылку",
      "copied": "Скопировано",
      "loading": "Загрузка статистики приглашений...",
      "bonusTitle": "Как платит ваша ссылка",
      "bonusReferee": "Игроки, пришедшие по вашей ссылке, получают +10% опыта и золота в первые 30 дней.",
      "bonusReferrer": "В этот период вы получаете +5% от их заработка прямо на своего персонажа.",
      "bonusRealm": "Плюс комиссия 15% в USDC с любого основанного ими мира.",
      "rewardsTitle": "Ваши награды за приглашения",
      "rewardsPending": "Ожидает выплаты: {xp} опыта и {gold}, будут начислены при следующем входе",
      "rewardsLifetime": "Всего заработано: {xp} опыта и {gold}",
      "rewardsReferred": "Приглашено игроков: {count}",
      "rewardsEmpty": "Приглашайте игроков, чтобы начать зарабатывать. Награды придут персонажу при следующем входе.",
      "referredTitle": "Приглашённые вами миры",
      "referredCount": "Активных приглашённых миров: {count}",
      "referredCountPlural": "Активных приглашённых миров: {count}",
      "empty": "Пока нет приглашённых миров. Поделитесь ссылкой, чтобы начать зарабатывать.",
      "commission": "Комиссия {pct}%",
      "earningsSoon": "Комиссии в USDC начнут выплачиваться, когда заработает внутренняя экономика мира.",
      "unavailable": "Статистика приглашений сейчас недоступна. Повторите попытку позже."
    },
    "flow": {
      "connecting": "Подключаем ваш кошелёк...",
      "quoting": "Резервируем ваш мир...",
      "locking": "Подтвердите стейк в кошельке...",
      "confirming": "Проверяем ваш стейк в блокчейне...",
      "paying": "Подтвердите платёж в кошельке...",
      "confirmingBuy": "Проверяем ваш платёж в блокчейне...",
      "decommissioning": "Начинаем закрытие...",
      "releasing": "Завершаем закрытие...",
      "released": "Мир закрыт. Имя снова свободно.",
      "closed": "Мир закрыт. Имя снова свободно.",
      "founded": "{name} запущен. Добро пожаловать, оператор."
    },
    "err": {
      "invalid_realm_name": "Такое имя мира не допускается. Используйте буквы, цифры, пробелы или дефисы.",
      "realm_name_not_allowed": "Такое имя мира не допускается.",
      "realm_name_taken": "Такое имя мира уже занято.",
      "realm_cap_reached": "Достигнут лимит миров на аккаунт.",
      "stake_below_minimum": "Стейк ниже минимального уровня. Выберите уровень выше.",
      "supply_unavailable": "Данные о предложении $WOC временно недоступны. Повторите попытку позже.",
      "invalid_amount": "Недопустимая сумма стейка. Выберите уровень и повторите.",
      "link_wallet": "Сначала привяжите кошелёк к аккаунту.",
      "wallet_mismatch": "Подключите кошелёк, привязанный к вашему аккаунту.",
      "quote_expired": "Срок котировки истёк. Начните заново.",
      "quote_not_found": "Ваша котировка не найдена. Начните заново.",
      "not_your_quote": "Эта котировка принадлежит другому аккаунту.",
      "stake_already_recorded": "Этот стейк уже был учтён.",
      "tx_not_finalized": "Ваш стейк ещё не финализирован. Попробуйте подтвердить чуть позже.",
      "tx_failed": "Транзакция стейка не прошла в блокчейне.",
      "token_2022": "Этот минт $WOC не поддерживается для стейкинга.",
      "wrong_vault_amount": "Заблокированная сумма не совпадает с вашей котировкой.",
      "wrong_payer": "Стейк должен быть подписан вашим привязанным кошельком.",
      "stake_service_unavailable": "Стейкинг временно недоступен. Попробуйте подтвердить чуть позже.",
      "not_realm_owner": "Вы не управляете этим миром.",
      "realm_not_found": "Этот мир больше не существует.",
      "realm_not_active": "Этот мир не активен.",
      "realm_not_decommissioning": "Этот мир не находится в процессе закрытия.",
      "timelock_not_elapsed": "Таймлок стейка ещё не истёк.",
      "stake_not_released_onchain": "Сначала высвободите стейк в блокчейне, затем завершите закрытие.",
      "rate_limited": "Слишком много запросов. Подождите и повторите.",
      "buy_unavailable": "Покупка мира сейчас недоступна. Вместо этого застейкайте $WOC, чтобы основать его.",
      "invalid_currency": "Выберите SOL или USDC и повторите.",
      "invalid_tier": "Выберите уровень и повторите.",
      "price_unavailable": "Актуальные цены сейчас недоступны. Повторите попытку позже.",
      "payment_already_recorded": "Этот платёж уже был учтён.",
      "bad_signature": "Подпись платежа недействительна. Начните заново.",
      "legs_collide": "Не удалось проверить платёж. Начните заново.",
      "not_finalized": "Ваш платёж ещё не финализирован. Попробуйте подтвердить чуть позже.",
      "memo_mismatch": "Этот платёж не соответствует вашей котировке. Начните заново.",
      "treasury_short": "Оплаченная сумма не совпадает с вашей котировкой.",
      "buyback_short": "Оплаченная сумма не совпадает с вашей котировкой.",
      "bond_required": "Для покупки этого уровня нужно держать {amount} $WOC в привязанном кошельке. Пополните и повторите.",
      "generic": "Что-то пошло не так. Попробуйте ещё раз."
    }
  },
  "launchpad": {
    "open": "Токен-лаунчпад",
    "title": "Лаунчпад токена мира",
    "back": "Назад",
    "loading": "Загрузка состояния токена...",
    "symbolBadge": "Токен {symbol}",
    "termsNote": "World of ClaudeCraft выступает некастодиальным посредником: токены переходят из кошелька в кошелек, и этот сервер никогда не хранит средства. Функции лаунчпада недоступны в подсанкционных и ограниченных регионах и не содержат обещаний прибыли.",
    "status": {
      "none": "Токен не зарегистрирован",
      "prelaunch": "Перед запуском",
      ...
      "live": "Запущен",
      "graduated": "Выпущен на биржу",
      "closed": "Закрыт"
    },
    "checklist": {
      "aria": "Контрольный список запуска",
    ...
    "policy": {
      "cosmetic": "Только косметика",
      "power": "Плати и побеждай",
      "powerBanner": "Мир с платными преимуществами: после запуска этот токен может покупать игровую силу здесь."
    },
    "register": {
      "title": "Зарегистрировать токен мира",
      "subtitle": "Назовите валюту, которую запустит этот мир. Регистрация задает только идентичность: минт, блокировки и ликвидность появятся в следующих фазах со своими гарантиями.",
      "symbolLabel": "Тикер токена",
      "symbolPlaceholder": "напр. MOON",
      "policyLabel": "Политика монетизации",
      "policyHint": "Вариант «только косметика» сохраняет мир без платных преимуществ. «Плати и побеждай» помечается для каждого игрока и проходит проверку перед запуском.",
      "submit": "Зарегистрировать токен"
    },
    "vote": {
      "title": "Должен ли этот мир запустить свой токен?",
      "subtitle": "Один голос на подтвержденный привязанный кошелек, вес равен $WOC на момент голосования. Голосование совещательное и бесплатное: транзакция не отправляется.",
      "openBtn": "Открыть голосование сообщества",
      "yes": "Голосовать за",
      "no": "Голосовать против",
      "tallyYes": "За: {amount} $WOC",
      "tallyNo": "Против: {amount} $WOC",
      "tallyAria": "Доля голосов «за» в общем весе",
      "quorum": "Кворум: {current} из {required} $WOC",
      "quorumAria": "Прогресс кворума",
      "threshold": "Проходит при кворуме и {pct}% голосов «за»",
      "yourVote": "Ваш голос записан с весом {amount} $WOC.",
      "outcomePending": "Кворум еще не достигнут.",
      "outcomePassed": "Голосование пройдено. Предпродажа открыта.",
      "outcomeFailed": "Голосов «за» меньше порога."
    },
    "presale": {
      "title": "Предпродажа",
      "subtitle": "Вносите SOL, USDC или $WOC на запуск. Средства идут напрямую в эскроу-кошелек основателя; сервер лишь проверяет транзакцию и никогда не хранит деньги.",
      "stripeDeferred": "Оплата картой на этой фазе недоступна.",
      "progress": "{pct}% мягкого потолка",
      "progressAria": "Прогресс предпродажи к мягкому потолку",
      "railRaised": "Собрано {raised} из {cap} {currency}",
      "railWalletRemaining": "Ваш оставшийся лимит: {amount} {currency}",
      "railFull": "Эта валюта достигла лимита.",
      "amountLabel": "Сумма в {currency}",
      "amountPlaceholder": "0.0",
      "contribute": "Внести вклад",
      "contributeConnect": "Подключите кошелек, чтобы внести вклад",
      "escrowNote": "Эскроу-кошелек: {address}",
      "refundTerms": "Если предпродажа не достигнет мягкого потолка, основатель вернет взносы из эскроу-кошелька, и каждый возврат проверяется в блокчейне.",
      "softCapMet": "Мягкий потолок достигнут.",
      "finalize": "Завершить предпродажу",
      "finalizeHint": "Завершает предпродажу: при достигнутом потолке статус «профинансировано», иначе открываются возвраты.",
      "notConfigured": "Основатель еще не открыл прием взносов.",
      "refundTitle": "Возвраты",
      "refundNote": "Эта предпродажа не достигла мягкого потолка. Возвраты выплачиваются из эскроу-кошелька и проверяются в блокчейне.",
      "refundRemaining": "Взносов в ожидании проверенного возврата: {count}",
      "refundDone": "По каждому взносу есть проверенный возврат.",
      "config": {
        "title": "Открыть прием взносов",
        "subtitle": "Укажите эскроу-кошелек под вашим контролем и лимиты по каждой валюте. Пустая валюта отключается. Суммы в целых единицах.",
        "escrowLabel": "Адрес эскроу-кошелька",
        "softLabel": "Мягкий потолок ({currency})",
        "raiseLabel": "Потолок сбора ({currency})",
        "walletLabel": "Лимит на кошелек ({currency})",
        "submit": "Открыть предпродажу"
      }
    },
    "launch": {
      "title": "Запуск токена",
      "subtitle": "Создайте минт, распределите фиксированное предложение и заблокируйте все непубличные доли в блокчейне. Пока все блокировки не подтверждены, токен не может выйти в продажу.",
      "stepsAria": "Шаги запуска",
      "step": {
        "mint": "Создать минт",
        "locks": "Распределить и заблокировать",
        "verify": "Проверить в блокчейне",
        "list": "Выход в продажу"
      },
      "supply": "Фиксированное предложение: {amount} {symbol}",
      "allocLine": "Публичная кривая {publicPct}%, ликвидность {liquidityPct}% (навсегда заблокирована при выпуске)",
      "bucketLine": "{bucket}: {pct}%, {amount} {symbol}, клифф {cliff} мес. + линейно {linear} мес.",
      "bucket": {
        "founder": "Основатель",
        "levy": "Фонд Levy Street",
        "treasury": "Казна мира"
      },
      "lockProof": "Блокировка ({bucket}):",
      "mintCreated": "Минт:",
      "verifiedNote": "Все блокировки подтверждены в блокчейне. Токен сможет выйти в продажу после открытия кривой.",
      "createTitle": "Создать минт",
      "createHint": "Ваш кошелек оплачивает аренду и подписывает как владелец права выпуска. Сервер никогда не хранит ключ, способный перемещать средства: он лишь строит транзакцию, фиксирует адрес минта и проверяет результат в блокчейне.",
      "treasuryLabel": "Кошелек казны мира",
      "treasuryHint": "Получает вестируемую долю казны мира. Используйте кошелек под управлением вашего мира.",
      "nameLabel": "Название токена (необязательно)",
      "uriLabel": "URL метаданных (необязательно)",
      "createBtn": "Создать минт",
      "locksTitle": "Проверить блокировки",
      "locksHint": "Отчеканьте все предложение, создайте три неотменяемых эскроу Jupiter Lock точно на указанных условиях, откажитесь от права выпуска, затем вставьте сюда адрес каждого эскроу. Все сверяется с блокчейном.",
      "lockLabel": "Адрес эскроу блокировки ({bucket})",
      "verifyBtn": "Проверить в блокчейне",
      "checksAria": "Чек-лист проверки в блокчейне",
      "checkPass": "пройдено",
      "checkFail": "не пройдено",
      "check": {
        "mint_found": "Аккаунт минта читается",
        "mint_profile": "Чистый профиль токена (без заморозки, хуков и комиссий)",
        "supply_exact": "Фиксированное предложение отчеканено точно",
        "mint_authority_renounced": "Право выпуска отозвано",
        "lock_found": "Эскроу блокировки найден",
        "lock_mint": "Блокировка держит этот токен",
        "lock_recipient": "Получатель блокировки совпадает",
        "lock_immutable": "Блокировка неизменяема (нельзя отменить или сменить получателя)",
        "lock_token_program": "Блокировка использует верную программу токена",
        "lock_untouched": "Блокировка не тронута и не отменялась",
        "lock_amount": "Заблокированная сумма точна",
        "lock_schedule": "График вестинга соответствует обязательству",
        "lock_funded": "Эскроу блокировки держит токены",
        "unknown": "Дополнительная проверка"
      }
    },
    "curve": {
      "title": "Бондинговая кривая",
      "subtitle": "Токен торгуется на открытой кривой по одной цене для всех. При достижении порога миграции он выпускается в пул ликвидности с навсегда заблокированным LP.",
      "lpLockLine": "Конфигурация запуска навсегда блокирует {pct}% LP при выпуске.",
      "poolLabel": "Пул кривой:",
      "progressAria": "Прогресс к порогу миграции",
      "progress": "Собрано {raised} из {threshold} до миграции",
      "migratedNote": "Кривая достигла порога и мигрировала. Проверьте выпуск ниже.",
      "graduatedNote": "Выпуск завершен: пул ликвидности с навсегда заблокированным LP:",
      "openBtn": "Открыть кривую",
      "openHint": "Строит создание пула для подписи вашим кошельком. Хост кривой чеканит токен и держит предложение кривой; средства не проходят через этот сервер.",
      "verifyBtn": "Проверить листинг кривой",
      "verifyHint": "Когда транзакция создания пула подтвердится, проверьте ее, чтобы токен вышел в продажу.",
      "graduateBtn": "Проверить выпуск"
    },
    "fund": {
      "open": "Фонд Levy Street",
      "title": "Фонд Levy Street",
      "subtitle": "Платформа держит заблокированную долю каждого токена мира, запущенного здесь, и показывает ее в реальном времени. Это прозрачная казна, а не фонд для покупки: ничего на этой странице нельзя купить, продать или погасить.",
      "loading": "Загрузка портфеля...",
      "notPublished": "Портфель еще не опубликован.",
      "empty": "Фонд пока не держит токенов миров.",
      "aum": "Общая стоимость: {amount} USD",
      "updated": "Обновлено {time}",
      "clampedNote": "Крупное изменение за одно обновление удерживается до подтверждающего обновления.",
      "policyNote": "Каждая позиция вестируется по самому строгому графику в таблице капитализации (клифф 12 мес. + линейно 48 мес.), а распоряжение требует одобрения управления. Платформа не может сбросить эту долю.",
      "tableAria": "Позиции фонда",
      "colToken": "Токен",
      "colAmount": "Количество",
      "colPrice": "Цена (USD)",
      "colValue": "Стоимость (USD)",
      "colWeight": "Доля",
      "colStatus": "Статус",
      "badgeLocked": "Заблокировано",
      "badgeGraduated": "Выпущено",
      "statusIlliquid": "Неликвидно (исключено из итога)",
      "confidence": {
        "high": "Оценено (перекрестная проверка)",
        "medium": "Оценено",
        "low": "Оценено (низкая уверенность)"
      },
      "illiquidNote": "Позиции без надежной цены: {count}. Показываются, но не учитываются."
    },
    "flow": {
      "registering": "Регистрация токена...",
      "openingVote": "Открытие голосования...",
      "castingVote": "Запись вашего голоса...",
      "configuring": "Открытие приема взносов...",
      "quoting": "Резервирование вашего взноса...",
      "paying": "Подтвердите перевод в кошельке...",
      "confirming": "Проверка вашего взноса в блокчейне...",
      "contributed": "Взнос записан.",
      "finalizing": "Завершение предпродажи...",
      "preparingMint": "Подготовка транзакции минта...",
      "signingMint": "Подтвердите создание минта в кошельке...",
      "confirmingMint": "Проверка минта в блокчейне...",
      "mintDone": "Минт создан и проверен.",
      "verifying": "Проверка блокировок в блокчейне...",
      "verified": "Запуск подтвержден: все блокировки в блокчейне.",
      "notVerified": "Проверка выявила проблемы. Просмотрите чек-лист ниже.",
      "preparingCurve": "Подготовка пула кривой...",
      "signingCurve": "Подтвердите создание пула в кошельке...",
      "curveSubmitted": "Создание пула отправлено. После подтверждения проверьте листинг.",
      "verifyingCurve": "Проверка кривой в блокчейне...",
      "curveListed": "Токен торгуется на кривой.",
      "verifyingGraduation": "Проверка выпуска в блокчейне...",
      "graduated": "Выпуск завершен: LP навсегда заблокирован.",
      "quotingPower": "Получаем расчет конвертации...",
      "powerQuoted": "Вы получите {copper} меди. Подтвердите перевод в кошельке...",
      "confirmingPower": "Проверяем перевод в сети...",
      "powerCredited": "Персонажу начислено {copper} меди.",
      "powerBanked": "Начислено {copper} меди. Медь придет при следующем входе этого персонажа."
    },
    "power": {
      "title": "Конвертация в медь",
      "subtitle": "Этот мир с платными преимуществами конвертирует {symbol} в игровую медь. Токены отправляются в казну мира, а медь начисляется после финализации перевода в сети.",
      "charLabel": "Персонаж-получатель",
      "amountLabel": "Количество ({symbol})",
      "convertBtn": "Конвертировать в медь",
      "convertConnect": "Подключить кошелек и конвертировать",
      "noCharacters": "Сначала создайте персонажа в этом мире, чтобы получить медь."
    },
    "err": {
      "not_realm_owner": "Вы не управляете этим миром.",
      "realm_not_found": "Этот мир больше не существует.",
      "realm_not_active": "Этот мир не активен.",
      "invalid_token_symbol": "Выберите тикер из 2-10 заглавных букв и цифр.",
      "invalid_token_icon": "Этот значок токена недопустим.",
      "invalid_token_policy": "Выберите политику монетизации.",
      "token_already_registered": "У этого мира уже есть зарегистрированный токен.",
      "token_not_registered": "У этого мира нет зарегистрированного токена.",
      "vote_not_open": "Голосование сообщества не открыто.",
      "vote_not_openable": "Из этого состояния голосование открыть нельзя.",
      "invalid_vote_choice": "Выберите «за» или «против».",
      "wallet_not_linked": "Сначала подтвердите кошелек в аккаунте.",
      "vote_weight_unavailable": "Не удалось прочитать ваш баланс $WOC. Попробуйте позже.",
      "no_vote_weight": "На подтвержденном кошельке нет целого $WOC для голосования.",
      "already_voted": "Голос с этого кошелька или аккаунта уже записан.",
      "presale_not_open": "Предпродажа не открыта.",
      "presale_not_configured": "Основатель еще не открыл прием взносов.",
      "presale_already_configured": "Прием взносов уже открыт.",
      "presale_not_refunding": "Эта предпродажа не в стадии возврата.",
      "presale_unavailable": "Предпродажа временно недоступна. Попробуйте позже.",
      "invalid_escrow_wallet": "Этот адрес эскроу-кошелька недопустим.",
      "invalid_presale_caps": "Эти лимиты недопустимы. Каждой включенной валюте нужны мягкий потолок, потолок сбора не ниже него и лимит на кошелек.",
      "invalid_currency": "Выберите SOL, USDC или $WOC.",
      "currency_not_enabled": "Эта предпродажа не принимает такую валюту.",
      "invalid_amount": "Введите корректную сумму.",
      "wallet_cap_exceeded": "Это превысит ваш лимит на кошелек.",
      "raise_cap_exceeded": "Это превысит общий потолок сбора.",
      "quote_not_found": "Ваша заявка не найдена. Начните заново.",
      "not_your_quote": "Эта заявка принадлежит другому аккаунту.",
      "quote_expired": "Срок заявки истек. Начните заново.",
      "contribution_already_recorded": "Эта транзакция уже записана.",
      "contribution_not_found": "Этот взнос не найден.",
      "already_refunded": "Этот взнос уже возвращен.",
      "refund_sig_reused": "Эта транзакция возврата уже покрывает другой взнос.",
      "wrong_refunder": "Возврат должен быть оплачен эскроу-кошельком.",
      "refund_short": "Возврат не покрывает взнос.",
      "bad_signature": "Подпись транзакции недействительна. Начните заново.",
      "not_finalized": "Транзакция еще не финализирована. Попробуйте через минуту.",
      "tx_failed": "Транзакция завершилась ошибкой в блокчейне.",
      "token_2022": "Эта токен-программа здесь не поддерживается.",
      "memo_mismatch": "Транзакция не соответствует вашей заявке. Начните заново.",
      "wrong_payer": "Транзакция должна быть подписана привязанным кошельком.",
      "escrow_short": "Оплаченная сумма не совпадает с заявкой.",
      "missing_quoteId_or_paySig": "Подтверждение было неполным. Начните заново.",
      "missing_payTxSig_or_refundSig": "Данные возврата были неполными.",
      "mint_already_created": "Минт уже создан.",
      "presale_not_funded": "Предпродажа еще не завершена успешно.",
      "levy_fund_unconfigured": "Кошелек фонда платформы еще не настроен. Попробуйте позже.",
      "invalid_treasury_wallet": "Этот адрес кошелька казны недействителен.",
      "invalid_token_name": "Название токена: от 1 до 32 обычных символов.",
      "invalid_token_uri": "URL метаданных должен быть https-адресом.",
      "chain_unavailable": "Не удалось подключиться к блокчейну. Попробуйте позже.",
      "launch_not_prepared": "Сначала подготовьте транзакцию минта.",
      "mint_not_in_tx": "Эта транзакция не создала зафиксированный минт.",
      "mint_not_found": "Не удалось прочитать аккаунт минта в блокчейне.",
      "wrong_token_program": "Минт находится не под ожидаемой программой токена.",
      "wrong_decimals": "У минта не те десятичные знаки, что ожидались.",
      "freeze_authority_set": "У минта есть право заморозки. Его быть не должно.",
      "bad_metadata_pointer": "Указатель метаданных минта неверен или еще изменяем.",
      "metadata_symbol_mismatch": "Символ в блокчейне не совпадает с зарегистрированным токеном.",
      "unexpected_extension": "У минта есть недопустимое расширение.",
      "launch_sig_replayed": "Эта транзакция запуска уже использована.",
      "mint_not_created": "Сначала создайте и подтвердите минт.",
      "invalid_lock_address": "Введите три разных действительных адреса эскроу блокировок.",
      "launch_not_verifiable": "Запуск еще не готов к проверке.",
      "locks_not_verified": "Блокировки еще не проверены в блокчейне.",
      "not_listable": "Из этого состояния токен не может выйти в продажу.",
      "missing_sig": "Подтверждение было неполным. Начните заново.",
      "launchpad_disabled": "Лончпад кривой на этом сервере еще не включен.",
      "launchpad_config_unreadable": "Не удалось прочитать конфигурацию запуска. Попробуйте позже.",
      "curve_already_created": "Кривая уже существует.",
      "host_requires_dbc_mint": "Этот хост кривой сам создает токен; заранее отчеканенный токен не подходит.",
      "invalid_base_mint": "Этот адрес базового минта недействителен.",
      "curve_not_found": "Пул кривой еще не найден в блокчейне. Попробуйте чуть позже.",
      "wrong_curve_creator": "Пул кривой должен быть создан вашим привязанным кошельком.",
      "not_live": "Токен не торгуется на кривой.",
      "not_migrated": "Кривая не достигла порога миграции.",
      "graduation_not_found": "Пул ликвидности после выпуска еще не найден в блокчейне.",
      "lp_not_permanently_locked": "Ликвидность не заблокирована навсегда.",
      "not_damm_v2": "Конфигурация запуска не выпускает в заблокированный пул.",
      "no_locked_vesting": "В конфигурации запуска нет заблокированного вестинга.",
      "no_migration_threshold": "В конфигурации запуска нет порога миграции.",
      "power_disabled": "Конвертация токенов в медь не включена на этом сервере.",
      "realm_not_power": "Этот мир не допускает конвертацию токенов в медь.",
      "token_not_live": "Сначала токен должен торговаться на кривой.",
      "power_rate_unset": "Курс конвертации еще не настроен.",
      "power_sink_unavailable": "Казна мира пока недоступна.",
      "amount_below_minimum": "Это количество слишком мало для конвертации.",
      "character_not_found": "Выберите одного из ваших персонажей в этом мире.",
      "sink_short": "Перевод не покрывает указанное в расчете количество.",
      "credit_already_recorded": "Эта транзакция уже зачислена.",
      "region_blocked": "Эта функция недоступна в вашем регионе.",
      "wallet_sanctioned": "Этот кошелек не может использовать лаунчпад.",
      "sanctions_unavailable": "Проверка соответствия временно недоступна. Повторите попытку позже.",
      "rate_limited": "Слишком много запросов. Помедленнее и попробуйте снова.",
      "wallet_mismatch": "Подключите кошелек, привязанный к аккаунту.",
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "Сезон $WOC",
      "title": "Сезон наград $WOC",
      "subtitle": "Выплаты лучшим игрокам из казны",
      "close": "Закрыть",
      "none": "Сейчас нет активного сезона наград.",
      "noneHint": "Сезон откроется, когда сборы арены и выкупы начнут пополнять пул.",
      "statusActive": "Активен",
      "statusEnded": "Завершён",
      "endsIn": "Ends in",
      "endsInValue": "{days}d {hours}h {minutes}m",
      "ended": "Этот сезон завершён.",
      "openEnded": "Бессрочный",
      "poolLabel": "Доступный призовой фонд",
      "wocUnit": "$WOC",
      "emittedLabel": "Выплачено {pct}% пула",
      "sinkLabel": "Пополнено",
      "emissionLabel": "Paid out",
      "invariant": "Выплаты никогда не превысят доход сезона: покупок больше, чем продаж, это гарантирует блокчейн.",
      "standingsTitle": "Прогноз лидеров по наградам",
      "colRank": "#",
      "colPlayer": "Игрок",
      "colRating": "Рейтинг",
      "colReward": "Награда ($WOC)",
      "projectedNote": "Прогноз по текущему пулу и рейтингу арены; итоговые выплаты фиксируются в конце сезона."
    },
    "account": {
      "title": "Аккаунт",
