...
export const ru_RU: EnTranslations = {
  ...
  "launchpad": {
    ...
    "launches": {
      "open": "Запуски сообщества",
      "title": "Запуски сообщества",
      "subtitle": "Миры, где сейчас идёт голосование за запуск токена или предпродажа. Голосовать или внести вклад может любой.",
      "loading": "Загрузка запусков сообщества...",
      "empty": "Сейчас ни один мир не голосует и не проводит предпродажу. Загляните позже.",
      "statusVoting": "Голосование сообщества",
      "statusPresale": "Предпродажа",
      "powerTag": "Плати и побеждай",
      "progressVoting": "{pct}% кворума",
      "progressPresale": "{pct}% мягкого потолка",
      "ctaVote": "Голосовать",
      "ctaContribute": "Внести вклад"
    },
    "levy": {
      "open": "Фонд Леви-Стрит",
      "title": "Фонд Леви-Стрит",
      "subtitle": "Прозрачный портфель только для отображения, содержащий долю каждого токена мира, запущенного здесь.",
      "displayOnlyNote": "Только для отображения: фонд держит эти токены рядом с вами и не может их продать. Нет доли фонда и нет погашения.",
      "loading": "Загрузка портфеля……",
      "empty": "Пока нет активов. Запущенные токены миров появятся здесь после листинга.",
      "aum": "Общая стоимость (AUM)",
      "aumSol": "in SOL",
      "holdings": "{count} активов",
      "excluded": "{count} исключено как неликвидные",
      "clamped": "Изменение стоимости при этом обновлении ограничено до подтверждения.",
      ...
      "colValue": "Стоимость",
      "colWeight": "Вес",
      "illiquidTag": "неликвид",
      "sourceCurve": "кривая",
      "sourceDex": "DEX",
      "locked": "Заблокировано в сети",
      "solPrice": "SOL / USD {price}"
    },
    "register": {
    ...
    "err": {
      ...
      "mint_not_ready": "Токен можно выпустить только после успешного пресейла.",
      "token_already_minted": "Этот токен уже выпущен.",
      "token_not_minted": "Сначала выпустите токен.",
      "levy_wallet_unconfigured": "Запуск токенов на этом хосте мира еще не включен.",
      "launch_unavailable": "Сервис запуска временно недоступен. Попробуйте позже.",
      "launch_sig_reused": "Эта транзакция уже использована другим запуском.",
      "mint_mismatch": "Минт в сети не соответствует этому запуску. Начните заново.",
      "already_distributed": "Предложение уже распределено.",
      "not_distributed": "Сначала распределите предложение.",
      "distribution_mismatch": "Распределение не соответствует плану аллокации.",
      "invalid_lock_bucket": "Выберите блокировку основателя, платформы или казны.",
      "already_locked": "Эта доля уже заблокирована.",
      "lock_mismatch": "Блокировка в сети не соответствует этому запуску. Начните заново.",
      "lock_not_immutable": "Эта блокировка не является неизменяемой. Никто не должен иметь возможности ее отменить.",
      "lock_underfunded": "В блокировке нет полной суммы доли.",
      "locks_incomplete": "Токен не может выйти на листинг, пока блокировки основателя, платформы и ликвидности не подтверждены в сети.",
      "missing_quoteId_or_signature": "Подтверждение запуска было неполным. Начните заново.",
      "curve_disabled": "Запуск через бондинг-кривую на этом хосте мира еще не включен.",
      "fee_claimer_unconfigured": "Комиссионное хранилище платформы еще не настроено.",
      "curve_already_launched": "У этого токена уже есть бондинг-кривая.",
      "curve_not_launched": "Сначала запустите бондинг-кривую.",
      "curve_mismatch": "Кривая в сети не соответствует этому запуску. Начните заново.",
      "not_migrated": "Кривая еще не завершила выпуск.",
      "power_credit_disabled": "Трата этого токена на внутриигровую силу здесь не включена.",
      "power_sink_unconfigured": "В этом мире еще не настроена трата токенов.",
      "not_power_realm": "Этот мир только косметический: его токен не может покупать игровую силу.",
      "token_2022_mismatch": "Этот перевод не соответствует токену мира. Начните заново.",
      "sink_not_credited": "Перевод не дошел до кошелька мира.",
      "amount_too_small": "Эта сумма слишком мала для зачисления монет.",
      "credit_already_recorded": "Этот перевод уже зачислен.",
      "no_character_to_credit": "Войдите персонажем в этом мире, чтобы получить зачисление.",
      "missing_payTxSig": "Данные зачисления были неполными.",
