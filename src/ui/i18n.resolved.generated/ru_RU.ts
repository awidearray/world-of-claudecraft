...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hilo": {
      "title": "Больше-меньше интенданта",
      "rules": "Называйте «больше» или «меньше» на броске от 1 до 100. Меньше выигрывает на 1 до 49, больше на 52 до 100. Выплата равная.",
      "balance": "Кошелёк: {amount}",
      "stakeLabel": "Ставка",
      "prompt": "Выберите ставку и назовите: больше или меньше.",
      "low": "Меньше (1 до 49)",
      "high": "Больше (52 до 100)",
      "session": "За эту сессию: побед {wins}, поражений {losses}",
      "close": "Закрыть",
      "wonLine": "Выпало {roll}. Вы выиграли {amount}.",
      "lostLine": "Выпало {roll}. Вы проиграли {amount}.",
      "wonLog": "Больше-меньше: выпало {roll}, выигрыш {amount}.",
      "lostLog": "Больше-меньше: выпало {roll}, проигрыш {amount}."
    },
    "readyCheck": {
  ...
  "loading": {
    ...
    "webOnlyRealm": "В этот мир можно войти только через веб-браузер.",
    "tips": {
  ...
  "realm": {
    ...
    "p2wBadge": "Пэй-ту-вин",
    "p2wTip": "В этом мире включены механики реальных денег и криптовалюты. Вход добровольный и только для совершеннолетних.",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "riverboat_dealer": {
        "name": "Крупье Марибель",
        "title": "Шулер Большого салона",
        "greeting": "Присаживайтесь, {className}. Колода свежая, а раздача честная. Сыграем партию?"
      },
      "riverboat_pit_boss": {
        "name": "Распорядитель Крейк",
        "title": "Хозяин ставочного ринга",
        "greeting": "Двое бойцов, один куш, {className}. Выходи на ринг и назови свою ставку."
      },
      "riverboat_slots_attendant": {
        "name": "Тилли Спрокет",
        "title": "Хранительница барабанов",
        "greeting": "Автоматы смазаны и готовы, {className}. Одно бесплатное вращение в день, и барабаны никогда не лгут."
      },
      "riverboat_hilo_croupier": {
        "name": "Интендант Нок",
        "title": "Вещатель костей",
        "greeting": "Больше или меньше, {className}, один бросок решает всё. Дом забирает лишь середину."
      },
      "riverboat_cashier_purser": {
        "name": "Казначей Одали Финч",
        "title": "Хранительница клетки",
        "greeting": "Касса открыта, {className}. Фишки внутрь, монеты наружу, и к рассвету всякий счёт сходится."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
