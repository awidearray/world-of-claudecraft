...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "Магазин мерча",
      "subtitle": "Официальный мерч World of ClaudeCraft с доставкой по всему миру.",
      "loading": "Загрузка магазина…",
      "unavailable": "Магазин мерча сейчас недоступен. Ваши заказы и платежи не затронуты; загляните позже.",
      "disclosure": "Мерч производится и отправляется нашим печатным партнёром под заказ. Claudium, потраченный на мерч, не возвращается в виде Claudium; платежи картой и через Solana подчиняются политике возвратов в Условиях обслуживания.",
      "catalogTitle": "Каталог",
      "catalogEmpty": "Сейчас мерч недоступен.",
      "variantLabel": "Стиль и размер",
      ...
      "totalLabel": "Итого",
      "totalNote": "Доставка и налоги добавляются при оформлении; итоговая сумма подтверждается на сервере.",
      ...
      "shipping": {
        ...
        "zip": "Почтовый индекс",
        "country": "Страна",
        "email": "Эл. почта для уведомлений о заказе"
      },
      "shippingIncomplete": "Заполните все обязательные поля доставки.",
      "railLabel": "Способ оплаты",
      "railStripe": "Карта",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "Оформить заказ",
      "checkoutPending": "Заказ выполняется. Завершите оплату и не закрывайте эту страницу.",
      "checkoutFailed": "Не удалось начать оформление. Попробуйте ещё раз.",
      "checkoutUnavailable": "Этот заказ сейчас недоступен.",
      "checkoutNotSettled": "Транзакция отправлена, но заказ ещё не подтверждён. Проверьте свои заказы чуть позже.",
      "orderPlaced": "Заказ {orderId} оформлен. Отслеживайте его в списке заказов ниже.",
      "ordersTitle": "Ваши заказы",
      "trackOrder": "Отследить",
      "status": {
        "pendingPayment": "Ожидает оплаты",
        "paid": "Оплачен",
        "submitted": "Передан в производство",
        ...
        "canceled": "Отменён",
        "refunded": "Возвращён",
        "fulfillmentFailed": "Сбой отправки",
        "unknown": "В обработке"
      }
    },
    "theme": {
