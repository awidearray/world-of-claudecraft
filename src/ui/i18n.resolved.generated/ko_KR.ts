...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "merch": {
      "title": "굿즈 스토어",
      "subtitle": "공식 World of ClaudeCraft 굿즈를 전 세계로 배송합니다.",
      "loading": "스토어를 불러오는 중…",
      "unavailable": "굿즈 스토어를 지금은 이용할 수 없습니다. 주문과 결제에는 영향이 없습니다. 잠시 후 다시 시도해 주세요.",
      "disclosure": "굿즈는 인쇄 파트너가 주문 제작하여 배송합니다. 굿즈 구매에 사용한 Claudium은 Claudium으로 환불되지 않으며, 카드 및 Solana 결제는 서비스 약관의 환불 정책을 따릅니다.",
      "catalogTitle": "카탈로그",
      "catalogEmpty": "지금은 구매할 수 있는 굿즈가 없습니다.",
      "variantLabel": "스타일 및 사이즈",
      "addToCart": "장바구니에 추가",
      "outOfStock": "품절",
      "cartTitle": "장바구니",
      ...
      "totalLabel": "합계",
      "totalNote": "배송비와 세금은 결제 시 추가되며, 최종 금액은 서버에서 확정됩니다.",
      "claudiumPrice": "{amount} Claudium",
      "checkoutTitle": "결제",
      "loginRequired": "결제하려면 계정에 로그인하세요.",
      "shipping": {
        "name": "이름",
        "address1": "주소",
        "address2": "주소 2행(선택)",
      ...
      "shippingIncomplete": "필수 배송 정보를 모두 입력해 주세요.",
      "railLabel": "결제 수단",
      "railStripe": "카드",
      "railSol": "SOL",
      "railClaudium": "Claudium",
      "payNow": "주문하기",
      "checkoutPending": "주문을 처리 중입니다. 결제를 완료하고 이 페이지를 열어 두세요.",
      "checkoutFailed": "결제를 시작할 수 없습니다. 다시 시도해 주세요.",
      "checkoutUnavailable": "해당 주문은 지금 이용할 수 없습니다.",
      "checkoutNotSettled": "트랜잭션은 전송되었지만 주문이 아직 확인되지 않았습니다. 잠시 후 주문 내역을 확인해 주세요.",
      "orderPlaced": "주문 {orderId}이(가) 접수되었습니다. 아래 주문 내역에서 추적할 수 있습니다.",
      "ordersTitle": "주문 내역",
      "trackOrder": "추적",
      "status": {
