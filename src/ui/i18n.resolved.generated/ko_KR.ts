...
export const ko_KR: EnTranslations = {
  ...
  "realmOp": {
    ...
    "found": {
      "title": "월드 설립",
      "subtitle": "$WOC를 비수탁 에스크로에 스테이킹하여 나만의 월드를 개설하고 운영하세요.",
      "nameLabel": "월드 이름",
      "namePlaceholder": "월드 이름 짓기",
      "typeLabel": "월드 유형",
      "tierLabel": "스테이크 등급",
      "tierHint": "더 큰 스테이크는 더 높은 등급을 해제합니다. 더 많은 플레이어, 더 많은 커스터마이징 예산, 운영자 수익 레일이 제공됩니다.",
      "supplyNote": "각 등급의 가격은 실시간 $WOC 공급량의 비율로 책정됩니다.",
      "badgeNote": "스테이킹한 $WOC는 계속 홀더 배지에 집계되므로, 월드를 설립해도 등급이 내려가지 않습니다.",
      "affiliateNote": "제휴자의 추천입니다. 그들은 이 월드 수익의 15%를 수수료로 받습니다.",
      "tiersUnavailable": "실시간 등급 가격을 지금 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      "submit": "스테이킹 및 설립",
      "submitConnect": "설립하려면 지갑 연결",
      "stakingNote": "{amount} $WOC를 에스크로에 잠그는 트랜잭션 하나에 서명합니다. 해체 후 {days}일 타임락이 지나면 언제든 회수할 수 있습니다.",
      "nameTaken": "다른 이름을 선택하세요. 해당 이름은 사용 중입니다.",
      "methodLabel": "결제 방법",
      "methodStake": "$WOC 스테이킹",
      "methodStakeHint": "$WOC를 에스크로에 잠급니다. 해체 시 전액 반환됩니다.",
      "methodBuy": "SOL 또는 USDC로 구매",
      "methodBuyHint": "SOL 또는 USDC로 한 번만 지불합니다. 최종 구매이며 회수할 스테이크가 없습니다."
    },
    "tier": {
      "bronze": "브론즈",
      "silver": "실버",
      ...
      "priceUnavailable": "가격 없음"
    },
    "buy": {
      "currencyLabel": "결제 수단",
      "currencySol": "SOL",
      "currencyUsdc": "USDC",
      "currencyUnavailable": "{currency}은(는) 지금 사용할 수 없습니다(스왑 경로 없음).",
      "splitNote": "지불액의 {treasuryPct}%는 트레저리로 가고, 나머지는 $WOC를 매입하여 소각합니다.",
      "finalNote": "구매는 최종이며 환불되지 않습니다. 스테이크와 달리 월드를 해체해도 반환되지 않습니다.",
      "unavailable": "지금은 월드를 구매할 수 없습니다. 대신 $WOC를 스테이킹하여 설립하세요.",
      "submit": "구매 및 설립",
      "submitConnect": "구매하려면 지갑 연결",
      "note": "{amount} {currency}을(를) 지불하는 트랜잭션 하나에 서명하여 이 월드를 설립합니다. 월드는 즉시 활성화됩니다.",
      "bondNote": "또한 {amount} $WOC를 보유해야 하며, 월드가 유지되는 동안 연결된 지갑에 보관해야 합니다. 그렇지 않으면 월드가 만료됩니다.",
      "bondWhy": "이 지속 보증금은 지불하는 {currency}와 별개입니다. 월드를 운영하는 동안 이해관계를 유지하기 위한 것입니다."
    },
    "mine": {
      "title": "내 월드",
      "loading": "월드를 불러오는 중...",
      "empty": "아직 운영 중인 월드가 없습니다. 위에서 하나 설립해 시작하세요.",
      "tier": "{tier} 등급",
      "decommission": "해체",
      "release": "닫기 마무리",
      "enter": "입장",
      "eligible": "스테이크는 {date}에 해제 가능",
      "releaseHint": "온체인에서 스테이크를 해제한 뒤 마무리하면 월드가 닫히고 이름이 해제됩니다.",
      "decommissionConfirm": "{name}을(를) 해체할까요? 월드가 오프라인이 되고 {days}일의 스테이크 해제 타임락이 시작됩니다.",
      "bondInfo": "보증금: 연결된 지갑에 {amount} $WOC 보유.",
      "bondWarning": "보증금이 요구치 미만입니다. {amount} $WOC를 보유하고 {date} 전에 충전하지 않으면 이 월드는 만료됩니다."
    },
    "status": {
      "active": "활성",
      "provisioning": "준비 중",
      "decommissioning": "해체 중"
    },
    "affiliate": {
      "open": "추천 프로그램",
      "title": "추천 및 제휴 프로그램",
      "subtitle": "링크 하나를 공유하세요. 링크로 가입한 플레이어는 경험치와 골드 부스트를 받고, 당신은 그들의 수익에서 보상을 얻으며, 그들이 설립한 월드에서 15%를 받습니다.",
      "yourLink": "내 추천 링크",
      "copy": "링크 복사",
      "copied": "복사됨",
      "loading": "추천 통계를 불러오는 중...",
      "bonusTitle": "링크 보상 안내",
      "bonusReferee": "내 링크로 가입한 플레이어는 첫 30일 동안 경험치와 골드를 +10% 받습니다.",
      "bonusReferrer": "해당 기간 동안 그들이 얻는 수익의 +5%가 내 캐릭터에 적립됩니다.",
      "bonusRealm": "또한 그들이 설립한 월드에서 15%의 USDC 수수료를 받습니다.",
      "rewardsTitle": "내 추천 보상",
      "rewardsPending": "{xp} 경험치와 {gold} 지급 대기 중, 다음 로그인 시 적립됩니다",
      "rewardsLifetime": "평생 {xp} 경험치와 {gold} 획득",
      "rewardsReferred": "추천한 플레이어: {count}",
      "rewardsEmpty": "플레이어를 추천하여 수익을 시작하세요. 보상은 다음 로그인 시 캐릭터에 지급됩니다.",
      "referredTitle": "내가 추천한 월드",
      "referredCount": "활성 추천 월드 {count}개",
      "referredCountPlural": "활성 추천 월드 {count}개",
      "empty": "아직 추천한 월드가 없습니다. 링크를 공유하여 수익을 시작하세요.",
      "commission": "{pct}% 수수료",
      "earningsSoon": "월드 내 수익이 시작되면 USDC 수수료 지급이 시작됩니다.",
      "unavailable": "추천 통계를 지금 사용할 수 없습니다. 잠시 후 다시 시도하세요."
    },
    "flow": {
      "connecting": "지갑에 연결하는 중...",
      "quoting": "월드를 예약하는 중...",
      "locking": "지갑에서 스테이크를 승인하세요...",
      "confirming": "스테이크를 온체인에서 확인하는 중...",
      "paying": "지갑에서 결제를 승인하세요...",
      "confirmingBuy": "결제를 온체인에서 확인하는 중...",
      "decommissioning": "해체를 시작하는 중...",
      "releasing": "닫기를 마무리하는 중...",
      "released": "월드가 닫혔습니다. 이름을 다시 사용할 수 있습니다.",
      "closed": "월드가 닫혔습니다. 이름을 다시 사용할 수 있습니다.",
      "founded": "{name}이(가) 가동되었습니다. 운영자님, 환영합니다."
    },
    "err": {
      "invalid_realm_name": "해당 월드 이름은 허용되지 않습니다. 문자, 숫자, 공백, 하이픈을 사용하세요.",
      "realm_name_not_allowed": "해당 월드 이름은 허용되지 않습니다.",
      "realm_name_taken": "해당 월드 이름은 이미 사용 중입니다.",
      "realm_cap_reached": "계정당 월드 수 한도에 도달했습니다.",
      "stake_below_minimum": "해당 스테이크는 최소 등급 미만입니다. 더 높은 등급을 선택하세요.",
      "supply_unavailable": "$WOC 공급량 정보를 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      "invalid_amount": "스테이크 수량이 유효하지 않습니다. 등급을 선택하고 다시 시도하세요.",
      "link_wallet": "먼저 지갑을 계정에 연결하세요.",
      "wallet_mismatch": "계정에 연결한 지갑을 연결하세요.",
      "quote_expired": "견적이 만료되었습니다. 다시 시작하세요.",
      "quote_not_found": "견적을 찾을 수 없습니다. 다시 시작하세요.",
      "not_your_quote": "해당 견적은 다른 계정의 것입니다.",
      "stake_already_recorded": "해당 스테이크는 이미 기록되었습니다.",
      "tx_not_finalized": "스테이크가 아직 확정되지 않았습니다. 잠시 후 다시 확인하세요.",
      "tx_failed": "스테이크 트랜잭션이 온체인에서 실패했습니다.",
      "token_2022": "이 $WOC 민트는 스테이킹에 지원되지 않습니다.",
      "wrong_vault_amount": "잠긴 수량이 견적과 일치하지 않습니다.",
      "wrong_payer": "스테이크는 연결된 지갑으로 서명해야 합니다.",
      "stake_service_unavailable": "스테이킹을 일시적으로 사용할 수 없습니다. 잠시 후 다시 확인하세요.",
      "not_realm_owner": "해당 월드의 운영자가 아닙니다.",
      "realm_not_found": "해당 월드는 더 이상 존재하지 않습니다.",
      "realm_not_active": "해당 월드는 활성 상태가 아닙니다.",
      "realm_not_decommissioning": "해당 월드는 해체 진행 중이 아닙니다.",
      "timelock_not_elapsed": "스테이크 타임락이 아직 지나지 않았습니다.",
      "stake_not_released_onchain": "먼저 온체인에서 스테이크를 해제한 다음 마무리하세요.",
      "rate_limited": "요청이 너무 많습니다. 잠시 후 다시 시도하세요.",
      "buy_unavailable": "지금은 월드를 구매할 수 없습니다. 대신 $WOC를 스테이킹하여 설립하세요.",
      "invalid_currency": "SOL 또는 USDC를 선택하고 다시 시도하세요.",
      "invalid_tier": "등급을 선택하고 다시 시도하세요.",
      "price_unavailable": "실시간 가격을 지금 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      "payment_already_recorded": "해당 결제는 이미 기록되었습니다.",
      "bad_signature": "해당 결제 서명이 유효하지 않습니다. 다시 시작하세요.",
      "legs_collide": "결제를 확인할 수 없습니다. 다시 시작하세요.",
      "not_finalized": "결제가 아직 확정되지 않았습니다. 잠시 후 다시 확인하세요.",
      "memo_mismatch": "해당 결제가 견적과 일치하지 않습니다. 다시 시작하세요.",
      "treasury_short": "지불한 금액이 견적과 일치하지 않습니다.",
      "buyback_short": "지불한 금액이 견적과 일치하지 않습니다.",
      "bond_required": "이 등급을 구매하려면 연결된 지갑에 {amount} $WOC를 보유해야 합니다. 충전 후 다시 시도하세요.",
  ...
  "launchpad": {
    ...
    "title": "월드 토큰 런치패드",
    "back": "뒤로",
    "loading": "토큰 상태 불러오는 중...",
    "symbolBadge": "{symbol} 토큰",
    "termsNote": "World of ClaudeCraft는 비수탁 중개자입니다. 토큰은 지갑 간에 직접 이동하며 이 서버는 자금을 보관하지 않습니다. 런치패드 기능은 제재 대상 또는 제한 지역에서 사용할 수 없으며 수익을 약속하지 않습니다.",
    "status": {
      "none": "등록된 토큰 없음",
      "prelaunch": "출시 전",
      "voting": "커뮤니티 투표",
    ...
    "register": {
      "title": "월드 토큰 등록",
      "subtitle": "이 월드가 출시할 화폐의 이름을 정합니다. 등록은 신원 확정일 뿐이며, 민트, 잠금, 유동성은 각자의 안전장치와 함께 이후 단계에서 제공됩니다.",
      "symbolLabel": "토큰 심볼",
      "symbolPlaceholder": "예: MOON",
      "policyLabel": "수익화 정책",
      "policyHint": "'외형 전용'을 선택하면 이 월드는 페이 투 윈이 없는 상태를 유지합니다. '페이 투 윈'은 모든 플레이어에게 표시되며 출시 전 승인 게이트를 거칩니다.",
      "submit": "토큰 등록"
    },
    "vote": {
      "title": "이 월드가 토큰을 출시해야 할까요?",
      "subtitle": "검증된 연결 지갑당 1표이며, 투표 시점에 보유한 $WOC로 가중됩니다. 투표는 자문용이며 무료입니다. 트랜잭션이 전송되지 않습니다.",
      "openBtn": "커뮤니티 투표 열기",
      "yes": "찬성 투표",
      "no": "반대 투표",
      "tallyYes": "찬성: {amount} $WOC",
      "tallyNo": "반대: {amount} $WOC",
      "tallyAria": "전체 투표 가중치 중 찬성 비율",
      "quorum": "정족수: {current} / {required} $WOC",
      "quorumAria": "정족수 진행도",
      "threshold": "정족수 충족 및 찬성 {pct}% 이상이면 통과",
      "yourVote": "회원님의 투표가 {amount} $WOC 가중치로 기록되었습니다.",
      "outcomePending": "아직 정족수에 도달하지 않았습니다.",
      "outcomePassed": "투표가 통과되었습니다. 사전 판매가 열렸습니다.",
      "outcomeFailed": "찬성이 기준에 미치지 못했습니다."
    },
    "presale": {
      "title": "사전 판매",
      "subtitle": "SOL, USDC 또는 $WOC로 출시에 기여하세요. 자금은 창립자 에스크로 지갑으로 직접 전송되며, 이 서버는 트랜잭션을 검증만 하고 자금을 보관하지 않습니다.",
      "stripeDeferred": "이 단계에서는 카드 결제를 사용할 수 없습니다.",
      "progress": "소프트캡의 {pct}%",
      "progressAria": "소프트캡 대비 사전 판매 진행도",
      "railRaised": "{currency} 모금액 {raised} / {cap}",
      "railWalletRemaining": "남은 한도: {amount} {currency}",
      "railFull": "이 화폐는 한도에 도달했습니다.",
      "amountLabel": "금액 ({currency})",
      "amountPlaceholder": "0.0",
      "contribute": "기여하기",
      "contributeConnect": "지갑 연결 후 기여",
      "escrowNote": "에스크로 지갑: {address}",
      "refundTerms": "사전 판매가 소프트캡을 넘지 못하면 창립자가 에스크로 지갑에서 환불하며, 각 환불은 온체인 검증 후 반영됩니다.",
      "softCapMet": "소프트캡을 달성했습니다.",
      "finalize": "사전 판매 마감",
      "finalizeHint": "사전 판매를 종료합니다. 소프트캡을 달성하면 목표 달성, 아니면 환불이 시작됩니다.",
      "notConfigured": "창립자가 아직 기여를 열지 않았습니다.",
      "refundTitle": "환불",
      "refundNote": "이 사전 판매는 소프트캡에 도달하지 못했습니다. 환불은 에스크로 지갑에서 지급되며 온체인에서 검증됩니다.",
      "refundRemaining": "환불 검증 대기 중인 기여: {count}",
      "refundDone": "모든 기여가 검증된 환불을 받았습니다.",
      "config": {
        "title": "기여 받기 열기",
        "subtitle": "본인이 관리하는 에스크로 지갑과 화폐별 한도를 설정하세요. 비워 두면 해당 화폐는 비활성화됩니다. 금액은 전체 단위입니다.",
        "escrowLabel": "에스크로 지갑 주소",
        "softLabel": "소프트캡 ({currency})",
        "raiseLabel": "모금 상한 ({currency})",
        "walletLabel": "지갑당 한도 ({currency})",
        "submit": "사전 판매 열기"
      }
    },
    "launch": {
      "title": "토큰 런치",
      "subtitle": "민트를 생성하고 고정 공급량을 배분하며 모든 비공개 몫을 온체인에 잠급니다. 모든 잠금이 검증되기 전에는 토큰이 상장될 수 없습니다.",
      "stepsAria": "런치 단계",
      "step": {
        "mint": "민트 생성",
        "locks": "배분 및 잠금",
      ...
      "supply": "고정 공급량: {amount} {symbol}",
      "allocLine": "퍼블릭 커브 {publicPct}%, 유동성 {liquidityPct}% (졸업 시 영구 잠금)",
      "bucketLine": "{bucket}: {pct}%, {amount} {symbol}, 클리프 {cliff}개월 + 선형 {linear}개월",
      "bucket": {
        "founder": "파운더",
        "levy": "Levy Street 펀드",
        "treasury": "렐름 재무"
      ...
      "lockProof": "{bucket} 잠금:",
      "mintCreated": "민트:",
      "verifiedNote": "모든 잠금이 온체인에서 검증되었습니다. 커브가 열리면 토큰이 상장될 수 있습니다.",
      "createTitle": "민트 생성",
      "createHint": "지갑이 임대료를 지불하고 민트 권한으로 서명합니다. 서버는 자금을 움직일 수 있는 키를 절대 보유하지 않습니다. 트랜잭션을 구성하고 민트 주소를 고정하며 결과를 온체인에서 검증할 뿐입니다.",
      "treasuryLabel": "렐름 재무 지갑",
      "treasuryHint": "베스팅되는 렐름 재무 몫을 받습니다. 렐름이 관리하는 지갑을 사용하세요.",
      "nameLabel": "토큰 이름 (선택)",
      "uriLabel": "메타데이터 URL (선택)",
      "createBtn": "민트 생성",
      "locksTitle": "잠금 검증",
      "locksHint": "전체 공급량을 민트하고 위의 정확한 조건으로 취소 불가능한 Jupiter Lock 에스크로 3개를 생성한 뒤 민트 권한을 포기하고, 각 에스크로 주소를 여기에 붙여 넣으세요. 모든 내용이 체인과 대조 확인됩니다.",
      "lockLabel": "{bucket} 잠금 에스크로 주소",
      "verifyBtn": "온체인 검증",
      "checksAria": "온체인 검증 체크리스트",
      "checkPass": "통과",
      "checkFail": "실패",
      "check": {
        "mint_found": "민트 계정 읽기 가능",
        "mint_profile": "깨끗한 토큰 구성 (동결 없음, 후크 없음, 수수료 없음)",
        "supply_exact": "고정 공급량이 정확히 민트됨",
        "mint_authority_renounced": "민트 권한 포기됨",
        "lock_found": "잠금 에스크로 확인됨",
        "lock_mint": "잠금이 이 토큰을 보유",
        "lock_recipient": "잠금 수령인 일치",
        "lock_immutable": "잠금 불변 (취소 불가, 수령인 변경 불가)",
        "lock_token_program": "잠금이 올바른 토큰 프로그램 사용",
        "lock_untouched": "잠금이 미청구 상태이며 취소된 적 없음",
        "lock_amount": "잠금 수량 정확",
        "lock_schedule": "베스팅 일정이 약속을 충족",
        "lock_funded": "잠금 에스크로가 토큰 보유",
        "unknown": "추가 확인"
      }
    },
    "curve": {
    ...
    "flow": {
      ...
      "openingVote": "투표 여는 중...",
      "castingVote": "투표 기록 중...",
      "configuring": "기여 받기 여는 중...",
      "quoting": "기여 예약 중...",
      "paying": "지갑에서 전송을 승인하세요...",
      "confirming": "온체인에서 기여 검증 중...",
      "contributed": "기여가 기록되었습니다.",
      "finalizing": "사전 판매 마감 중...",
      "preparingMint": "민트 트랜잭션을 준비하는 중...",
      "signingMint": "지갑에서 민트 생성을 승인하세요...",
      "confirmingMint": "온체인에서 민트를 검증하는 중...",
    ...
    "err": {
      ...
      "realm_not_found": "해당 월드가 더 이상 존재하지 않습니다.",
      "realm_not_active": "해당 월드가 활성 상태가 아닙니다.",
      "invalid_token_symbol": "대문자와 숫자로 된 2에서 10자 티커를 선택하세요.",
      "invalid_token_icon": "해당 토큰 아이콘이 유효하지 않습니다.",
      "invalid_token_policy": "수익화 정책을 선택하세요.",
      "token_already_registered": "이 월드에는 이미 등록된 토큰이 있습니다.",
      "token_not_registered": "이 월드에는 등록된 토큰이 없습니다.",
      "vote_not_open": "커뮤니티 투표가 열려 있지 않습니다.",
      "vote_not_openable": "이 상태에서는 투표를 열 수 없습니다.",
      "invalid_vote_choice": "찬성 또는 반대를 선택하세요.",
      "wallet_not_linked": "먼저 계정에 지갑을 인증하세요.",
      "vote_weight_unavailable": "$WOC 잔액을 읽을 수 없습니다. 잠시 후 다시 시도하세요.",
      "no_vote_weight": "인증된 지갑에 투표할 수 있는 1 $WOC 이상이 없습니다.",
      "already_voted": "이 지갑 또는 계정의 투표가 이미 기록되어 있습니다.",
      "presale_not_open": "사전 판매가 열려 있지 않습니다.",
      "presale_not_configured": "창립자가 아직 기여를 열지 않았습니다.",
      "presale_already_configured": "기여가 이미 열려 있습니다.",
      "presale_not_refunding": "이 사전 판매는 환불 상태가 아닙니다.",
      "presale_unavailable": "사전 판매를 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      "invalid_escrow_wallet": "해당 에스크로 지갑 주소가 유효하지 않습니다.",
      "invalid_presale_caps": "해당 한도가 유효하지 않습니다. 활성화된 화폐마다 소프트캡, 그 이상인 모금 상한, 지갑당 한도가 필요합니다.",
      "invalid_currency": "SOL, USDC 또는 $WOC를 선택하세요.",
      "currency_not_enabled": "이 사전 판매는 해당 화폐를 받지 않습니다.",
      "invalid_amount": "유효한 금액을 입력하세요.",
      "wallet_cap_exceeded": "지갑당 한도를 초과하게 됩니다.",
      "raise_cap_exceeded": "총 모금 상한을 초과하게 됩니다.",
      "quote_not_found": "견적을 찾을 수 없습니다. 다시 시작하세요.",
      "not_your_quote": "해당 견적은 다른 계정의 것입니다.",
      "quote_expired": "견적이 만료되었습니다. 다시 시작하세요.",
      "contribution_already_recorded": "해당 트랜잭션은 이미 기록되었습니다.",
      "contribution_not_found": "해당 기여를 찾을 수 없습니다.",
      "already_refunded": "해당 기여는 이미 환불되었습니다.",
      "refund_sig_reused": "해당 환불 트랜잭션은 이미 다른 기여에 사용되었습니다.",
      "wrong_refunder": "환불은 에스크로 지갑에서 지급되어야 합니다.",
      "refund_short": "환불 금액이 기여를 충당하지 못합니다.",
      "bad_signature": "해당 트랜잭션 서명이 유효하지 않습니다. 다시 시작하세요.",
      "not_finalized": "트랜잭션이 아직 확정되지 않았습니다. 잠시 후 다시 시도하세요.",
      "tx_failed": "트랜잭션이 온체인에서 실패했습니다.",
      "token_2022": "해당 토큰 프로그램은 여기에서 지원되지 않습니다.",
      "memo_mismatch": "해당 트랜잭션이 견적과 일치하지 않습니다. 다시 시작하세요.",
      "wrong_payer": "트랜잭션은 연결된 지갑으로 서명해야 합니다.",
      "escrow_short": "지불 금액이 견적과 일치하지 않습니다.",
      "missing_quoteId_or_paySig": "확인 정보가 불완전합니다. 다시 시작하세요.",
      "missing_payTxSig_or_refundSig": "환불 제출 정보가 불완전합니다.",
      "mint_already_created": "민트가 이미 생성되었습니다.",
      "presale_not_funded": "프리세일이 아직 목표를 달성하지 못했습니다.",
      "levy_fund_unconfigured": "플랫폼 펀드 지갑이 아직 설정되지 않았습니다. 나중에 다시 시도하세요.",
      "invalid_treasury_wallet": "해당 재무 지갑 주소가 유효하지 않습니다.",
      "invalid_token_name": "토큰 이름은 1자에서 32자의 일반 문자입니다.",
      "invalid_token_uri": "메타데이터 URL은 https 주소여야 합니다.",
      "chain_unavailable": "체인에 연결할 수 없습니다. 잠시 후 다시 시도하세요.",
      "launch_not_prepared": "먼저 민트 트랜잭션을 준비하세요.",
      "mint_not_in_tx": "해당 트랜잭션은 고정된 민트를 생성하지 않았습니다.",
      "mint_not_found": "온체인에서 민트 계정을 읽을 수 없습니다.",
      "wrong_token_program": "민트가 예상 토큰 프로그램 아래에 있지 않습니다.",
      "wrong_decimals": "민트의 소수 자릿수가 예상과 다릅니다.",
      "freeze_authority_set": "민트에 동결 권한이 있습니다. 동결 권한이 없어야 합니다.",
      "bad_metadata_pointer": "민트 메타데이터 포인터가 잘못되었거나 아직 변경 가능합니다.",
      "metadata_symbol_mismatch": "온체인 심볼이 등록된 토큰과 일치하지 않습니다.",
      "unexpected_extension": "민트에 허용되지 않는 확장이 있습니다.",
      "launch_sig_replayed": "해당 런치 트랜잭션은 이미 사용되었습니다.",
      "mint_not_created": "먼저 민트를 생성하고 확인하세요.",
      "invalid_lock_address": "서로 다른 유효한 잠금 에스크로 주소 3개를 입력하세요.",
      "launch_not_verifiable": "런치가 아직 검증할 준비가 되지 않았습니다.",
      ...
      "region_blocked": "이 기능은 현재 지역에서 사용할 수 없습니다.",
      "wallet_sanctioned": "이 지갑은 런치패드를 사용할 수 없습니다.",
      "sanctions_unavailable": "컴플라이언스 심사를 일시적으로 사용할 수 없습니다. 나중에 다시 시도하세요.",
      "rate_limited": "요청이 너무 많습니다. 잠시 후 다시 시도하세요.",
      "wallet_mismatch": "계정에 연결한 지갑을 연결하세요.",
      "generic": "문제가 발생했습니다. 다시 시도하세요."
    }
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "$WOC 시즌",
      "title": "$WOC 보상 시즌",
      "subtitle": "트레저리 재원으로 상위 플레이어에게 지급",
      "close": "닫기",
      "none": "현재 진행 중인 보상 시즌이 없습니다.",
      "noneHint": "투기장 수수료와 바이백이 풀에 자금을 대기 시작하면 시즌이 열립니다.",
      "statusActive": "진행 중",
      "statusEnded": "종료됨",
      "endsIn": "Ends in",
      "endsInValue": "{days}d {hours}h {minutes}m",
      "ended": "이번 시즌이 종료되었습니다.",
      "openEnded": "무기한",
      "poolLabel": "사용 가능한 보상 풀",
      "wocUnit": "$WOC",
      "emittedLabel": "지금까지 풀의 {pct}% 지급됨",
      "sinkLabel": "적립됨",
      "emissionLabel": "Paid out",
      "invariant": "지급액은 시즌 수입을 초과할 수 없습니다. 매수가 매도를 초과하도록 온체인에서 강제됩니다.",
      "standingsTitle": "예상 상위 획득자",
      "colRank": "#",
      "colPlayer": "플레이어",
      "colRating": "레이팅",
      "colReward": "보상($WOC)",
      "projectedNote": "현재 풀과 투기장 순위 기준 예상치이며, 최종 지급은 시즌 종료 시 확정됩니다."
    },
    "account": {
      "title": "계정",
