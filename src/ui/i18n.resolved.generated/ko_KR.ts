...
export const ko_KR: EnTranslations = {
  ...
  "launchpad": {
    ...
    "levy": {
      "open": "레비 스트리트 펀드",
      "title": "레비 스트리트 펀드",
      "subtitle": "여기서 런치된 모든 렐름 토큰의 일부를 보유하는 투명한 표시 전용 포트폴리오입니다.",
      "displayOnlyNote": "표시 전용: 펀드는 이 토큰들을 여러분과 함께 보유하며 매도할 수 없습니다. 펀드 지분도 상환도 없습니다.",
      "loading": "포트폴리오를 불러오는 중……",
      "empty": "아직 보유 자산이 없습니다. 런치된 렐름 토큰은 상장되면 여기에 표시됩니다.",
      "aum": "총 가치(AUM)",
      "aumSol": "in SOL",
      "holdings": "{count}개 보유",
      "excluded": "{count}개는 비유동으로 제외됨",
      "clamped": "이번 새로고침의 가치 변동은 확인 대기 중으로 제한되었습니다.",
    ...
    "err": {
      ...
      "mint_not_ready": "토큰은 프리세일이 목표를 달성한 후에만 발행할 수 있습니다.",
      "token_already_minted": "이 토큰은 이미 발행되었습니다.",
      "token_not_minted": "먼저 토큰을 발행하세요.",
      "levy_wallet_unconfigured": "이 렐름 호스트에서는 토큰 런치가 아직 활성화되지 않았습니다.",
      "launch_unavailable": "런치 서비스를 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      "launch_sig_reused": "해당 트랜잭션은 이미 다른 런치에 사용되었습니다.",
      "mint_mismatch": "체인상의 민트가 이 런치와 일치하지 않습니다. 다시 시작하세요.",
      "already_distributed": "공급량이 이미 분배되었습니다.",
      "not_distributed": "먼저 공급량을 분배하세요.",
      "distribution_mismatch": "분배가 할당 계획과 일치하지 않습니다.",
      "invalid_lock_bucket": "파운더, 레비, 트레저리 락 중 하나를 선택하세요.",
      "already_locked": "해당 할당량은 이미 잠겨 있습니다.",
      "lock_mismatch": "체인상의 락이 이 런치와 일치하지 않습니다. 다시 시작하세요.",
      "lock_not_immutable": "해당 락은 불변이 아닙니다. 누구도 취소할 수 없어야 합니다.",
      ...
      "power_credit_disabled": "이 토큰을 게임 내 파워로 사용하는 것은 여기서 활성화되지 않았습니다.",
      "power_sink_unconfigured": "이 렐름은 아직 토큰 사용을 설정하지 않았습니다.",
      "not_power_realm": "이 렐름은 외형 전용입니다: 토큰으로 게임 파워를 살 수 없습니다.",
      "token_2022_mismatch": "그 전송은 이 렐름 토큰과 일치하지 않습니다. 다시 시작하세요.",
      "sink_not_credited": "전송이 렐름 지갑에 도달하지 않았습니다.",
      "amount_too_small": "그 금액은 너무 작아 화폐로 환산할 수 없습니다.",
      "credit_already_recorded": "그 전송은 이미 반영되었습니다.",
      "no_character_to_credit": "이 렐름의 캐릭터로 로그인하여 받으세요.",
      "missing_payTxSig": "크레딧 제출 정보가 불완전했습니다.",
      "rate_limited": "요청이 너무 많습니다. 잠시 후 다시 시도하세요.",
      "wallet_mismatch": "계정에 연결한 지갑을 연결하세요.",
      "generic": "문제가 발생했습니다. 다시 시도하세요."
    }
