...
export const zh_TW: EnTranslations = {
  ...
  "realmOp": {
    ...
    "found": {
      "title": "創立世界",
      "subtitle": "將 $WOC 質押到非託管的鏈上託管帳戶，以開設並營運你自己的世界。",
      "nameLabel": "世界名稱",
      "namePlaceholder": "為你的世界命名",
      "typeLabel": "世界類型",
      "tierLabel": "質押等級",
      "tierHint": "更大的質押解鎖更高等級：更多玩家、更多自訂預算，以及營運者收益通道。",
      "supplyNote": "每個等級的價格按 $WOC 即時供應量的一定比例計算。",
      "badgeNote": "你質押的 $WOC 仍計入你的持有者徽章，因此創立世界絕不會降低你的等級。",
      "affiliateNote": "由聯盟推薦。他們將獲得該世界收入 15% 的佣金。",
      "tiersUnavailable": "即時等級價格暫時不可用。請稍後再試。",
      "submit": "質押並創立",
      "submitConnect": "連接錢包以創立",
      "stakingNote": "你簽署一筆交易，將 {amount} $WOC 鎖入託管。停用後經過 {days} 天時間鎖即可隨時取回。",
      "nameTaken": "請換一個名稱；該名稱已被佔用。",
      "methodLabel": "支付方式",
      "methodStake": "質押 $WOC",
      "methodStakeHint": "將 $WOC 鎖入託管。停用時全額返還。",
      "methodBuy": "用 SOL 或 USDC 購買",
      "methodBuyHint": "用 SOL 或 USDC 一次性支付。購買為最終交易，沒有可取回的質押。"
    },
    "tier": {
      "bronze": "青銅",
      "silver": "白銀",
    ...
    "buy": {
      ...
      "currencySol": "SOL",
      "currencyUsdc": "USDC",
      "currencyUnavailable": "{currency} 暫時不可用（沒有兌換路徑）。",
      "splitNote": "你支付的 {treasuryPct}% 注入金庫，其餘用於回購並銷毀 $WOC。",
      "finalNote": "購買為最終交易，不可退款。與質押不同，停用世界時不會返還。",
      "unavailable": "目前無法購買世界。請改為質押 $WOC 來創立。",
      "submit": "購買並創立",
      "submitConnect": "連接錢包以購買",
      "note": "你簽署一筆交易，支付 {amount} {currency} 來創立此世界。世界立即啟用。",
      "bondNote": "還需持有 {amount} $WOC，在世界存續期間保留在你綁定的錢包中，否則世界將失效。",
      "bondWhy": "這筆持續保證金獨立於你支付的 {currency}：它確保你在營運世界期間保持利益綁定。"
    },
    "mine": {
      "title": "我的世界",
      "loading": "正在載入你的世界...",
      "empty": "你還沒有營運任何世界。在上方創立一個即可開始。",
      "tier": "{tier} 等級",
      "decommission": "停用",
      "release": "完成關閉",
      "enter": "進入",
      "eligible": "質押可於 {date} 釋放",
      "releaseHint": "先在鏈上釋放你的質押，然後完成關閉以關停世界並釋放其名稱。",
      "decommissionConfirm": "停用 {name}？這將使世界下線，並啟動 {days} 天的質押釋放時間鎖。",
      "bondInfo": "保證金：在綁定錢包中持有 {amount} $WOC。",
      "bondWarning": "保證金低於要求。請持有 {amount} $WOC，並在 {date} 之前補足，否則此世界將失效。"
    },
    "status": {
      "active": "啟用",
      "provisioning": "開通中",
    ...
    "affiliate": {
      "open": "推薦計畫",
      "title": "推薦與聯盟計畫",
      "subtitle": "分享一個連結。通過它加入的玩家獲得經驗和金幣加成，你從他們的收益中賺取分成，他們創立的任何世界還會給你 15%。",
      "yourLink": "你的推薦連結",
      "copy": "複製連結",
      "copied": "已複製",
      "loading": "正在載入你的推薦統計...",
      "bonusTitle": "你的連結如何賺錢",
      "bonusReferee": "通過你的連結加入的玩家在前 30 天獲得 +10% 經驗和金幣。",
      "bonusReferrer": "在此期間，你可獲得他們收益的 +5%，直接計入你的角色。",
      "bonusRealm": "另外，他們創立的任何世界都會給你 15% 的 USDC 佣金。",
      "rewardsTitle": "你的推薦獎勵",
      "rewardsPending": "{xp} 經驗和 {gold} 待發放，將在你下次登入時到帳",
      "rewardsLifetime": "累計已獲得 {xp} 經驗和 {gold}",
      "rewardsReferred": "已推薦玩家：{count}",
      "rewardsEmpty": "推薦玩家即可開始賺取。獎勵將在你下次登入時發放到角色。",
      "referredTitle": "你推薦的世界",
      "referredCount": "{count} 個活躍的被推薦世界",
      "referredCountPlural": "{count} 個活躍的被推薦世界",
      "empty": "還沒有被推薦的世界。分享你的連結開始賺取收益。",
      "commission": "{pct}% 佣金",
      "earningsSoon": "當世界內收入上線後，USDC 佣金即開始發放。",
      "unavailable": "推薦統計暫時不可用。請稍後再試。"
    },
    "flow": {
      "connecting": "正在連接你的錢包...",
      "quoting": "正在為你預留世界...",
      "locking": "請在錢包中核准質押...",
      "confirming": "正在鏈上驗證你的質押...",
      "paying": "請在錢包中核准支付...",
      "confirmingBuy": "正在鏈上驗證你的支付...",
      "decommissioning": "正在開始停用...",
      "releasing": "正在完成關閉...",
      "released": "世界已關閉。該名稱重新可用。",
      "closed": "世界已關閉。該名稱重新可用。",
      "founded": "{name} 已上線。歡迎，營運者。"
    },
    "err": {
      "invalid_realm_name": "該世界名稱不被允許。請使用字母、數字、空格或連字號。",
      "realm_name_not_allowed": "該世界名稱不被允許。",
      "realm_name_taken": "該世界名稱已被佔用。",
      "realm_cap_reached": "你已達到每個帳戶的世界數量上限。",
      "stake_below_minimum": "該質押低於最低等級。請選擇更高的等級。",
      "supply_unavailable": "$WOC 供應量數據暫時不可用。請稍後再試。",
      "invalid_amount": "質押數量無效。請選擇一個等級後重試。",
      "link_wallet": "請先將錢包綁定到你的帳戶。",
      "wallet_mismatch": "請連接你綁定到帳戶的錢包。",
      "quote_expired": "你的報價已過期。請重新開始。",
      "quote_not_found": "未找到你的報價。請重新開始。",
      "not_your_quote": "該報價屬於其他帳戶。",
      "stake_already_recorded": "該質押已被記錄。",
      "tx_not_finalized": "你的質押尚未最終確認。請稍後再確認一次。",
      "tx_failed": "質押交易在鏈上失敗。",
      "token_2022": "此 $WOC 鑄幣不支援用於質押。",
      "wrong_vault_amount": "鎖定的數量與你的報價不符。",
      "wrong_payer": "質押必須由你綁定的錢包簽署。",
      "stake_service_unavailable": "質押服務暫時不可用。請稍後再確認一次。",
      "not_realm_owner": "你不是該世界的營運者。",
      "realm_not_found": "該世界已不存在。",
      "realm_not_active": "該世界未處於啟用狀態。",
      "realm_not_decommissioning": "該世界未處於停用流程中。",
      "timelock_not_elapsed": "質押的時間鎖尚未到期。",
      "stake_not_released_onchain": "請先在鏈上釋放你的質押，然後再完成關閉。",
      "rate_limited": "請求過於頻繁。請放慢速度後重試。",
      "buy_unavailable": "目前無法購買世界。請改為質押 $WOC 來創立。",
      "invalid_currency": "請選擇 SOL 或 USDC 後重試。",
      "invalid_tier": "請選擇一個等級後重試。",
      "price_unavailable": "即時價格暫時不可用。請稍後再試。",
      "payment_already_recorded": "該支付已被記錄。",
      "bad_signature": "該支付簽名無效。請重新開始。",
      "legs_collide": "無法驗證該支付。請重新開始。",
      "not_finalized": "你的支付尚未最終確認。請稍後再確認一次。",
      "memo_mismatch": "該支付與你的報價不符。請重新開始。",
      "treasury_short": "支付金額與你的報價不符。",
      "buyback_short": "支付金額與你的報價不符。",
      "bond_required": "購買此等級需要在綁定錢包中持有 {amount} $WOC。請儲值後重試。",
      "generic": "出了點問題。請重試。"
    }
  },
  "launchpad": {
    ...
    "register": {
      "title": "註冊世界代幣",
      "subtitle": "為這個世界將要發射的貨幣命名。註冊僅確定身分：鑄造、鎖倉與流動性將在後續階段連同各自的保障機制推出。",
      "symbolLabel": "代幣代碼",
      "symbolPlaceholder": "例如 MOON",
      "policyLabel": "變現政策",
      "policyHint": "選擇「僅限外觀」可讓這個世界維持無付費變強。「付費變強」會向所有玩家明確標示，並在上線前受到審核限制。",
      "submit": "註冊代幣"
    },
    "vote": {
      "title": "這個世界應該發射它的代幣嗎？",
      "subtitle": "每個已驗證的關聯錢包一票，依投票時錢包持有的 $WOC 加權。投票僅供參考且免費：不會送出任何交易。",
      "openBtn": "開啟社群投票",
      "yes": "投贊成票",
      "no": "投反對票",
      "tallyYes": "贊成：{amount} $WOC",
      "tallyNo": "反對：{amount} $WOC",
      "tallyAria": "贊成票權重佔比",
      "quorum": "法定人數：{current} / {required} $WOC",
      "quorumAria": "法定人數進度",
      "threshold": "達到法定人數且贊成率達 {pct}% 時通過",
      "yourVote": "您的投票已記錄，權重 {amount} $WOC。",
      "outcomePending": "尚未達到法定人數。",
      "outcomePassed": "投票已通過。預售已解鎖。",
      "outcomeFailed": "贊成票低於門檻。"
    },
    "presale": {
      "title": "預售",
      "subtitle": "用 SOL、USDC 或 $WOC 為發射出資。資金直接進入創始人託管錢包；本伺服器只驗證您的交易，絕不保管資金。",
      "stripeDeferred": "本階段暫不支援銀行卡支付。",
      "progress": "軟頂進度 {pct}%",
      "progressAria": "預售軟頂進度",
      "railRaised": "已籌 {raised} / {cap} {currency}",
      "railWalletRemaining": "您的剩餘額度：{amount} {currency}",
      "railFull": "該幣種已達上限。",
      "amountLabel": "金額（{currency}）",
      "amountPlaceholder": "0.0",
      "contribute": "出資",
      "contributeConnect": "連接錢包以出資",
      "escrowNote": "託管錢包：{address}",
      "refundTerms": "如果預售未達軟頂，創始人將從託管錢包退款，每筆退款都會先經鏈上驗證才計入。",
      "softCapMet": "已達到軟頂。",
      "finalize": "結束預售",
      "finalizeHint": "結束預售：達到軟頂則判定為已達標，否則開啟退款。",
      "notConfigured": "創始人尚未開放出資。",
      "refundTitle": "退款",
      "refundNote": "本次預售未達軟頂。退款由託管錢包支付並經鏈上驗證。",
      "refundRemaining": "等待退款驗證的出資：{count}",
      "refundDone": "所有出資都已完成經驗證的退款。",
      "config": {
        "title": "開放出資",
        "subtitle": "設定您掌控的託管錢包與各幣種上限。留空即停用該幣種。金額為整單位。",
        "escrowLabel": "託管錢包地址",
        "softLabel": "軟頂（{currency}）",
        "raiseLabel": "籌集上限（{currency}）",
        "walletLabel": "單錢包上限（{currency}）",
        "submit": "開啟預售"
      }
    },
    "launch": {
      "title": "代幣發射",
      "subtitle": "建立鑄幣、分配固定供應量,並將所有非公開份額鎖定在鏈上。所有鎖倉通過驗證之前,代幣無法上線。",
      "stepsAria": "發射流程步驟",
      "step": {
        "mint": "建立鑄幣",
        "locks": "分配並鎖倉",
      ...
      "supply": "固定供應量:{amount} {symbol}",
      "allocLine": "公開曲線 {publicPct}%,流動性 {liquidityPct}%(畢業時永久鎖定)",
      "bucketLine": "{bucket}:{pct}%,{amount} {symbol},{cliff} 個月懸崖期 + {linear} 個月線性解鎖",
      "bucket": {
        "founder": "創始人",
        "levy": "Levy Street 基金",
        "treasury": "伺服器金庫"
      ...
      "lockProof": "{bucket}鎖倉:",
      "mintCreated": "鑄幣:",
      "verifiedNote": "所有鎖倉均已在鏈上驗證。曲線開放後代幣即可上線。",
      "createTitle": "建立鑄幣",
      "createHint": "您的錢包支付租金並作為鑄幣權限簽名。伺服器從不持有能轉移資金的金鑰:它只建構交易、鎖定鑄幣地址,並在鏈上驗證結果。",
      "treasuryLabel": "伺服器金庫錢包",
      "treasuryHint": "接收歸屬解鎖的伺服器金庫份額。請使用您的伺服器掌控的錢包。",
      "nameLabel": "代幣名稱(可選)",
      "uriLabel": "中繼資料網址(可選)",
      "createBtn": "建立鑄幣",
      "locksTitle": "驗證鎖倉",
      "locksHint": "鑄出全部供應量,按上述確切條款建立三個不可撤銷的 Jupiter Lock 託管,放棄鑄幣權限,然後在此貼上每個託管地址。所有內容都會對照鏈上核驗。",
      "lockLabel": "{bucket}鎖倉託管地址",
      "verifyBtn": "鏈上驗證",
      "checksAria": "鏈上驗證清單",
      "checkPass": "通過",
      "checkFail": "未通過",
      "check": {
        "mint_found": "鑄幣帳戶可讀取",
        "mint_profile": "乾淨的代幣配置(無凍結、無掛鉤、無費用)",
        "supply_exact": "固定供應量足額鑄出",
        "mint_authority_renounced": "鑄幣權限已放棄",
        "lock_found": "找到鎖倉託管",
        "lock_mint": "鎖倉持有本代幣",
        "lock_recipient": "鎖倉接收人相符",
        "lock_immutable": "鎖倉不可變(不可取消、不可更換接收人)",
        "lock_token_program": "鎖倉使用正確的代幣程式",
        "lock_untouched": "鎖倉未領取且從未取消",
        "lock_amount": "鎖定數量精確",
        "lock_schedule": "解鎖計畫滿足承諾",
        "lock_funded": "鎖倉託管持有代幣",
        "unknown": "附加檢查"
      }
    },
    "curve": {
    ...
    "flow": {
      "registering": "正在註冊代幣...",
      "openingVote": "正在開啟投票...",
      "castingVote": "正在記錄您的投票...",
      "configuring": "正在開放出資...",
      "quoting": "正在預留您的出資...",
      "paying": "請在錢包中批准轉帳...",
      "confirming": "正在鏈上驗證您的出資...",
      "contributed": "出資已記錄。",
      "finalizing": "正在結束預售...",
      "preparingMint": "正在準備鑄幣交易...",
      "signingMint": "請在錢包中批准鑄幣建立...",
      "confirmingMint": "正在鏈上驗證鑄幣...",
      "mintDone": "鑄幣已建立並通過驗證。",
      "verifying": "正在鏈上驗證鎖倉...",
    ...
    "err": {
      ...
      "realm_not_found": "該世界已不存在。",
      "realm_not_active": "該世界未處於活躍狀態。",
      "invalid_token_symbol": "請選擇 2 到 10 個字元的大寫字母和數字代碼。",
      "invalid_token_icon": "該代幣圖示無效。",
      "invalid_token_policy": "請選擇變現政策。",
      "token_already_registered": "該世界已註冊代幣。",
      "token_not_registered": "該世界沒有註冊代幣。",
      "vote_not_open": "社群投票尚未開啟。",
      "vote_not_openable": "目前狀態無法開啟投票。",
      "invalid_vote_choice": "請選擇贊成或反對。",
      "wallet_not_linked": "請先在您的帳戶上驗證錢包。",
      "vote_weight_unavailable": "無法讀取您的 $WOC 餘額。請稍後再試。",
      "no_vote_weight": "您的已驗證錢包沒有可用於投票的整數 $WOC。",
      "already_voted": "該錢包或帳戶已經投過票。",
      "presale_not_open": "預售未開啟。",
      "presale_not_configured": "創始人尚未開放出資。",
      "presale_already_configured": "出資已經開放。",
      "presale_not_refunding": "本次預售不在退款階段。",
      "presale_unavailable": "預售暫時不可用。請稍後再試。",
      "invalid_escrow_wallet": "該託管錢包地址無效。",
      "invalid_presale_caps": "這些上限無效。每個啟用的幣種需要軟頂、不低於軟頂的籌集上限和單錢包上限。",
      "invalid_currency": "請選擇 SOL、USDC 或 $WOC。",
      "currency_not_enabled": "本次預售不接受該幣種。",
      "invalid_amount": "請輸入有效金額。",
      "wallet_cap_exceeded": "這將超過您的單錢包上限。",
      "raise_cap_exceeded": "這將超過總籌集上限。",
      "quote_not_found": "找不到您的報價。請重新開始。",
      "not_your_quote": "該報價屬於其他帳戶。",
      "quote_expired": "您的報價已過期。請重新開始。",
      "contribution_already_recorded": "該交易已被記錄。",
      "contribution_not_found": "找不到該出資。",
      "already_refunded": "該出資已退款。",
      "refund_sig_reused": "該退款交易已用於另一筆出資。",
      "wrong_refunder": "退款必須由託管錢包支付。",
      "refund_short": "退款金額不足以覆蓋該出資。",
      "bad_signature": "該交易簽名無效。請重新開始。",
      "not_finalized": "您的交易尚未最終確認。請稍後再試。",
      "tx_failed": "交易在鏈上失敗。",
      "token_2022": "此處不支援該代幣程式。",
      "memo_mismatch": "該交易與您的報價不符。請重新開始。",
      "wrong_payer": "交易必須由您的關聯錢包簽名。",
      "escrow_short": "支付金額與您的報價不符。",
      "missing_quoteId_or_paySig": "確認資訊不完整。請重新開始。",
      "missing_payTxSig_or_refundSig": "退款提交資訊不完整。",
      "mint_already_created": "鑄幣已建立。",
      "presale_not_funded": "預售尚未達標完成。",
      "levy_fund_unconfigured": "平台基金錢包尚未設定。請稍後再試。",
      "invalid_treasury_wallet": "該金庫錢包地址無效。",
      "invalid_token_name": "代幣名稱為 1 到 32 個普通字元。",
      "invalid_token_uri": "中繼資料網址必須是 https 地址。",
      "chain_unavailable": "無法連接鏈上網路。請稍後再試。",
      "launch_not_prepared": "請先準備鑄幣交易。",
      "mint_not_in_tx": "該交易沒有建立鎖定的鑄幣。",
      "mint_not_found": "無法在鏈上讀取鑄幣帳戶。",
      "wrong_token_program": "鑄幣不在預期的代幣程式之下。",
      "wrong_decimals": "鑄幣的小數位數不符合預期。",
      "freeze_authority_set": "鑄幣設有凍結權限。必須沒有凍結權限。",
      "bad_metadata_pointer": "鑄幣中繼資料指標錯誤或仍可更改。",
      "metadata_symbol_mismatch": "鏈上代碼與已註冊代幣不符。",
      "unexpected_extension": "鑄幣帶有不被允許的擴充。",
      "launch_sig_replayed": "該發射交易已被使用。",
      "mint_not_created": "請先建立並確認鑄幣。",
      "invalid_lock_address": "請輸入三個互不相同的有效鎖倉託管地址。",
      "launch_not_verifiable": "發射尚未準備好進行驗證。",
  ...
  "hudChrome": {
    ...
    "wocSeason": {
      "menu": "$WOC 賽季",
      "title": "$WOC 獎勵賽季",
      "subtitle": "由金庫出資，向頂尖玩家派發",
      "close": "關閉",
      "none": "目前沒有進行中的獎勵賽季。",
      "noneHint": "當競技場抽成和回購開始注入獎池時，賽季即會開啟。",
      "statusActive": "進行中",
      "statusEnded": "已結束",
      "endsIn": "Ends in",
      ...
      "poolLabel": "可用獎池",
      "wocUnit": "$WOC",
      "emittedLabel": "獎池已發放 {pct}%",
      "sinkLabel": "已注入",
      "emissionLabel": "Paid out",
      "invariant": "派發絕不會超過賽季收入：買入大於賣出，由鏈上強制執行。",
      "standingsTitle": "預計最高收益者",
      "colRank": "#",
      "colPlayer": "玩家",
      "colRating": "評分",
      "colReward": "獎勵（$WOC）",
      "projectedNote": "根據當前獎池和競技場排名預估；最終派發在賽季結束時結算。"
    },
    "account": {
      "title": "帳號",
