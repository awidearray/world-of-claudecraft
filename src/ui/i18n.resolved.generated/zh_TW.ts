...
export const zh_TW: EnTranslations = {
  ...
  "launchpad": {
    ...
    "levy": {
      "open": "萊維街基金",
      "title": "萊維街基金",
      "subtitle": "一個透明、僅供展示的投資組合，持有本平台發射的每個領域代幣的一部分。",
      "displayOnlyNote": "僅供展示：基金與你一同持有這些代幣，無法出售。沒有基金份額，也沒有贖回。",
      "loading": "正在載入投資組合……",
      "empty": "尚無持倉。已發射的領域代幣在上架後會顯示在此處。",
      "aum": "總價值（AUM）",
      "aumSol": "in SOL",
      "holdings": "{count} 項持倉",
      "excluded": "{count} 項因流動性不足被排除",
      "clamped": "本次重新整理的價值變動已被限制，等待確認。",
      "updated": "更新於 {time}",
      "colToken": "代幣",
      "colAmount": "數量",
      "colPrice": "價格",
    ...
    "err": {
      ...
      "mint_not_ready": "只有在預售達標後才能鑄造代幣。",
      "token_already_minted": "該代幣已鑄造。",
      "token_not_minted": "請先鑄造代幣。",
      "levy_wallet_unconfigured": "該伺服器主機尚未啟用代幣發射。",
      "launch_unavailable": "發射服務暫時無法使用。請稍後再試。",
      "launch_sig_reused": "該交易已被其他發射使用。",
      "mint_mismatch": "鏈上鑄幣與本次發射不符。請重新開始。",
      "already_distributed": "供應量已分配。",
      "not_distributed": "請先分配供應量。",
      "distribution_mismatch": "分配結果與分配方案不符。",
      "invalid_lock_bucket": "請選擇創始人、平台或金庫鎖倉。",
      "already_locked": "該份額已鎖倉。",
      "lock_mismatch": "鏈上鎖倉與本次發射不符。請重新開始。",
      "lock_not_immutable": "該鎖倉並非不可變。必須任何人都無法取消。",
      ...
      "not_migrated": "曲線尚未畢業。",
      "power_credit_disabled": "此處未啟用使用該代幣兌換遊戲內力量。",
      "power_sink_unconfigured": "該領域尚未設定代幣消費。",
      "not_power_realm": "該領域僅為裝飾性：其代幣無法購買遊戲力量。",
      "token_2022_mismatch": "該轉帳與此領域代幣不符。請重新開始。",
      "sink_not_credited": "轉帳未到達領域錢包。",
      "amount_too_small": "該金額太小，無法兌換任何貨幣。",
      "credit_already_recorded": "該轉帳已入帳。",
      "no_character_to_credit": "請登入該領域的角色以接收入帳。",
      "missing_payTxSig": "入帳提交資訊不完整。",
