...
export const sv_SE: EnTranslations = {
  ...
  "launchpad": {
    ...
    "levy": {
      ...
      "subtitle": "A transparent, display-only portfolio of a slice of every realm token launched here.",
      "displayOnlyNote": "Display only: the fund holds these tokens beside you and cannot sell them. There is no fund share and no redemption.",
