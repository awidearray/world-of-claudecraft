...
export const da_DK: EnTranslations = {
  ...
  "launchpad": {
    ...
    "register": {
      ...
      "subtitle": "Name the currency this realm will launch. Registration is identity only: the mint, locks, and liquidity come in later phases with their own safeguards.",
      "symbolLabel": "Token symbol",
      "symbolPlaceholder": "e.g. MOON",
      "policyLabel": "Monetization policy",
      "policyHint": "Cosmetic keeps this realm no-pay-to-win. Pay-to-win is labeled to every player and gated before launch.",
      "submit": "Register Token"
    },
    "vote": {
      "title": "Should this realm launch its token?",
      "subtitle": "One vote per verified linked wallet, weighted by the $WOC it holds when you vote. The vote is advisory and free: no transaction is sent.",
    ...
    "presale": {
      "title": "Presale",
      "subtitle": "Contribute SOL, USDC, or $WOC toward the launch. Funds go straight to the founder escrow wallet; this server only verifies your transaction and never holds money.",
      ...
      "refundTerms": "If the presale misses its soft cap, the founder refunds contributions from the escrow wallet and each refund is verified on chain before it counts.",
      ...
      "refundTitle": "Refunds",
      "refundNote": "This presale missed its soft cap. Refunds are paid from the escrow wallet and verified on chain.",
      ...
      "config": {
        ...
        "subtitle": "Set the escrow wallet you control and the caps per currency. Leave a currency blank to disable it. Amounts are whole units.",
    ...
    "launch": {
      "title": "Token Launch",
      "subtitle": "Create the mint, distribute the fixed supply, and lock every non-public bucket on chain. The token cannot go live until every lock is verified.",
      ...
      "allocLine": "Public curve {publicPct}%, liquidity {liquidityPct}% (permanently locked at graduation)",
      "bucketLine": "{bucket}: {pct}%, {amount} {symbol}, {cliff} month cliff + {linear} month linear vest",
      "bucket": {
        "founder": "Founder",
      ...
      "createHint": "Your wallet pays rent and signs as the mint authority. The server never holds a key that can move funds: it builds the transaction, pins the mint address, and verifies the result on chain.",
      ...
      "locksHint": "Mint the full supply, create the three immutable Jupiter Lock escrows with the exact terms above, renounce the mint authority, then paste each escrow address here. Everything is checked against the chain.",
    ...
    "err": {
      ...
      "invalid_presale_caps": "Those caps are not valid. Each enabled currency needs a soft cap, a raise cap at or above it, and a per-wallet cap.",
